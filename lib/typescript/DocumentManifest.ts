// To parse this data:
//
//   import { Convert, DocumentManifest } from "./file";
//
//   const documentManifest = Convert.toDocumentManifest(json);
//
...
export namespace Convert {
    export function toDocumentManifest(json: string): DocumentManifest {
        return cast(JSON.parse(json), r("DocumentManifest"));
    }

    export function documentManifestToJson(value: DocumentManifest): string {
        return JSON.stringify(uncast(value, r("DocumentManifest")), null, 2);
    }
    ...
    const typeMap: any = {
        "DocumentManifest": o([
            ...
            { json: "content", js: "content", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("DocumentManifestStatus")) },
        ...
        "Related": o([
            ...
            { json: "identifier", js: "identifier", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "ref", js: "ref", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
