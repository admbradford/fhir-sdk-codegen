// To parse this data:
//
//   import { Convert, MedicinalProductPharmaceutical } from "./file";
//
//   const medicinalProductPharmaceutical = Convert.toMedicinalProductPharmaceutical(json);
//
...
export interface MedicinalProductPharmaceutical {
     ...
     */
    administrableDoseForm?: PurpleType;
    /**
...
export interface RouteOfAdministration {
     ...
     * authorisation.
     */
    maxDosePerDay?: ValueQuantity;
    /**
     * The maximum dose per treatment period that can be administered as per the protocol
     * referenced in the clinical trial authorisation.
     */
    maxDosePerTreatmentPeriod?: ValueRatio;
    /**
     * The maximum single dose that can be administered as per the protocol of a clinical trial
     * can be specified using a numerical value and its unit of measurement.
     */
    maxSingleDose?: ValueQuantity;
    /**
     * The maximum treatment period during which an Investigational Medicinal Product can be
     * administered as per the protocol referenced in the clinical trial authorisation.
     */
    maxTreatmentPeriod?: ValueDuration;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
...
export interface WithdrawalPeriod {
     ...
     * Extensions for supportingInformation
     */
    _supportingInformation?: PuneHedgehog;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export namespace Convert {
    export function toMedicinalProductPharmaceutical(json: string): MedicinalProductPharmaceutical {
        return cast(JSON.parse(json), r("MedicinalProductPharmaceutical"));
    }

    export function medicinalProductPharmaceuticalToJson(value: MedicinalProductPharmaceutical): string {
        return JSON.stringify(uncast(value, r("MedicinalProductPharmaceutical")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductPharmaceutical": o([
            ...
            { json: "administrableDoseForm", js: "administrableDoseForm", typ: u(undefined, r("PurpleType")) },
            { json: "characteristics", js: "characteristics", typ: u(undefined, a(r("Characteristics"))) },
            ...
            { json: "ingredient", js: "ingredient", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "routeOfAdministration", js: "routeOfAdministration", typ: u(undefined, a(r("RouteOfAdministration"))) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "unitOfPresentation", js: "unitOfPresentation", typ: u(undefined, r("PurpleType")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "RouteOfAdministration": o([
            { json: "code", js: "code", typ: r("PurpleType") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "firstDose", js: "firstDose", typ: u(undefined, r("ValueQuantity")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "maxDosePerDay", js: "maxDosePerDay", typ: u(undefined, r("ValueQuantity")) },
            { json: "maxDosePerTreatmentPeriod", js: "maxDosePerTreatmentPeriod", typ: u(undefined, r("ValueRatio")) },
            { json: "maxSingleDose", js: "maxSingleDose", typ: u(undefined, r("ValueQuantity")) },
            { json: "maxTreatmentPeriod", js: "maxTreatmentPeriod", typ: u(undefined, r("ValueDuration")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "targetSpecies", js: "targetSpecies", typ: u(undefined, a(r("TargetSpecies"))) },
        ], false),
        "TargetSpecies": o([
            { json: "code", js: "code", typ: r("PurpleType") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "withdrawalPeriod", js: "withdrawalPeriod", typ: u(undefined, a(r("WithdrawalPeriod"))) },
        ], false),
        "WithdrawalPeriod": o([
            { json: "_supportingInformation", js: "_supportingInformation", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "supportingInformation", js: "supportingInformation", typ: u(undefined, "") },
            { json: "tissue", js: "tissue", typ: r("PurpleType") },
            { json: "value", js: "value", typ: r("ValueQuantity") },
        ], false),
        "Text": o([
