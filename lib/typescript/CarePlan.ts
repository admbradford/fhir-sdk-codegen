// To parse this data:
//
//   import { Convert, CarePlan } from "./file";
//
//   const carePlan = Convert.toCarePlan(json);
//
...
export interface Activity {
     ...
     */
    outcomeCodeableConcept?: PurpleType[];
    /**
     ...
     */
    outcomeReference?: HammerfestPonies[];
    /**
     * Notes about the adherence/status/progress of the activity.
     */
    progress?: ValueAnnotation[];
    /**
     * The details of the proposed activity represented in a specific resource.
     */
...
export interface Detail {
     ...
     * Identifies the food, drug or other product to be consumed or supplied in the activity.
     */
    productReference?: HammerfestPonies;
    /**
     * Identifies the quantity expected to be supplied, administered or consumed by the subject.
     */
...
export namespace Convert {
    export function toCarePlan(json: string): CarePlan {
        return cast(JSON.parse(json), r("CarePlan"));
    }

    export function carePlanToJson(value: CarePlan): string {
        return JSON.stringify(uncast(value, r("CarePlan")), null, 2);
    }
    ...
    const typeMap: any = {
        "CarePlan": o([
            ...
            { json: "activity", js: "activity", typ: u(undefined, a(r("Activity"))) },
            ...
            { json: "careTeam", js: "careTeam", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "contributor", js: "contributor", typ: u(undefined, a(r("HammerfestPonies"))) },
            ...
            { json: "goal", js: "goal", typ: u(undefined, a(r("HammerfestPonies"))) },
            ...
            { json: "replaces", js: "replaces", typ: u(undefined, a(r("HammerfestPonies"))) },
        ...
        "Activity": o([
            { json: "detail", js: "detail", typ: u(undefined, r("Detail")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "outcomeCodeableConcept", js: "outcomeCodeableConcept", typ: u(undefined, a(r("PurpleType"))) },
            { json: "outcomeReference", js: "outcomeReference", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "progress", js: "progress", typ: u(undefined, a(r("ValueAnnotation"))) },
        ...
        "Detail": o([
            ...
            { json: "_scheduledString", js: "_scheduledString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "dailyAmount", js: "dailyAmount", typ: u(undefined, r("ValueQuantity")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "performer", js: "performer", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "productCodeableConcept", js: "productCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "productReference", js: "productReference", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "scheduledPeriod", js: "scheduledPeriod", typ: u(undefined, r("Period")) },
            { json: "scheduledString", js: "scheduledString", typ: u(undefined, "") },
            { json: "scheduledTiming", js: "scheduledTiming", typ: u(undefined, r("ValueTiming")) },
            { json: "status", js: "status", typ: u(undefined, r("DetailStatus")) },
