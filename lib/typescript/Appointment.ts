...
export interface Appointment {
     ...
     */
    serviceCategory?: PurpleType[];
    /**
     * The specific service that is to be performed during this appointment.
     */
    serviceType?: PurpleType[];
    /**
     * The slots from the participants' schedules that will be filled by the appointment.
     */
    slot?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toAppointment(json: string): Appointment {
        return cast(JSON.parse(json), r("Appointment"));
    }

    export function appointmentToJson(value: Appointment): string {
        return JSON.stringify(uncast(value, r("Appointment")), null, 2);
    }
    ...
    const typeMap: any = {
        "Appointment": o([
            ...
            { json: "_minutesDuration", js: "_minutesDuration", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "appointmentType", js: "appointmentType", typ: u(undefined, r("PurpleType")) },
            { json: "basedOn", js: "basedOn", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "cancelationReason", js: "cancelationReason", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "minutesDuration", js: "minutesDuration", typ: u(undefined, 3.14) },
            ...
            { json: "requestedPeriod", js: "requestedPeriod", typ: u(undefined, a(r("Period"))) },
            { json: "serviceCategory", js: "serviceCategory", typ: u(undefined, a(r("PurpleType"))) },
            { json: "serviceType", js: "serviceType", typ: u(undefined, a(r("PurpleType"))) },
            { json: "slot", js: "slot", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "Participant": o([
            ...
            { json: "status", js: "status", typ: u(undefined, r("ParticipantStatus")) },
