// To parse this data:
//
//   import { Convert, RelatedPerson } from "./file";
//
//   const relatedPerson = Convert.toRelatedPerson(json);
//
...
export namespace Convert {
    export function toRelatedPerson(json: string): RelatedPerson {
        return cast(JSON.parse(json), r("RelatedPerson"));
    }

    export function relatedPersonToJson(value: RelatedPerson): string {
        return JSON.stringify(uncast(value, r("RelatedPerson")), null, 2);
    }
