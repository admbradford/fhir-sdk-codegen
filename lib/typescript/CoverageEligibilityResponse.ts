// To parse this data:
//
//   import { Convert, CoverageEligibilityResponse } from "./file";
//
//   const coverageEligibilityResponse = Convert.toCoverageEligibilityResponse(json);
//
...
export interface Item {
     ...
     * Extensions for authorizationRequired
     */
    _authorizationRequired?: PuneHedgehog;
    /**
     * Extensions for authorizationUrl
     */
    _authorizationUrl?: PuneHedgehog;
    /**
     * Extensions for description
     */
    _description?: PuneHedgehog;
     ...
     */
    authorizationSupporting?: PurpleType[];
    /**
...
export namespace Convert {
    export function toCoverageEligibilityResponse(json: string): CoverageEligibilityResponse {
        return cast(JSON.parse(json), r("CoverageEligibilityResponse"));
    }

    export function coverageEligibilityResponseToJson(value: CoverageEligibilityResponse): string {
        return JSON.stringify(uncast(value, r("CoverageEligibilityResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "CoverageEligibilityResponse": o([
            ...
            { json: "_purpose", js: "_purpose", typ: u(undefined, a(r("PuneHedgehog"))) },
            ...
            { json: "form", js: "form", typ: u(undefined, r("PurpleType")) },
        ...
        "Error": o([
            { json: "code", js: "code", typ: r("PurpleType") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Insurance": o([
            { json: "_inforce", js: "_inforce", typ: u(undefined, r("PuneHedgehog")) },
            { json: "benefitPeriod", js: "benefitPeriod", typ: u(undefined, r("Period")) },
            { json: "coverage", js: "coverage", typ: r("AuthorReference") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "inforce", js: "inforce", typ: u(undefined, true) },
            { json: "item", js: "item", typ: u(undefined, a(r("Item"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Item": o([
            { json: "_authorizationRequired", js: "_authorizationRequired", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_authorizationUrl", js: "_authorizationUrl", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_excluded", js: "_excluded", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "authorizationRequired", js: "authorizationRequired", typ: u(undefined, true) },
            { json: "authorizationSupporting", js: "authorizationSupporting", typ: u(undefined, a(r("PurpleType"))) },
            { json: "authorizationUrl", js: "authorizationUrl", typ: u(undefined, "") },
            { json: "benefit", js: "benefit", typ: u(undefined, a(r("Benefit"))) },
            { json: "category", js: "category", typ: u(undefined, r("PurpleType")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "excluded", js: "excluded", typ: u(undefined, true) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifier", js: "modifier", typ: u(undefined, a(r("PurpleType"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "network", js: "network", typ: u(undefined, r("PurpleType")) },
            { json: "productOrService", js: "productOrService", typ: u(undefined, r("PurpleType")) },
            { json: "provider", js: "provider", typ: u(undefined, r("AuthorReference")) },
            { json: "term", js: "term", typ: u(undefined, r("PurpleType")) },
            { json: "unit", js: "unit", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Benefit": o([
            ...
            { json: "_usedString", js: "_usedString", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "usedString", js: "usedString", typ: u(undefined, "") },
