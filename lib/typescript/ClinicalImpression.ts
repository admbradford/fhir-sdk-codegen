// To parse this data:
//
//   import { Convert, ClinicalImpression } from "./file";
//
//   const clinicalImpression = Convert.toClinicalImpression(json);
//
...
export interface ClinicalImpression {
     ...
     */
    _summary?: PuneHedgehog;
    /**
     * The clinician performing the assessment.
     */
    assessor?: AuthorReference;
    /**
     ...
     */
    previous?: AuthorReference;
    /**
     * A list of the relevant problems/conditions for a patient.
     */
    problem?: AuthorReference[];
    /**
     * Estimate of likely outcome.
     */
    prognosisCodeableConcept?: PurpleType[];
    /**
     * RiskAssessment expressing likely outcome.
     */
    prognosisReference?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toClinicalImpression(json: string): ClinicalImpression {
        return cast(JSON.parse(json), r("ClinicalImpression"));
    }

    export function clinicalImpressionToJson(value: ClinicalImpression): string {
        return JSON.stringify(uncast(value, r("ClinicalImpression")), null, 2);
    }
    ...
    const typeMap: any = {
        "ClinicalImpression": o([
            ...
            { json: "_protocol", js: "_protocol", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_summary", js: "_summary", typ: u(undefined, r("PuneHedgehog")) },
            { json: "assessor", js: "assessor", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "finding", js: "finding", typ: u(undefined, a(r("Finding"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "investigation", js: "investigation", typ: u(undefined, a(r("Investigation"))) },
            ...
            { json: "previous", js: "previous", typ: u(undefined, r("AuthorReference")) },
            { json: "problem", js: "problem", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "prognosisCodeableConcept", js: "prognosisCodeableConcept", typ: u(undefined, a(r("PurpleType"))) },
            { json: "prognosisReference", js: "prognosisReference", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "protocol", js: "protocol", typ: u(undefined, a("")) },
        ...
        "Finding": o([
            { json: "_basis", js: "_basis", typ: u(undefined, r("PuneHedgehog")) },
            { json: "basis", js: "basis", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
        ...
        "Investigation": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "item", js: "item", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Meta": o([
