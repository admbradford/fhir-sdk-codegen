// To parse this data:
//
//   import { Convert, ServiceRequest } from "./file";
//
//   const serviceRequest = Convert.toServiceRequest(json);
//
...
export interface ServiceRequest {
     ...
     * 1.8 Gy per fraction).
     */
    quantityRange?: ValueRange;
    /**
     * An amount of service being requested which can be a quantity ( for example $1,500 home
     * modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to
     * 1.8 Gy per fraction).
     */
    quantityRatio?: ValueRatio;
    /**
     ...
     */
    relevantHistory?: AuthorReference[];
    /**
     ...
     * measurements.
     */
    supportingInfo?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toServiceRequest(json: string): ServiceRequest {
        return cast(JSON.parse(json), r("ServiceRequest"));
    }

    export function serviceRequestToJson(value: ServiceRequest): string {
        return JSON.stringify(uncast(value, r("ServiceRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "ServiceRequest": o([
            ...
            { json: "insurance", js: "insurance", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "intent", js: "intent", typ: u(undefined, "") },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "locationCode", js: "locationCode", typ: u(undefined, a(r("PurpleType"))) },
            { json: "locationReference", js: "locationReference", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "orderDetail", js: "orderDetail", typ: u(undefined, a(r("PurpleType"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "performer", js: "performer", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "performerType", js: "performerType", typ: u(undefined, r("PurpleType")) },
            { json: "priority", js: "priority", typ: u(undefined, "") },
            { json: "quantityQuantity", js: "quantityQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "quantityRange", js: "quantityRange", typ: u(undefined, r("ValueRange")) },
            { json: "quantityRatio", js: "quantityRatio", typ: u(undefined, r("ValueRatio")) },
            ...
            { json: "relevantHistory", js: "relevantHistory", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "replaces", js: "replaces", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "requester", js: "requester", typ: u(undefined, r("AuthorReference")) },
            { json: "requisition", js: "requisition", typ: u(undefined, r("Identifier")) },
            { json: "specimen", js: "specimen", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "subject", js: "subject", typ: u(undefined, r("AuthorReference")) },
            { json: "supportingInfo", js: "supportingInfo", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
            { json: "use", js: "use", typ: u(undefined, r("RequisitionUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
