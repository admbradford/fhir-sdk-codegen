// To parse this data:
//
//   import { Convert, EventDefinition } from "./file";
//
//   const eventDefinition = Convert.toEventDefinition(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * The EventDefinition resource provides a reusable description of when a particular event
 * can occur.
 */
...
export namespace Convert {
    export function toEventDefinition(json: string): EventDefinition {
        return cast(JSON.parse(json), r("EventDefinition"));
    }

    export function eventDefinitionToJson(value: EventDefinition): string {
        return JSON.stringify(uncast(value, r("EventDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "EventDefinition": o([
            ...
            { json: "status", js: "status", typ: u(undefined, r("EventDefinitionStatus")) },
