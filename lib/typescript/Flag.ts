// To parse this data:
//
//   import { Convert, Flag } from "./file";
//
//   const flag = Convert.toFlag(json);
//
...
export namespace Convert {
    export function toFlag(json: string): Flag {
        return cast(JSON.parse(json), r("Flag"));
    }

    export function flagToJson(value: Flag): string {
        return JSON.stringify(uncast(value, r("Flag")), null, 2);
    }
    ...
    const typeMap: any = {
        "Flag": o([
            ...
            { json: "category", js: "category", typ: u(undefined, a(r("CodeElement"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("FlagStatus")) },
