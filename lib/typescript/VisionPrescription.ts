// To parse this data:
//
//   import { Convert, VisionPrescription } from "./file";
//
//   const visionPrescription = Convert.toVisionPrescription(json);
//
...
export interface LensSpecification {
     ...
     * Extensions for cylinder
     */
    _cylinder?: PuneHedgehog;
    /**
     * Extensions for diameter
     */
    _diameter?: PuneHedgehog;
    /**
     * Extensions for eye
     */
    _eye?: PuneHedgehog;
...
export namespace Convert {
    export function toVisionPrescription(json: string): VisionPrescription {
        return cast(JSON.parse(json), r("VisionPrescription"));
    }

    export function visionPrescriptionToJson(value: VisionPrescription): string {
        return JSON.stringify(uncast(value, r("VisionPrescription")), null, 2);
    }
    ...
    const typeMap: any = {
        "VisionPrescription": o([
            { json: "_created", js: "_created", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_dateWritten", js: "_dateWritten", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "dateWritten", js: "dateWritten", typ: u(undefined, "") },
            ...
            { json: "lensSpecification", js: "lensSpecification", typ: u(undefined, a(r("LensSpecification"))) },
            ...
            { json: "prescriber", js: "prescriber", typ: u(undefined, r("AuthorReference")) },
        ...
        "LensSpecification": o([
            { json: "_add", js: "_add", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_axis", js: "_axis", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_backCurve", js: "_backCurve", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_brand", js: "_brand", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_color", js: "_color", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_cylinder", js: "_cylinder", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_diameter", js: "_diameter", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_eye", js: "_eye", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_power", js: "_power", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_sphere", js: "_sphere", typ: u(undefined, r("PuneHedgehog")) },
            { json: "add", js: "add", typ: u(undefined, 3.14) },
            { json: "axis", js: "axis", typ: u(undefined, 3.14) },
            { json: "backCurve", js: "backCurve", typ: u(undefined, 3.14) },
            { json: "brand", js: "brand", typ: u(undefined, "") },
            { json: "color", js: "color", typ: u(undefined, "") },
            { json: "cylinder", js: "cylinder", typ: u(undefined, 3.14) },
            { json: "diameter", js: "diameter", typ: u(undefined, 3.14) },
            { json: "duration", js: "duration", typ: u(undefined, r("ValueQuantity")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "eye", js: "eye", typ: u(undefined, r("Eye")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "note", js: "note", typ: u(undefined, a(r("ValueAnnotation"))) },
            { json: "power", js: "power", typ: u(undefined, 3.14) },
            { json: "prism", js: "prism", typ: u(undefined, a(r("Prism"))) },
            { json: "product", js: "product", typ: r("TypeElement") },
            { json: "sphere", js: "sphere", typ: u(undefined, 3.14) },
        ], false),
        "Prism": o([
            { json: "_amount", js: "_amount", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_base", js: "_base", typ: u(undefined, r("PuneHedgehog")) },
