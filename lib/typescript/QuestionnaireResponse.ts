// To parse this data:
//
//   import { Convert, QuestionnaireResponse } from "./file";
//
//   const questionnaireResponse = Convert.toQuestionnaireResponse(json);
//
...
export namespace Convert {
    export function toQuestionnaireResponse(json: string): QuestionnaireResponse {
        return cast(JSON.parse(json), r("QuestionnaireResponse"));
    }

    export function questionnaireResponseToJson(value: QuestionnaireResponse): string {
        return JSON.stringify(uncast(value, r("QuestionnaireResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "QuestionnaireResponse": o([
            { json: "_authored", js: "_authored", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "authored", js: "authored", typ: u(undefined, "") },
            ...
            { json: "questionnaire", js: "questionnaire", typ: u(undefined, "") },
            { json: "source", js: "source", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("QuestionnaireResponseStatus")) },
