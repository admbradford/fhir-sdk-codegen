// To parse this data:
//
//   import { Convert, CareTeam } from "./file";
//
//   const careTeam = Convert.toCareTeam(json);
//
...
export namespace Convert {
    export function toCareTeam(json: string): CareTeam {
        return cast(JSON.parse(json), r("CareTeam"));
    }

    export function careTeamToJson(value: CareTeam): string {
        return JSON.stringify(uncast(value, r("CareTeam")), null, 2);
    }
    ...
    const typeMap: any = {
        "CareTeam": o([
            ...
            { json: "managingOrganization", js: "managingOrganization", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("CareTeamStatus")) },
        ...
        "Participant": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "member", js: "member", typ: u(undefined, r("AuthorReference")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "onBehalfOf", js: "onBehalfOf", typ: u(undefined, r("AuthorReference")) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
