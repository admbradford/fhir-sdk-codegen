// To parse this data:
//
//   import { Convert, CoverageEligibilityRequest } from "./file";
//
//   const coverageEligibilityRequest = Convert.toCoverageEligibilityRequest(json);
//
...
export interface Item {
     ...
     */
    _supportingInfoSequence?: PuneHedgehog[];
    /**
     * Code to identify the general type of benefits under which products and services are
     * provided.
     */
...
export interface Diagnosis {
     ...
     * Condition.
     */
    diagnosisCodeableConcept?: PurpleType;
    /**
     * The nature of illness or problem in a coded form or as a reference to an external defined
     * Condition.
     */
    diagnosisReference?: AuthorReference;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export namespace Convert {
    export function toCoverageEligibilityRequest(json: string): CoverageEligibilityRequest {
        return cast(JSON.parse(json), r("CoverageEligibilityRequest"));
    }

    export function coverageEligibilityRequestToJson(value: CoverageEligibilityRequest): string {
        return JSON.stringify(uncast(value, r("CoverageEligibilityRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "CoverageEligibilityRequest": o([
            ...
            { json: "enterer", js: "enterer", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "facility", js: "facility", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "priority", js: "priority", typ: u(undefined, r("PurpleType")) },
        ...
        "Item": o([
            { json: "_supportingInfoSequence", js: "_supportingInfoSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "category", js: "category", typ: u(undefined, r("PurpleType")) },
            { json: "detail", js: "detail", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "supportingInfoSequence", js: "supportingInfoSequence", typ: u(undefined, a(3.14)) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "Diagnosis": o([
            { json: "diagnosisCodeableConcept", js: "diagnosisCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "diagnosisReference", js: "diagnosisReference", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        ...
        "SupportingInfo": o([
            { json: "_appliesToAll", js: "_appliesToAll", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "appliesToAll", js: "appliesToAll", typ: u(undefined, true) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "information", js: "information", typ: r("AuthorReference") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
        ], false),
        "Text": o([
