// To parse this data:
//
//   import { Convert, EvidenceVariable } from "./file";
//
//   const evidenceVariable = Convert.toEvidenceVariable(json);
//
...
export interface ValueTriggerDefinition {
     ...
     */
    type?: DefinitionTriggerDefinitionType;
}
 ...
 * The type of triggering event.
 */
export enum DefinitionTriggerDefinitionType {
...
export interface Characteristic {
     ...
     * DataRequirements (such as Diabetes diagnosis onset in the last year).
     */
    definitionReference?: AuthorReference;
    /**
     * Define members of the evidence element using Codes (such as condition, medication, or
     * observation), Expressions ( using an expression language such as FHIRPath or CQL) or
     * DataRequirements (such as Diabetes diagnosis onset in the last year).
     */
    definitionTriggerDefinition?: ValueTriggerDefinition;
    /**
...
export namespace Convert {
    export function toEvidenceVariable(json: string): EvidenceVariable {
        return cast(JSON.parse(json), r("EvidenceVariable"));
    }

    export function evidenceVariableToJson(value: EvidenceVariable): string {
        return JSON.stringify(uncast(value, r("EvidenceVariable")), null, 2);
    }
    ...
    const typeMap: any = {
        "EvidenceVariable": o([
            ...
            { json: "status", js: "status", typ: u(undefined, r("EvidenceVariableStatus")) },
            ...
            { json: "type", js: "type", typ: u(undefined, r("EvidenceVariableType")) },
        ...
        "ValueTriggerDefinition": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("DefinitionTriggerDefinitionType")) },
        ], false),
        "ValueSignature": o([
        ...
        "Characteristic": o([
            ...
            { json: "_groupMeasure", js: "_groupMeasure", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "definitionReference", js: "definitionReference", typ: u(undefined, r("AuthorReference")) },
            { json: "definitionTriggerDefinition", js: "definitionTriggerDefinition", typ: u(undefined, r("ValueTriggerDefinition")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "exclude", js: "exclude", typ: u(undefined, true) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "groupMeasure", js: "groupMeasure", typ: u(undefined, r("GroupMeasure")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            ...
            { json: "timeFromStart", js: "timeFromStart", typ: u(undefined, r("ValueDuration")) },
        ...
        "DefinitionTriggerDefinitionType": [
            "data-access-ended",
            "data-accessed",
            "data-added",
            "data-changed",
