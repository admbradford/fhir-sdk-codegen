...
/**
 * A photo, video, or audio recording acquired or used in healthcare. The actual content may
 * be inline or provided by direct reference.
 */
export interface Media {
    /**
     * Extensions for createdDateTime
     */
    _createdDateTime?: PuneHedgehog;
    /**
     * Extensions for deviceName
     */
    _deviceName?: PuneHedgehog;
    /**
     ...
     */
    _frames?: PuneHedgehog;
    /**
     * Extensions for height
     */
    _height?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toMedia(json: string): Media {
        return cast(JSON.parse(json), r("Media"));
    }

    export function mediaToJson(value: Media): string {
    ...
    const typeMap: any = {
        "Media": o([
            { json: "_createdDateTime", js: "_createdDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_deviceName", js: "_deviceName", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_duration", js: "_duration", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_frames", js: "_frames", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_height", js: "_height", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "frames", js: "frames", typ: u(undefined, 3.14) },
            ...
            { json: "modality", js: "modality", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "operator", js: "operator", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "view", js: "view", typ: u(undefined, r("PurpleType")) },
