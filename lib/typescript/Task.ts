...
export namespace Convert {
    export function toTask(json: string): Task {
        return cast(JSON.parse(json), r("Task"));
    }

    export function taskToJson(value: Task): string {
    ...
    const typeMap: any = {
        "Task": o([
            ...
            { json: "businessStatus", js: "businessStatus", typ: u(undefined, r("PurpleType")) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "encounter", js: "encounter", typ: u(undefined, r("AuthorReference")) },
            { json: "executionPeriod", js: "executionPeriod", typ: u(undefined, r("Period")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "focus", js: "focus", typ: u(undefined, r("AuthorReference")) },
            { json: "for", js: "for", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "input", js: "input", typ: u(undefined, a(r("Input"))) },
            { json: "instantiatesCanonical", js: "instantiatesCanonical", typ: u(undefined, "") },
            ...
            { json: "output", js: "output", typ: u(undefined, a(r("Output"))) },
            { json: "owner", js: "owner", typ: u(undefined, r("AuthorReference")) },
            { json: "partOf", js: "partOf", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "performerType", js: "performerType", typ: u(undefined, a(r("PurpleType"))) },
            { json: "priority", js: "priority", typ: u(undefined, "") },
            { json: "reasonCode", js: "reasonCode", typ: u(undefined, r("PurpleType")) },
            { json: "reasonReference", js: "reasonReference", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "restriction", js: "restriction", typ: u(undefined, r("Restriction")) },
            { json: "status", js: "status", typ: u(undefined, r("TaskStatus")) },
        ...
        "Restriction": o([
            { json: "_repetitions", js: "_repetitions", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "recipient", js: "recipient", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "repetitions", js: "repetitions", typ: u(undefined, 3.14) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
