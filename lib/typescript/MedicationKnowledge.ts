// To parse this data:
//
//   import { Convert, MedicationKnowledge } from "./file";
//
//   const medicationKnowledge = Convert.toMedicationKnowledge(json);
//
...
export interface MedicationKnowledge {
     ...
     */
    _preparationInstruction?: PuneHedgehog;
    /**
     ...
     * Crestor).
     */
    associatedMedication?: AuthorReference[];
    /**
     ...
     */
    contraindication?: AuthorReference[];
    /**
 ...
 * Information about a medication that is used to support knowledge.
 */
export interface AdministrationGuidelines {
    /**
     ...
     * Indication for use that apply to the specific administration guidelines.
     */
    indicationCodeableConcept?: PurpleType;
    /**
     * Indication for use that apply to the specific administration guidelines.
     */
...
export interface PatientCharacteristics {
     ...
     * weight, gender).
     */
    characteristicCodeableConcept?: PurpleType;
    /**
     * Specific characteristic that is relevant to the administration guideline (e.g. height,
     * weight, gender).
     */
    characteristicQuantity?: ValueQuantity;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export interface Ingredient {
     ...
     * The actual ingredient - either a substance (simple ingredient) or another medication.
     */
    itemCodeableConcept?: PurpleType;
    /**
     * The actual ingredient - either a substance (simple ingredient) or another medication.
     */
    itemReference?: AuthorReference;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
...
export interface Regulatory {
     ...
     * The authority that is specifying the regulations.
     */
    regulatoryAuthority: AuthorReference;
    /**
 ...
 * Information about a medication that is used to support knowledge.
 */
export interface RelatedMedicationKnowledge {
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export namespace Convert {
    export function toMedicationKnowledge(json: string): MedicationKnowledge {
        return cast(JSON.parse(json), r("MedicationKnowledge"));
    }

    export function medicationKnowledgeToJson(value: MedicationKnowledge): string {
        return JSON.stringify(uncast(value, r("MedicationKnowledge")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicationKnowledge": o([
            ...
            { json: "_preparationInstruction", js: "_preparationInstruction", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_synonym", js: "_synonym", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "administrationGuidelines", js: "administrationGuidelines", typ: u(undefined, a(r("AdministrationGuidelines"))) },
            { json: "amount", js: "amount", typ: u(undefined, r("ValueQuantity")) },
            { json: "associatedMedication", js: "associatedMedication", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "contraindication", js: "contraindication", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "cost", js: "cost", typ: u(undefined, a(r("Cost"))) },
            { json: "doseForm", js: "doseForm", typ: u(undefined, r("PurpleType")) },
            { json: "drugCharacteristic", js: "drugCharacteristic", typ: u(undefined, a(r("DrugCharacteristic"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "ingredient", js: "ingredient", typ: u(undefined, a(r("Ingredient"))) },
            { json: "intendedRoute", js: "intendedRoute", typ: u(undefined, a(r("PurpleType"))) },
            { json: "kinetics", js: "kinetics", typ: u(undefined, a(r("Kinetics"))) },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "manufacturer", js: "manufacturer", typ: u(undefined, r("AuthorReference")) },
            { json: "medicineClassification", js: "medicineClassification", typ: u(undefined, a(r("MedicineClassification"))) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "monitoringProgram", js: "monitoringProgram", typ: u(undefined, a(r("MonitoringProgram"))) },
            { json: "monograph", js: "monograph", typ: u(undefined, a(r("Monograph"))) },
            { json: "packaging", js: "packaging", typ: u(undefined, r("Packaging")) },
            { json: "preparationInstruction", js: "preparationInstruction", typ: u(undefined, "") },
            { json: "productType", js: "productType", typ: u(undefined, a(r("PurpleType"))) },
            { json: "regulatory", js: "regulatory", typ: u(undefined, a(r("Regulatory"))) },
            { json: "relatedMedicationKnowledge", js: "relatedMedicationKnowledge", typ: u(undefined, a(r("RelatedMedicationKnowledge"))) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "synonym", js: "synonym", typ: u(undefined, a("")) },
        ...
        "AdministrationGuidelines": o([
            { json: "dosage", js: "dosage", typ: u(undefined, a(r("Dosage"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "indicationCodeableConcept", js: "indicationCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "indicationReference", js: "indicationReference", typ: u(undefined, r("AuthorReference")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientCharacteristics", js: "patientCharacteristics", typ: u(undefined, a(r("PatientCharacteristics"))) },
        ], false),
        "Dosage": o([
            { json: "dosage", js: "dosage", typ: a(r("ValueDosage")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: r("PurpleType") },
        ], false),
        "PatientCharacteristics": o([
            { json: "_value", js: "_value", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "characteristicCodeableConcept", js: "characteristicCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "characteristicQuantity", js: "characteristicQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Cost": o([
            ...
            { json: "cost", js: "cost", typ: r("ValueMoney") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Ingredient": o([
            { json: "_isActive", js: "_isActive", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "isActive", js: "isActive", typ: u(undefined, true) },
            { json: "itemCodeableConcept", js: "itemCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "itemReference", js: "itemReference", typ: u(undefined, r("AuthorReference")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "strength", js: "strength", typ: u(undefined, r("ValueRatio")) },
        ], false),
        "Kinetics": o([
            { json: "areaUnderCurve", js: "areaUnderCurve", typ: u(undefined, a(r("ValueQuantity"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "halfLifePeriod", js: "halfLifePeriod", typ: u(undefined, r("ValueDuration")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "lethalDose50", js: "lethalDose50", typ: u(undefined, a(r("ValueQuantity"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "MedicineClassification": o([
            { json: "classification", js: "classification", typ: u(undefined, a(r("PurpleType"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: r("PurpleType") },
        ...
        "Monograph": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "source", js: "source", typ: u(undefined, r("AuthorReference")) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Packaging": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Regulatory": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "maxDispense", js: "maxDispense", typ: u(undefined, r("MaxDispense")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "regulatoryAuthority", js: "regulatoryAuthority", typ: r("AuthorReference") },
            { json: "schedule", js: "schedule", typ: u(undefined, a(r("Schedule"))) },
            { json: "substitution", js: "substitution", typ: u(undefined, a(r("Substitution"))) },
        ], false),
        "MaxDispense": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "period", js: "period", typ: u(undefined, r("ValueDuration")) },
            { json: "quantity", js: "quantity", typ: r("ValueQuantity") },
        ], false),
        "Schedule": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "schedule", js: "schedule", typ: r("PurpleType") },
        ], false),
        "Substitution": o([
            { json: "_allowed", js: "_allowed", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "RelatedMedicationKnowledge": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reference", js: "reference", typ: a(r("AuthorReference")) },
            { json: "type", js: "type", typ: r("PurpleType") },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
