// To parse this data:
//
//   import { Convert, SpecimenDefinition } from "./file";
//
//   const specimenDefinition = Convert.toSpecimenDefinition(json);
//
...
export interface SpecimenDefinition {
     ...
     */
    _timeAspect?: PuneHedgehog;
    /**
     * The action to be performed for collecting the specimen.
     */
    collection?: PurpleType[];
    /**
 ...
 * Conditions that are not related to temperature may be handled in the instruction
 * element.
 *
 ...
 * A kind of specimen with associated set of requirements.
 */
export interface TypeTested {
    /**
     * Extensions for isDerived
     */
    _isDerived?: PuneHedgehog;
    /**
     * Extensions for preference
     */
    _preference?: PuneHedgehog;
    /**
     * Extensions for requirement
     */
    _requirement?: PuneHedgehog;
    /**
...
export interface Container {
     ...
     * Extensions for minimumVolumeString
     */
    _minimumVolumeString?: PuneHedgehog;
    /**
     * Extensions for preparation
     */
    _preparation?: PuneHedgehog;
    /**
     * Substance introduced in the kind of container to preserve, maintain or enhance the
     * specimen. Examples: Formalin, Citrate, EDTA.
     */
     ...
     * The minimum volume to be conditioned in the container.
     */
    minimumVolumeQuantity?: ValueQuantity;
    /**
     * The minimum volume to be conditioned in the container.
     */
...
export interface Additive {
     ...
     * specimen. Examples: Formalin, Citrate, EDTA.
     */
    additiveCodeableConcept?: PurpleType;
    /**
     * Substance introduced in the kind of container to preserve, maintain or enhance the
     * specimen. Examples: Formalin, Citrate, EDTA.
     */
    additiveReference?: AuthorReference;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export interface Handling {
     ...
     */
    temperatureQualifier?: PurpleType;
    /**
     * The temperature interval for this set of handling instructions.
     */
...
export namespace Convert {
    export function toSpecimenDefinition(json: string): SpecimenDefinition {
        return cast(JSON.parse(json), r("SpecimenDefinition"));
    }

    export function specimenDefinitionToJson(value: SpecimenDefinition): string {
        return JSON.stringify(uncast(value, r("SpecimenDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "SpecimenDefinition": o([
            ...
            { json: "_timeAspect", js: "_timeAspect", typ: u(undefined, r("PuneHedgehog")) },
            { json: "collection", js: "collection", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "patientPreparation", js: "patientPreparation", typ: u(undefined, a(r("PurpleType"))) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "timeAspect", js: "timeAspect", typ: u(undefined, "") },
            { json: "typeCollected", js: "typeCollected", typ: u(undefined, r("PurpleType")) },
            { json: "typeTested", js: "typeTested", typ: u(undefined, a(r("TypeTested"))) },
        ], false),
        "ValueUsageContext": o([
        ...
        "TypeTested": o([
            { json: "_isDerived", js: "_isDerived", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_preference", js: "_preference", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_requirement", js: "_requirement", typ: u(undefined, r("PuneHedgehog")) },
            { json: "container", js: "container", typ: u(undefined, r("Container")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "handling", js: "handling", typ: u(undefined, a(r("Handling"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "isDerived", js: "isDerived", typ: u(undefined, true) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "preference", js: "preference", typ: u(undefined, r("Preference")) },
            { json: "rejectionCriterion", js: "rejectionCriterion", typ: u(undefined, a(r("PurpleType"))) },
            { json: "requirement", js: "requirement", typ: u(undefined, "") },
            { json: "retentionTime", js: "retentionTime", typ: u(undefined, r("ValueDuration")) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Container": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_minimumVolumeString", js: "_minimumVolumeString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_preparation", js: "_preparation", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additive", js: "additive", typ: u(undefined, a(r("Additive"))) },
            { json: "cap", js: "cap", typ: u(undefined, r("PurpleType")) },
            { json: "capacity", js: "capacity", typ: u(undefined, r("ValueQuantity")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "material", js: "material", typ: u(undefined, r("PurpleType")) },
            { json: "minimumVolumeQuantity", js: "minimumVolumeQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "minimumVolumeString", js: "minimumVolumeString", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "preparation", js: "preparation", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Additive": o([
            { json: "additiveCodeableConcept", js: "additiveCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "additiveReference", js: "additiveReference", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Handling": o([
            ...
            { json: "maxDuration", js: "maxDuration", typ: u(undefined, r("ValueDuration")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "temperatureQualifier", js: "temperatureQualifier", typ: u(undefined, r("PurpleType")) },
            { json: "temperatureRange", js: "temperatureRange", typ: u(undefined, r("ValueRange")) },
        ], false),
