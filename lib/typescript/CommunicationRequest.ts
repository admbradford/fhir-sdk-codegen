// To parse this data:
//
//   import { Convert, CommunicationRequest } from "./file";
//
//   const communicationRequest = Convert.toCommunicationRequest(json);
//
...
export namespace Convert {
    export function toCommunicationRequest(json: string): CommunicationRequest {
        return cast(JSON.parse(json), r("CommunicationRequest"));
    }

    export function communicationRequestToJson(value: CommunicationRequest): string {
        return JSON.stringify(uncast(value, r("CommunicationRequest")), null, 2);
    }
