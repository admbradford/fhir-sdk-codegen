// To parse this data:
//
//   import { Convert, DiagnosticReport } from "./file";
//
//   const diagnosticReport = Convert.toDiagnosticReport(json);
//
...
export namespace Convert {
    export function toDiagnosticReport(json: string): DiagnosticReport {
        return cast(JSON.parse(json), r("DiagnosticReport"));
    }

    export function diagnosticReportToJson(value: DiagnosticReport): string {
        return JSON.stringify(uncast(value, r("DiagnosticReport")), null, 2);
    }
    ...
    const typeMap: any = {
        "DiagnosticReport": o([
            { json: "_conclusion", js: "_conclusion", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "conclusionCode", js: "conclusionCode", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "imagingStudy", js: "imagingStudy", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "presentedForm", js: "presentedForm", typ: u(undefined, a(r("ValueAttachment"))) },
            { json: "result", js: "result", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "resultsInterpreter", js: "resultsInterpreter", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "specimen", js: "specimen", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, r("DiagnosticReportStatus")) },
        ...
        "Media": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "link", js: "link", typ: r("AuthorReference") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Meta": o([
