// To parse this data:
//
//   import { Convert, RiskEvidenceSynthesis } from "./file";
//
//   const riskEvidenceSynthesis = Convert.toRiskEvidenceSynthesis(json);
//
...
export interface RiskEstimate {
     ...
     * Extensions for denominatorCount
     */
    _denominatorCount?: PuneHedgehog;
    /**
     * Extensions for description
     */
    _description?: PuneHedgehog;
...
export namespace Convert {
    export function toRiskEvidenceSynthesis(json: string): RiskEvidenceSynthesis {
        return cast(JSON.parse(json), r("RiskEvidenceSynthesis"));
    }

    export function riskEvidenceSynthesisToJson(value: RiskEvidenceSynthesis): string {
        return JSON.stringify(uncast(value, r("RiskEvidenceSynthesis")), null, 2);
    }
    ...
    const typeMap: any = {
        "RiskEvidenceSynthesis": o([
            ...
            { json: "riskEstimate", js: "riskEstimate", typ: u(undefined, r("RiskEstimate")) },
            { json: "sampleSize", js: "sampleSize", typ: u(undefined, r("SampleSize")) },
            { json: "status", js: "status", typ: u(undefined, r("RiskEvidenceSynthesisStatus")) },
        ...
        "RiskEstimate": o([
            { json: "_denominatorCount", js: "_denominatorCount", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_numeratorCount", js: "_numeratorCount", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_value", js: "_value", typ: u(undefined, r("PuneHedgehog")) },
            { json: "denominatorCount", js: "denominatorCount", typ: u(undefined, 3.14) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "numeratorCount", js: "numeratorCount", typ: u(undefined, 3.14) },
