// To parse this data:
//
//   import { Convert, RiskAssessment } from "./file";
//
//   const riskAssessment = Convert.toRiskAssessment(json);
//
...
export interface Prediction {
     ...
     * Extensions for probabilityDecimal
     */
    _probabilityDecimal?: PuneHedgehog;
    /**
     * Extensions for rationale
     */
     ...
     * Indicates how likely the outcome is (in the specified timeframe).
     */
    probabilityRange?: ValueRange;
    /**
     * Indicates how likely the outcome is (in the specified timeframe), expressed as a
     * qualitative value (e.g. low, medium, or high).
     */
    qualitativeRisk?: PurpleType;
    /**
...
export namespace Convert {
    export function toRiskAssessment(json: string): RiskAssessment {
        return cast(JSON.parse(json), r("RiskAssessment"));
    }

    export function riskAssessmentToJson(value: RiskAssessment): string {
        return JSON.stringify(uncast(value, r("RiskAssessment")), null, 2);
    }
    ...
    const typeMap: any = {
        "RiskAssessment": o([
            ...
            { json: "_mitigation", js: "_mitigation", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "basedOn", js: "basedOn", typ: u(undefined, r("AuthorReference")) },
            { json: "basis", js: "basis", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "condition", js: "condition", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "mitigation", js: "mitigation", typ: u(undefined, "") },
            ...
            { json: "prediction", js: "prediction", typ: u(undefined, a(r("Prediction"))) },
        ...
        "Prediction": o([
            { json: "_probabilityDecimal", js: "_probabilityDecimal", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_rationale", js: "_rationale", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_relativeRisk", js: "_relativeRisk", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "outcome", js: "outcome", typ: u(undefined, r("PurpleType")) },
            { json: "probabilityDecimal", js: "probabilityDecimal", typ: u(undefined, 3.14) },
            { json: "probabilityRange", js: "probabilityRange", typ: u(undefined, r("ValueRange")) },
            { json: "qualitativeRisk", js: "qualitativeRisk", typ: u(undefined, r("PurpleType")) },
            { json: "rationale", js: "rationale", typ: u(undefined, "") },
            { json: "relativeRisk", js: "relativeRisk", typ: u(undefined, 3.14) },
            { json: "whenPeriod", js: "whenPeriod", typ: u(undefined, r("Period")) },
            { json: "whenRange", js: "whenRange", typ: u(undefined, r("ValueRange")) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
