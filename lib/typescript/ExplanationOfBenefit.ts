// To parse this data:
//
//   import { Convert, ExplanationOfBenefit } from "./file";
//
//   const explanationOfBenefit = Convert.toExplanationOfBenefit(json);
//
...
export interface ExplanationOfBenefit {
     ...
     */
    _created?: PuneHedgehog;
    /**
     * Extensions for disposition
     */
    _disposition?: PuneHedgehog;
    /**
     ...
     */
    _outcome?: PuneHedgehog;
    /**
     * Extensions for preAuthRef
     */
    _preAuthRef?: PuneHedgehog[];
    /**
     * Extensions for precedence
     */
    _precedence?: PuneHedgehog;
    /**
     ...
     */
    facility?: HammerfestPonies;
    /**
     * The actual form, by reference or inclusion, for printing the content or an EOB.
     */
    form?: ValueAttachment;
    /**
     * A code for the form to be used for printing the content.
     */
    formCode?: ArakGroundhog;
    /**
     ...
     */
    fundsReserve?: ArakGroundhog;
    /**
     * A code to indicate whether and for whom funds are to be reserved for future claims.
     */
    fundsReserveRequested?: ArakGroundhog;
    /**
     ...
     */
    originalPrescription?: HammerfestPonies;
    /**
     ...
     */
    provider?: HammerfestPonies;
    /**
     * A reference to a referral resource.
     */
    referral?: HammerfestPonies;
    /**
 ...
 * The purpose of this address.
 */
export enum LocationAddressUse {
    Billing = "billing",
    Home = "home",
    Old = "old",
    Temp = "temp",
...
export interface Accident {
     ...
     * The physical location of the accident event.
     */
    locationAddress?: ValueAddress;
    /**
     * The physical location of the accident event.
     */
    locationReference?: HammerfestPonies;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
...
export interface AddItem {
     ...
     */
    _itemSequence?: PuneHedgehog[];
    /**
     * Extensions for noteNumber
     */
    _noteNumber?: PuneHedgehog[];
    /**
     * Extensions for servicedDate
     */
    _servicedDate?: PuneHedgehog;
    /**
     * Extensions for subDetailSequence
     */
    _subDetailSequence?: PuneHedgehog[];
    /**
     ...
     * Where the product or service was provided.
     */
    locationCodeableConcept?: ArakGroundhog;
    /**
     * Where the product or service was provided.
     */
    locationReference?: HammerfestPonies;
     ...
     * otherwise this contains the product, service, drug or other billing code for the item.
     */
    productOrService: ArakGroundhog;
    /**
     * Identifies the program under which this may be recovered.
     */
    programCode?: ArakGroundhog[];
    /**
 ...
 * benefits provided.
 */
export interface PurpleSubDetail {
    /**
     * Extensions for factor
     */
    _factor?: PuneHedgehog;
...
export interface Financial {
     ...
     * Extensions for allowedString
     */
    _allowedString?: PuneHedgehog;
    /**
     * Extensions for allowedUnsignedInt
     */
    _allowedUnsignedInt?: PuneHedgehog;
    /**
     * Extensions for usedUnsignedInt
     */
    _usedUnsignedInt?: PuneHedgehog;
    /**
     * The quantity of the benefit which is permitted under the coverage.
     */
    allowedMoney?: ValueMoney;
    /**
     * The quantity of the benefit which is permitted under the coverage.
     */
...
export interface Diagnosis {
     ...
     * Condition.
     */
    diagnosisCodeableConcept?: ArakGroundhog;
    /**
     * The nature of illness or problem in a coded form or as a reference to an external defined
     * Condition.
     */
    diagnosisReference?: HammerfestPonies;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
     ...
     * Indication of whether the diagnosis was present on admission to a facility.
     */
    onAdmission?: ArakGroundhog;
    /**
     * A package billing code or bundle code used to group products and services to a particular
     * health condition (such as heart attack) which is based on a predetermined grouping code
     * system.
     */
    packageCode?: ArakGroundhog;
    /**
...
export interface Item {
     ...
     */
    _careTeamSequence?: PuneHedgehog[];
    /**
     * Extensions for diagnosisSequence
     */
    _diagnosisSequence?: PuneHedgehog[];
    /**
     * Extensions for factor
     */
    _factor?: PuneHedgehog;
     ...
     */
    _informationSequence?: PuneHedgehog[];
    /**
     * Extensions for noteNumber
     */
    _noteNumber?: PuneHedgehog[];
     ...
     */
    _procedureSequence?: PuneHedgehog[];
    /**
     * Extensions for sequence
     */
    _sequence?: PuneHedgehog;
 ...
 * benefits provided.
 */
export interface FluffySubDetail {
    /**
     * Extensions for factor
     */
    _factor?: PuneHedgehog;
...
export interface Payment {
     ...
     * not related to this claim's adjudication.
     */
    adjustment?: ValueMoney;
    /**
     * Reason for the payment adjustment.
     */
    adjustmentReason?: ArakGroundhog;
    /**
     * Benefits payable less any payment adjustment.
     */
    amount?: ValueMoney;
...
export interface Procedure {
     ...
     * performed.
     */
    procedureCodeableConcept?: ArakGroundhog;
    /**
     * The code or reference to a Procedure resource which identifies the clinical intervention
     * performed.
     */
    procedureReference?: HammerfestPonies;
    /**
...
export namespace Convert {
    export function toExplanationOfBenefit(json: string): ExplanationOfBenefit {
        return cast(JSON.parse(json), r("ExplanationOfBenefit"));
    }

    export function explanationOfBenefitToJson(value: ExplanationOfBenefit): string {
        return JSON.stringify(uncast(value, r("ExplanationOfBenefit")), null, 2);
    }
    ...
    const typeMap: any = {
        "ExplanationOfBenefit": o([
            { json: "_created", js: "_created", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_disposition", js: "_disposition", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_outcome", js: "_outcome", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_preAuthRef", js: "_preAuthRef", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_precedence", js: "_precedence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_use", js: "_use", typ: u(undefined, r("PuneHedgehog")) },
            { json: "accident", js: "accident", typ: u(undefined, r("Accident")) },
            { json: "addItem", js: "addItem", typ: u(undefined, a(r("AddItem"))) },
            { json: "adjudication", js: "adjudication", typ: u(undefined, a(r("Adjudication"))) },
            { json: "benefitBalance", js: "benefitBalance", typ: u(undefined, a(r("BenefitBalance"))) },
            { json: "benefitPeriod", js: "benefitPeriod", typ: u(undefined, r("Period")) },
            { json: "billablePeriod", js: "billablePeriod", typ: u(undefined, r("Period")) },
            { json: "careTeam", js: "careTeam", typ: u(undefined, a(r("CareTeam"))) },
            { json: "claim", js: "claim", typ: u(undefined, r("HammerfestPonies")) },
            { json: "claimResponse", js: "claimResponse", typ: u(undefined, r("HammerfestPonies")) },
            { json: "created", js: "created", typ: u(undefined, "") },
            { json: "diagnosis", js: "diagnosis", typ: u(undefined, a(r("Diagnosis"))) },
            { json: "disposition", js: "disposition", typ: u(undefined, "") },
            { json: "enterer", js: "enterer", typ: u(undefined, r("HammerfestPonies")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "facility", js: "facility", typ: u(undefined, r("HammerfestPonies")) },
            { json: "form", js: "form", typ: u(undefined, r("ValueAttachment")) },
            { json: "formCode", js: "formCode", typ: u(undefined, r("ArakGroundhog")) },
            { json: "fundsReserve", js: "fundsReserve", typ: u(undefined, r("ArakGroundhog")) },
            { json: "fundsReserveRequested", js: "fundsReserveRequested", typ: u(undefined, r("ArakGroundhog")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "insurance", js: "insurance", typ: u(undefined, a(r("Insurance"))) },
            { json: "insurer", js: "insurer", typ: u(undefined, r("HammerfestPonies")) },
            { json: "item", js: "item", typ: u(undefined, a(r("Item"))) },
            ...
            { json: "originalPrescription", js: "originalPrescription", typ: u(undefined, r("HammerfestPonies")) },
            { json: "outcome", js: "outcome", typ: u(undefined, "") },
            { json: "patient", js: "patient", typ: u(undefined, r("HammerfestPonies")) },
            { json: "payee", js: "payee", typ: u(undefined, r("Payee")) },
            { json: "payment", js: "payment", typ: u(undefined, r("Payment")) },
            { json: "preAuthRef", js: "preAuthRef", typ: u(undefined, a("")) },
            { json: "preAuthRefPeriod", js: "preAuthRefPeriod", typ: u(undefined, a(r("Period"))) },
            { json: "precedence", js: "precedence", typ: u(undefined, 3.14) },
            { json: "prescription", js: "prescription", typ: u(undefined, r("HammerfestPonies")) },
            { json: "priority", js: "priority", typ: u(undefined, r("ArakGroundhog")) },
            { json: "procedure", js: "procedure", typ: u(undefined, a(r("Procedure"))) },
            { json: "processNote", js: "processNote", typ: u(undefined, a(r("ProcessNote"))) },
            { json: "provider", js: "provider", typ: u(undefined, r("HammerfestPonies")) },
            { json: "referral", js: "referral", typ: u(undefined, r("HammerfestPonies")) },
            { json: "related", js: "related", typ: u(undefined, a(r("Related"))) },
            { json: "status", js: "status", typ: u(undefined, r("ExplanationOfBenefitStatus")) },
            { json: "subType", js: "subType", typ: u(undefined, r("ArakGroundhog")) },
            { json: "supportingInfo", js: "supportingInfo", typ: u(undefined, a(r("SupportingInfo"))) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "total", js: "total", typ: u(undefined, a(r("Total"))) },
        ...
        "ValueAddress": o([
            ...
            { json: "text", js: "text", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("LocationAddressType")) },
            { json: "use", js: "use", typ: u(undefined, r("LocationAddressUse")) },
        ], false),
        "Extension": o([
            { json: "_url", js: "_url", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Accident": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "locationAddress", js: "locationAddress", typ: u(undefined, r("ValueAddress")) },
            { json: "locationReference", js: "locationReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: u(undefined, r("ArakGroundhog")) },
        ], false),
        "AddItem": o([
            { json: "_detailSequence", js: "_detailSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_itemSequence", js: "_itemSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_noteNumber", js: "_noteNumber", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_servicedDate", js: "_servicedDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_subDetailSequence", js: "_subDetailSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "adjudication", js: "adjudication", typ: u(undefined, a(r("Adjudication"))) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, r("ArakGroundhog")) },
            { json: "detail", js: "detail", typ: u(undefined, a(r("AddItemDetail"))) },
            { json: "detailSequence", js: "detailSequence", typ: u(undefined, a(3.14)) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "factor", js: "factor", typ: u(undefined, 3.14) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "itemSequence", js: "itemSequence", typ: u(undefined, a(3.14)) },
            { json: "locationAddress", js: "locationAddress", typ: u(undefined, r("ValueAddress")) },
            { json: "locationCodeableConcept", js: "locationCodeableConcept", typ: u(undefined, r("ArakGroundhog")) },
            { json: "locationReference", js: "locationReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifier", js: "modifier", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "net", js: "net", typ: u(undefined, r("ValueMoney")) },
            { json: "noteNumber", js: "noteNumber", typ: u(undefined, a(3.14)) },
            { json: "productOrService", js: "productOrService", typ: r("ArakGroundhog") },
            { json: "programCode", js: "programCode", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "provider", js: "provider", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "servicedDate", js: "servicedDate", typ: u(undefined, "") },
            { json: "servicedPeriod", js: "servicedPeriod", typ: u(undefined, r("Period")) },
            { json: "subDetailSequence", js: "subDetailSequence", typ: u(undefined, a(3.14)) },
            { json: "subSite", js: "subSite", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "Adjudication": o([
            { json: "_value", js: "_value", typ: u(undefined, r("PuneHedgehog")) },
            { json: "amount", js: "amount", typ: u(undefined, r("ValueMoney")) },
            { json: "category", js: "category", typ: r("ArakGroundhog") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reason", js: "reason", typ: u(undefined, r("ArakGroundhog")) },
            { json: "value", js: "value", typ: u(undefined, 3.14) },
        ], false),
        "AddItemDetail": o([
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "productOrService", js: "productOrService", typ: r("ArakGroundhog") },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "subDetail", js: "subDetail", typ: u(undefined, a(r("PurpleSubDetail"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "PurpleSubDetail": o([
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "BenefitBalance": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_excluded", js: "_excluded", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "category", js: "category", typ: r("ArakGroundhog") },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "excluded", js: "excluded", typ: u(undefined, true) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "financial", js: "financial", typ: u(undefined, a(r("Financial"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "network", js: "network", typ: u(undefined, r("ArakGroundhog")) },
            { json: "term", js: "term", typ: u(undefined, r("ArakGroundhog")) },
            { json: "unit", js: "unit", typ: u(undefined, r("ArakGroundhog")) },
        ], false),
        "Financial": o([
            { json: "_allowedString", js: "_allowedString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_allowedUnsignedInt", js: "_allowedUnsignedInt", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_usedUnsignedInt", js: "_usedUnsignedInt", typ: u(undefined, r("PuneHedgehog")) },
            { json: "allowedMoney", js: "allowedMoney", typ: u(undefined, r("ValueMoney")) },
            { json: "allowedString", js: "allowedString", typ: u(undefined, "") },
            { json: "allowedUnsignedInt", js: "allowedUnsignedInt", typ: u(undefined, 3.14) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: r("ArakGroundhog") },
            { json: "usedMoney", js: "usedMoney", typ: u(undefined, r("ValueMoney")) },
            { json: "usedUnsignedInt", js: "usedUnsignedInt", typ: u(undefined, 3.14) },
        ], false),
        "CareTeam": o([
            { json: "_responsible", js: "_responsible", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "provider", js: "provider", typ: r("HammerfestPonies") },
            { json: "qualification", js: "qualification", typ: u(undefined, r("ArakGroundhog")) },
            { json: "responsible", js: "responsible", typ: u(undefined, true) },
            { json: "role", js: "role", typ: u(undefined, r("ArakGroundhog")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
        ], false),
        "Diagnosis": o([
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "diagnosisCodeableConcept", js: "diagnosisCodeableConcept", typ: u(undefined, r("ArakGroundhog")) },
            { json: "diagnosisReference", js: "diagnosisReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "onAdmission", js: "onAdmission", typ: u(undefined, r("ArakGroundhog")) },
            { json: "packageCode", js: "packageCode", typ: u(undefined, r("ArakGroundhog")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "type", js: "type", typ: u(undefined, a(r("ArakGroundhog"))) },
        ], false),
        "Insurance": o([
            { json: "_focal", js: "_focal", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_preAuthRef", js: "_preAuthRef", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "coverage", js: "coverage", typ: r("HammerfestPonies") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "focal", js: "focal", typ: u(undefined, true) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "preAuthRef", js: "preAuthRef", typ: u(undefined, a("")) },
        ], false),
        "Item": o([
            { json: "_careTeamSequence", js: "_careTeamSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_diagnosisSequence", js: "_diagnosisSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_informationSequence", js: "_informationSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_noteNumber", js: "_noteNumber", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_procedureSequence", js: "_procedureSequence", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_servicedDate", js: "_servicedDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "adjudication", js: "adjudication", typ: u(undefined, a(r("Adjudication"))) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, r("ArakGroundhog")) },
            { json: "careTeamSequence", js: "careTeamSequence", typ: u(undefined, a(3.14)) },
            { json: "category", js: "category", typ: u(undefined, r("ArakGroundhog")) },
            { json: "detail", js: "detail", typ: u(undefined, a(r("ItemDetail"))) },
            { json: "diagnosisSequence", js: "diagnosisSequence", typ: u(undefined, a(3.14)) },
            { json: "encounter", js: "encounter", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "factor", js: "factor", typ: u(undefined, 3.14) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "informationSequence", js: "informationSequence", typ: u(undefined, a(3.14)) },
            { json: "locationAddress", js: "locationAddress", typ: u(undefined, r("ValueAddress")) },
            { json: "locationCodeableConcept", js: "locationCodeableConcept", typ: u(undefined, r("ArakGroundhog")) },
            { json: "locationReference", js: "locationReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifier", js: "modifier", typ: u(undefined, a(r("ArakGroundhog"))) },
            ...
            { json: "net", js: "net", typ: u(undefined, r("ValueMoney")) },
            { json: "noteNumber", js: "noteNumber", typ: u(undefined, a(3.14)) },
            { json: "procedureSequence", js: "procedureSequence", typ: u(undefined, a(3.14)) },
            { json: "productOrService", js: "productOrService", typ: r("ArakGroundhog") },
            { json: "programCode", js: "programCode", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "revenue", js: "revenue", typ: u(undefined, r("ArakGroundhog")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "servicedDate", js: "servicedDate", typ: u(undefined, "") },
            { json: "servicedPeriod", js: "servicedPeriod", typ: u(undefined, r("Period")) },
            { json: "subSite", js: "subSite", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "udi", js: "udi", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "ItemDetail": o([
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "revenue", js: "revenue", typ: u(undefined, r("ArakGroundhog")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "subDetail", js: "subDetail", typ: u(undefined, a(r("FluffySubDetail"))) },
            { json: "udi", js: "udi", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "FluffySubDetail": o([
        ...
        "Payee": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "party", js: "party", typ: u(undefined, r("HammerfestPonies")) },
            { json: "type", js: "type", typ: u(undefined, r("ArakGroundhog")) },
        ], false),
        "Payment": o([
            { json: "_date", js: "_date", typ: u(undefined, r("PuneHedgehog")) },
            { json: "adjustment", js: "adjustment", typ: u(undefined, r("ValueMoney")) },
            { json: "adjustmentReason", js: "adjustmentReason", typ: u(undefined, r("ArakGroundhog")) },
            { json: "amount", js: "amount", typ: u(undefined, r("ValueMoney")) },
            { json: "date", js: "date", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
        ...
        "Procedure": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "procedureCodeableConcept", js: "procedureCodeableConcept", typ: u(undefined, r("ArakGroundhog")) },
            { json: "procedureReference", js: "procedureReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "type", js: "type", typ: u(undefined, a(r("ArakGroundhog"))) },
            { json: "udi", js: "udi", typ: u(undefined, a(r("HammerfestPonies"))) },
        ], false),
        "ProcessNote": o([
            { json: "_number", js: "_number", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_type", js: "_type", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "language", js: "language", typ: u(undefined, r("ArakGroundhog")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "number", js: "number", typ: u(undefined, 3.14) },
            { json: "text", js: "text", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("ProcessNoteType")) },
        ], false),
        "Related": o([
            { json: "claim", js: "claim", typ: u(undefined, r("HammerfestPonies")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reference", js: "reference", typ: u(undefined, r("Identifier")) },
            { json: "relationship", js: "relationship", typ: u(undefined, r("ArakGroundhog")) },
        ], false),
        "SupportingInfo": o([
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_timingDate", js: "_timingDate", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reason", js: "reason", typ: u(undefined, r("Coding")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "timingDate", js: "timingDate", typ: u(undefined, "") },
            { json: "timingPeriod", js: "timingPeriod", typ: u(undefined, r("Period")) },
            { json: "valueAttachment", js: "valueAttachment", typ: u(undefined, r("ValueAttachment")) },
            { json: "valueBoolean", js: "valueBoolean", typ: u(undefined, true) },
            { json: "valueQuantity", js: "valueQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "valueReference", js: "valueReference", typ: u(undefined, r("HammerfestPonies")) },
        ...
        "Total": o([
            { json: "amount", js: "amount", typ: r("ValueMoney") },
            { json: "category", js: "category", typ: r("ArakGroundhog") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
