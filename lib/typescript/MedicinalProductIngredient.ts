// To parse this data:
//
//   import { Convert, MedicinalProductIngredient } from "./file";
//
//   const medicinalProductIngredient = Convert.toMedicinalProductIngredient(json);
//
 ...
 * An ingredient of a manufactured item or pharmaceutical product.
 */
export interface SpecifiedSubstance {
    /**
     * The specified substance.
     */
    code: PurpleType;
...
export interface Strength {
     ...
     * Extensions for measurementPoint
     */
    _measurementPoint?: PuneHedgehog;
    /**
     * The strength per unitary volume (or mass).
     */
    concentration?: ValueRatio;
    /**
     * A lower limit for the strength per unitary volume (or mass), for when there is a range.
     * The concentration attribute then becomes the upper limit.
     */
    concentrationLowLimit?: ValueRatio;
    /**
     ...
     * single pharmaceutical product or manufactured item.
     */
    presentation: ValueRatio;
    /**
     * A lower limit for the quantity of substance in the unit of presentation. For use when
     * there is a range of strengths, this is the lower limit, with the presentation attribute
     * becoming the upper limit.
     */
    presentationLowLimit?: ValueRatio;
    /**
     * Strength expressed in terms of a reference substance.
     */
...
export namespace Convert {
    export function toMedicinalProductIngredient(json: string): MedicinalProductIngredient {
        return cast(JSON.parse(json), r("MedicinalProductIngredient"));
    }

    export function medicinalProductIngredientToJson(value: MedicinalProductIngredient): string {
        return JSON.stringify(uncast(value, r("MedicinalProductIngredient")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductIngredient": o([
            ...
            { json: "specifiedSubstance", js: "specifiedSubstance", typ: u(undefined, a(r("SpecifiedSubstance"))) },
            { json: "substance", js: "substance", typ: u(undefined, r("Substance")) },
        ...
        "SpecifiedSubstance": o([
            { json: "code", js: "code", typ: r("PurpleType") },
            { json: "confidentiality", js: "confidentiality", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "group", js: "group", typ: r("PurpleType") },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "strength", js: "strength", typ: u(undefined, a(r("Strength"))) },
        ], false),
        "Strength": o([
            { json: "_measurementPoint", js: "_measurementPoint", typ: u(undefined, r("PuneHedgehog")) },
            { json: "concentration", js: "concentration", typ: u(undefined, r("ValueRatio")) },
            { json: "concentrationLowLimit", js: "concentrationLowLimit", typ: u(undefined, r("ValueRatio")) },
            { json: "country", js: "country", typ: u(undefined, a(r("PurpleType"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "measurementPoint", js: "measurementPoint", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "presentation", js: "presentation", typ: r("ValueRatio") },
            { json: "presentationLowLimit", js: "presentationLowLimit", typ: u(undefined, r("ValueRatio")) },
            { json: "referenceStrength", js: "referenceStrength", typ: u(undefined, a(r("ReferenceStrength"))) },
        ], false),
        "ReferenceStrength": o([
            { json: "_measurementPoint", js: "_measurementPoint", typ: u(undefined, r("PuneHedgehog")) },
            { json: "country", js: "country", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "measurementPoint", js: "measurementPoint", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "strength", js: "strength", typ: r("ValueRatio") },
            { json: "strengthLowLimit", js: "strengthLowLimit", typ: u(undefined, r("ValueRatio")) },
