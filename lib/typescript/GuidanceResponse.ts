// To parse this data:
//
//   import { Convert, GuidanceResponse } from "./file";
//
//   const guidanceResponse = Convert.toGuidanceResponse(json);
//
...
export interface GuidanceResponse {
     ...
     */
    _moduleCanonical?: PuneHedgehog;
    /**
     * Extensions for moduleUri
     */
    _moduleUri?: PuneHedgehog;
    /**
     ...
     */
    evaluationMessage?: AuthorReference[];
    /**
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested.
     */
    moduleCodeableConcept?: PurpleType;
    /**
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested.
     */
    moduleUri?: string;
     ...
     */
    outputParameters?: AuthorReference;
    /**
 ...
 * The purpose of this identifier.
 */
export enum RequestIdentifierUse {
    Official = "official",
    Old = "old",
    Secondary = "secondary",
    Temp = "temp",
...
export namespace Convert {
    export function toGuidanceResponse(json: string): GuidanceResponse {
        return cast(JSON.parse(json), r("GuidanceResponse"));
    }

    export function guidanceResponseToJson(value: GuidanceResponse): string {
        return JSON.stringify(uncast(value, r("GuidanceResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "GuidanceResponse": o([
            ...
            { json: "_moduleCanonical", js: "_moduleCanonical", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_moduleUri", js: "_moduleUri", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "dataRequirement", js: "dataRequirement", typ: u(undefined, a(r("ValueDataRequirement"))) },
            { json: "encounter", js: "encounter", typ: u(undefined, r("AuthorReference")) },
            { json: "evaluationMessage", js: "evaluationMessage", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "moduleCanonical", js: "moduleCanonical", typ: u(undefined, "") },
            { json: "moduleCodeableConcept", js: "moduleCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "moduleUri", js: "moduleUri", typ: u(undefined, "") },
            { json: "note", js: "note", typ: u(undefined, a(r("ValueAnnotation"))) },
            { json: "occurrenceDateTime", js: "occurrenceDateTime", typ: u(undefined, "") },
            { json: "outputParameters", js: "outputParameters", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "requestIdentifier", js: "requestIdentifier", typ: u(undefined, r("Identifier")) },
            { json: "result", js: "result", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("GuidanceResponseStatus")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
            { json: "use", js: "use", typ: u(undefined, r("RequestIdentifierUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
