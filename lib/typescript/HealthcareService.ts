// To parse this data:
//
//   import { Convert, HealthcareService } from "./file";
//
//   const healthcareService = Convert.toHealthcareService(json);
//
...
export interface HealthcareService {
     ...
     */
    _appointmentRequired?: PuneHedgehog;
    /**
     ...
     */
    communication?: PurpleType[];
    /**
     * The location(s) that this service is available to (not where the service is provided).
     */
    coverageArea?: AuthorReference[];
    /**
...
export interface AvailableTime {
     ...
     * Extensions for availableEndTime
     */
    _availableEndTime?: PuneHedgehog;
    /**
     * Extensions for availableStartTime
     */
    _availableStartTime?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toHealthcareService(json: string): HealthcareService {
        return cast(JSON.parse(json), r("HealthcareService"));
    }

    export function healthcareServiceToJson(value: HealthcareService): string {
        return JSON.stringify(uncast(value, r("HealthcareService")), null, 2);
    }
    ...
    const typeMap: any = {
        "HealthcareService": o([
            ...
            { json: "_appointmentRequired", js: "_appointmentRequired", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_extraDetails", js: "_extraDetails", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "appointmentRequired", js: "appointmentRequired", typ: u(undefined, true) },
            { json: "availabilityExceptions", js: "availabilityExceptions", typ: u(undefined, "") },
            { json: "availableTime", js: "availableTime", typ: u(undefined, a(r("AvailableTime"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "characteristic", js: "characteristic", typ: u(undefined, a(r("PurpleType"))) },
            { json: "comment", js: "comment", typ: u(undefined, "") },
            { json: "communication", js: "communication", typ: u(undefined, a(r("PurpleType"))) },
            { json: "coverageArea", js: "coverageArea", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "eligibility", js: "eligibility", typ: u(undefined, a(r("Eligibility"))) },
            { json: "endpoint", js: "endpoint", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "extraDetails", js: "extraDetails", typ: u(undefined, "") },
            ...
            { json: "location", js: "location", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "notAvailable", js: "notAvailable", typ: u(undefined, a(r("NotAvailable"))) },
            { json: "photo", js: "photo", typ: u(undefined, r("ValueAttachment")) },
            { json: "program", js: "program", typ: u(undefined, a(r("PurpleType"))) },
            { json: "providedBy", js: "providedBy", typ: u(undefined, r("AuthorReference")) },
            { json: "referralMethod", js: "referralMethod", typ: u(undefined, a(r("PurpleType"))) },
            { json: "serviceProvisionCode", js: "serviceProvisionCode", typ: u(undefined, a(r("PurpleType"))) },
            { json: "specialty", js: "specialty", typ: u(undefined, a(r("PurpleType"))) },
        ...
        "AvailableTime": o([
            ...
            { json: "_availableEndTime", js: "_availableEndTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_availableStartTime", js: "_availableStartTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_daysOfWeek", js: "_daysOfWeek", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "allDay", js: "allDay", typ: u(undefined, true) },
            { json: "availableEndTime", js: "availableEndTime", typ: u(undefined, "") },
            { json: "availableStartTime", js: "availableStartTime", typ: u(undefined, "") },
            { json: "daysOfWeek", js: "daysOfWeek", typ: u(undefined, a(r("DaysOfWeek"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        ...
        "NotAvailable": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "during", js: "during", typ: u(undefined, r("Period")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
