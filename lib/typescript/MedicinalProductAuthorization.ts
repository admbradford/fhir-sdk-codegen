// To parse this data:
//
//   import { Convert, MedicinalProductAuthorization } from "./file";
//
//   const medicinalProductAuthorization = Convert.toMedicinalProductAuthorization(json);
//
...
export interface MedicinalProductAuthorization {
     ...
     */
    _dateOfFirstAuthorization?: PuneHedgehog;
    /**
     ...
     */
    _internationalBirthDate?: PuneHedgehog;
    /**
 ...
 * The regulatory authorization of a medicinal product.
 */
export interface JurisdictionalAuthorization {
    /**
     * Country of authorization.
     */
    country?: PurpleType;
...
export namespace Convert {
    export function toMedicinalProductAuthorization(json: string): MedicinalProductAuthorization {
        return cast(JSON.parse(json), r("MedicinalProductAuthorization"));
    }

    export function medicinalProductAuthorizationToJson(value: MedicinalProductAuthorization): string {
        return JSON.stringify(uncast(value, r("MedicinalProductAuthorization")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductAuthorization": o([
            { json: "_dateOfFirstAuthorization", js: "_dateOfFirstAuthorization", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_implicitRules", js: "_implicitRules", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_internationalBirthDate", js: "_internationalBirthDate", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "country", js: "country", typ: u(undefined, a(r("PurpleType"))) },
            { json: "dataExclusivityPeriod", js: "dataExclusivityPeriod", typ: u(undefined, r("Period")) },
            { json: "dateOfFirstAuthorization", js: "dateOfFirstAuthorization", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "holder", js: "holder", typ: u(undefined, r("AuthorReference")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "internationalBirthDate", js: "internationalBirthDate", typ: u(undefined, "") },
            { json: "jurisdiction", js: "jurisdiction", typ: u(undefined, a(r("PurpleType"))) },
            { json: "jurisdictionalAuthorization", js: "jurisdictionalAuthorization", typ: u(undefined, a(r("JurisdictionalAuthorization"))) },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "legalBasis", js: "legalBasis", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("PurpleType")) },
        ...
        "JurisdictionalAuthorization": o([
            { json: "country", js: "country", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "jurisdiction", js: "jurisdiction", typ: u(undefined, a(r("PurpleType"))) },
        ...
        "Procedure": o([
            { json: "_dateDateTime", js: "_dateDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "application", js: "application", typ: u(undefined, a(r("Procedure"))) },
            { json: "dateDateTime", js: "dateDateTime", typ: u(undefined, "") },
            { json: "datePeriod", js: "datePeriod", typ: u(undefined, r("Period")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
