// To parse this data:
//
//   import { Convert, BodyStructure } from "./file";
//
//   const bodyStructure = Convert.toBodyStructure(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * Record details about an anatomical structure.  This resource may be used when a coded
...
export namespace Convert {
    export function toBodyStructure(json: string): BodyStructure {
        return cast(JSON.parse(json), r("BodyStructure"));
    }

    export function bodyStructureToJson(value: BodyStructure): string {
        return JSON.stringify(uncast(value, r("BodyStructure")), null, 2);
    }
    ...
    const typeMap: any = {
        "BodyStructure": o([
            ...
            { json: "location", js: "location", typ: u(undefined, r("PurpleType")) },
            { json: "locationQualifier", js: "locationQualifier", typ: u(undefined, a(r("PurpleType"))) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "morphology", js: "morphology", typ: u(undefined, r("PurpleType")) },
