// To parse this data:
//
//   import { Convert, MedicinalProductPackaged } from "./file";
//
//   const medicinalProductPackaged = Convert.toMedicinalProductPackaged(json);
//
...
export interface MedicinalProductPackaged {
     ...
     */
    legalStatusOfSupply?: PurpleType;
    /**
     ...
     * Manufacturer of this Package Item.
     */
    marketingAuthorization?: AuthorReference;
    /**
...
export interface PackageItem {
     ...
     */
    manufacturedItem?: AuthorReference[];
    /**
     * Manufacturer of this Package Item.
     */
    manufacturer?: AuthorReference[];
     ...
     */
    otherCharacteristics?: PurpleType[];
    /**
...
export namespace Convert {
    export function toMedicinalProductPackaged(json: string): MedicinalProductPackaged {
        return cast(JSON.parse(json), r("MedicinalProductPackaged"));
    }

    export function medicinalProductPackagedToJson(value: MedicinalProductPackaged): string {
        return JSON.stringify(uncast(value, r("MedicinalProductPackaged")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductPackaged": o([
            ...
            { json: "batchIdentifier", js: "batchIdentifier", typ: u(undefined, a(r("BatchIdentifier"))) },
            ...
            { json: "legalStatusOfSupply", js: "legalStatusOfSupply", typ: u(undefined, r("PurpleType")) },
            { json: "manufacturer", js: "manufacturer", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "marketingAuthorization", js: "marketingAuthorization", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "packageItem", js: "packageItem", typ: u(undefined, a(r("PackageItem"))) },
            { json: "subject", js: "subject", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "BatchIdentifier": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "immediatePackaging", js: "immediatePackaging", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "outerPackaging", js: "outerPackaging", typ: r("Identifier") },
        ], false),
        "MarketingStatus": o([
            { json: "_restoreDate", js: "_restoreDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "country", js: "country", typ: r("PurpleType") },
            { json: "dateRange", js: "dateRange", typ: r("Period") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "jurisdiction", js: "jurisdiction", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "restoreDate", js: "restoreDate", typ: u(undefined, "") },
            { json: "status", js: "status", typ: r("PurpleType") },
        ], false),
        "Meta": o([
        ...
        "PackageItem": o([
            { json: "alternateMaterial", js: "alternateMaterial", typ: u(undefined, a(r("PurpleType"))) },
            { json: "device", js: "device", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "manufacturedItem", js: "manufacturedItem", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "manufacturer", js: "manufacturer", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "material", js: "material", typ: u(undefined, a(r("PurpleType"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "otherCharacteristics", js: "otherCharacteristics", typ: u(undefined, a(r("PurpleType"))) },
            { json: "packageItem", js: "packageItem", typ: u(undefined, a(r("PackageItem"))) },
