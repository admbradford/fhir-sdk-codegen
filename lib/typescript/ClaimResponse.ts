// To parse this data:
//
//   import { Convert, ClaimResponse } from "./file";
//
//   const claimResponse = Convert.toClaimResponse(json);
//
...
export interface ClaimResponse {
     ...
     */
    communicationRequest?: AuthorReference[];
    /**
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: HammerfestPonies;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: HammerfestPonies[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: HammerfestPonies;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: HammerfestPonies;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
...
export interface AddItem {
     ...
     * Where the product or service was provided.
     */
    locationCodeableConcept?: HammerfestPonies;
    /**
     * Where the product or service was provided.
     */
    locationReference?: AuthorReference;
    /**
     * Item typification or modifiers codes to convey additional context for the product or
     * service.
     */
    modifier?: HammerfestPonies[];
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
     ...
     * otherwise this contains the product, service, drug or other billing code for the item.
     */
    productOrService: HammerfestPonies;
    /**
     * Identifies the program under which this may be recovered.
     */
    programCode?: HammerfestPonies[];
    /**
     * The providers who are authorized for the services rendered to the patient.
     */
    provider?: AuthorReference[];
    /**
     * The number of repetitions of a service or product.
     */
...
export interface Insurance {
     ...
     * Extensions for businessArrangement
     */
    _businessArrangement?: PuneHedgehog;
    /**
     * Extensions for focal
     */
    _focal?: PuneHedgehog;
     ...
     * insurance.
     */
    claimResponse?: AuthorReference;
    /**
     * Reference to the insurance card level information contained in the Coverage resource. The
     * coverage issuing insurer will use these details to locate the patient's actual coverage
     * within the insurer's information system.
     */
    coverage: AuthorReference;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export interface Payment {
     ...
     * Reason for the payment adjustment.
     */
    adjustmentReason?: HammerfestPonies;
    /**
     * Benefits payable less any payment adjustment.
     */
    amount: ValueMoney;
...
export namespace Convert {
    export function toClaimResponse(json: string): ClaimResponse {
        return cast(JSON.parse(json), r("ClaimResponse"));
    }

    export function claimResponseToJson(value: ClaimResponse): string {
        return JSON.stringify(uncast(value, r("ClaimResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "ClaimResponse": o([
            ...
            { json: "_preAuthRef", js: "_preAuthRef", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "communicationRequest", js: "communicationRequest", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "created", js: "created", typ: u(undefined, "") },
            { json: "disposition", js: "disposition", typ: u(undefined, "") },
            { json: "error", js: "error", typ: u(undefined, a(r("Error"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "form", js: "form", typ: u(undefined, r("ValueAttachment")) },
            { json: "formCode", js: "formCode", typ: u(undefined, r("HammerfestPonies")) },
            { json: "fundsReserve", js: "fundsReserve", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "insurer", js: "insurer", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "payeeType", js: "payeeType", typ: u(undefined, r("HammerfestPonies")) },
            { json: "payment", js: "payment", typ: u(undefined, r("Payment")) },
            { json: "preAuthPeriod", js: "preAuthPeriod", typ: u(undefined, r("Period")) },
            { json: "preAuthRef", js: "preAuthRef", typ: u(undefined, "") },
            { json: "processNote", js: "processNote", typ: u(undefined, a(r("ProcessNote"))) },
            { json: "request", js: "request", typ: u(undefined, r("AuthorReference")) },
            { json: "requestor", js: "requestor", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "subType", js: "subType", typ: u(undefined, r("HammerfestPonies")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "total", js: "total", typ: u(undefined, a(r("Total"))) },
            { json: "type", js: "type", typ: u(undefined, r("HammerfestPonies")) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("HammerfestPonies")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("HammerfestPonies")) },
        ...
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("HammerfestPonies")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("HammerfestPonies")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("HammerfestPonies")) },
        ...
        "AddItem": o([
            ...
            { json: "adjudication", js: "adjudication", typ: a(r("Adjudication")) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "locationCodeableConcept", js: "locationCodeableConcept", typ: u(undefined, r("HammerfestPonies")) },
            { json: "locationReference", js: "locationReference", typ: u(undefined, r("AuthorReference")) },
            { json: "modifier", js: "modifier", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "net", js: "net", typ: u(undefined, r("ValueMoney")) },
            { json: "noteNumber", js: "noteNumber", typ: u(undefined, a(3.14)) },
            { json: "productOrService", js: "productOrService", typ: r("HammerfestPonies") },
            { json: "programCode", js: "programCode", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "provider", js: "provider", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "subSite", js: "subSite", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "Adjudication": o([
            { json: "_value", js: "_value", typ: u(undefined, r("PuneHedgehog")) },
            { json: "amount", js: "amount", typ: u(undefined, r("ValueMoney")) },
            { json: "category", js: "category", typ: r("HammerfestPonies") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reason", js: "reason", typ: u(undefined, r("HammerfestPonies")) },
            { json: "value", js: "value", typ: u(undefined, 3.14) },
        ], false),
        "AddItemDetail": o([
            { json: "_factor", js: "_factor", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Error": o([
            { json: "_detailSequence", js: "_detailSequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_itemSequence", js: "_itemSequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_subDetailSequence", js: "_subDetailSequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "code", js: "code", typ: r("HammerfestPonies") },
            { json: "detailSequence", js: "detailSequence", typ: u(undefined, 3.14) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "itemSequence", js: "itemSequence", typ: u(undefined, 3.14) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "subDetailSequence", js: "subDetailSequence", typ: u(undefined, 3.14) },
        ], false),
        "Insurance": o([
            { json: "_businessArrangement", js: "_businessArrangement", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_focal", js: "_focal", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "businessArrangement", js: "businessArrangement", typ: u(undefined, "") },
            { json: "claimResponse", js: "claimResponse", typ: u(undefined, r("AuthorReference")) },
            { json: "coverage", js: "coverage", typ: r("AuthorReference") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Payment": o([
            ...
            { json: "adjustmentReason", js: "adjustmentReason", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "identifier", js: "identifier", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: r("HammerfestPonies") },
        ], false),
        "ProcessNote": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "language", js: "language", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
