// To parse this data:
//
//   import { Convert, OperationOutcome } from "./file";
//
//   const operationOutcome = Convert.toOperationOutcome(json);
//
...
export interface Issue {
     ...
     * system code that identifies the error.
     */
    details?: ValueCodeableConceptElement;
    /**
...
export namespace Convert {
    export function toOperationOutcome(json: string): OperationOutcome {
        return cast(JSON.parse(json), r("OperationOutcome"));
    }

    export function operationOutcomeToJson(value: OperationOutcome): string {
        return JSON.stringify(uncast(value, r("OperationOutcome")), null, 2);
    }
    ...
    const typeMap: any = {
        "OperationOutcome": o([
            ...
            { json: "issue", js: "issue", typ: u(undefined, a(r("Issue"))) },
        ...
        "Issue": o([
            { json: "_code", js: "_code", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_diagnostics", js: "_diagnostics", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_expression", js: "_expression", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_location", js: "_location", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_severity", js: "_severity", typ: u(undefined, r("PuneHedgehog")) },
            { json: "code", js: "code", typ: u(undefined, r("Code")) },
            { json: "details", js: "details", typ: u(undefined, r("ValueCodeableConceptElement")) },
            { json: "diagnostics", js: "diagnostics", typ: u(undefined, "") },
            { json: "expression", js: "expression", typ: u(undefined, a("")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
