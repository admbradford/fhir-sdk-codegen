// To parse this data:
//
//   import { Convert, EnrollmentResponse } from "./file";
//
//   const enrollmentResponse = Convert.toEnrollmentResponse(json);
//
...
export interface EnrollmentResponse {
     ...
     */
    requestProvider?: AuthorReference;
    /**
...
export namespace Convert {
    export function toEnrollmentResponse(json: string): EnrollmentResponse {
        return cast(JSON.parse(json), r("EnrollmentResponse"));
    }

    export function enrollmentResponseToJson(value: EnrollmentResponse): string {
        return JSON.stringify(uncast(value, r("EnrollmentResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "EnrollmentResponse": o([
            ...
            { json: "requestProvider", js: "requestProvider", typ: u(undefined, r("AuthorReference")) },
