// To parse this data:
//
//   import { Convert, MedicinalProductContraindication } from "./file";
//
//   const medicinalProductContraindication = Convert.toMedicinalProductContraindication(json);
//
...
export interface MedicinalProductContraindication {
     ...
     * of the indication.
     */
    therapeuticIndication?: AuthorReference[];
}
...
export namespace Convert {
    export function toMedicinalProductContraindication(json: string): MedicinalProductContraindication {
        return cast(JSON.parse(json), r("MedicinalProductContraindication"));
    }

    export function medicinalProductContraindicationToJson(value: MedicinalProductContraindication): string {
        return JSON.stringify(uncast(value, r("MedicinalProductContraindication")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductContraindication": o([
            ...
            { json: "disease", js: "disease", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "therapeuticIndication", js: "therapeuticIndication", typ: u(undefined, a(r("AuthorReference"))) },
        ], false),
        "ValueUsageContext": o([
