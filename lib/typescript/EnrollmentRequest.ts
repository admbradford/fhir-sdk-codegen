// To parse this data:
//
//   import { Convert, EnrollmentRequest } from "./file";
//
//   const enrollmentRequest = Convert.toEnrollmentRequest(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * This resource provides the insurance enrollment details to the insurer regarding a
 * specified coverage.
 */
...
export namespace Convert {
    export function toEnrollmentRequest(json: string): EnrollmentRequest {
        return cast(JSON.parse(json), r("EnrollmentRequest"));
    }

    export function enrollmentRequestToJson(value: EnrollmentRequest): string {
        return JSON.stringify(uncast(value, r("EnrollmentRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "EnrollmentRequest": o([
            ...
            { json: "candidate", js: "candidate", typ: u(undefined, r("AuthorReference")) },
            { json: "coverage", js: "coverage", typ: u(undefined, r("AuthorReference")) },
