// To parse this data:
//
//   import { Convert, MedicinalProductInteraction } from "./file";
//
//   const medicinalProductInteraction = Convert.toMedicinalProductInteraction(json);
//
...
export namespace Convert {
    export function toMedicinalProductInteraction(json: string): MedicinalProductInteraction {
        return cast(JSON.parse(json), r("MedicinalProductInteraction"));
    }

    export function medicinalProductInteractionToJson(value: MedicinalProductInteraction): string {
        return JSON.stringify(uncast(value, r("MedicinalProductInteraction")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductInteraction": o([
            ...
            { json: "effect", js: "effect", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "incidence", js: "incidence", typ: u(undefined, r("PurpleType")) },
            { json: "interactant", js: "interactant", typ: u(undefined, a(r("Interactant"))) },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "management", js: "management", typ: u(undefined, r("PurpleType")) },
