// To parse this data:
//
//   import { Convert, Specimen } from "./file";
//
//   const specimen = Convert.toSpecimen(json);
//
 ...
 * The purpose of this identifier.
 */
export enum AccessionIdentifierUse {
    Official = "official",
    Old = "old",
    Secondary = "secondary",
    Temp = "temp",
...
export interface Collection {
     ...
     * Extensions for collectedDateTime
     */
    _collectedDateTime?: PuneHedgehog;
    /**
     * Anatomical location from which the specimen was collected (if subject is a patient). This
     * is the target site.  This element is not used for environmental specimens.
     */
     ...
     * to sample collection.
     */
    fastingStatusCodeableConcept?: PurpleType;
    /**
     * Abstinence or reduction from some or all food, drink, or both, for a period of time prior
     * to sample collection.
     */
    fastingStatusDuration?: ValueDuration;
    /**
     * Unique id for the element within a resource (for internal references). This may be any
     * string value that does not contain spaces.
     */
...
export interface Container {
     ...
     * appropriate measurements, depending on the specimen type.
     */
    specimenQuantity?: ValueQuantity;
    /**
     * The type of container associated with the specimen (e.g. slide, aliquot, etc.).
     */
    type?: PurpleType;
...
export interface Processing {
     ...
     * Extensions for timeDateTime
     */
    _timeDateTime?: PuneHedgehog;
    /**
     * Material used in the processing step.
     */
    additive?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toSpecimen(json: string): Specimen {
        return cast(JSON.parse(json), r("Specimen"));
    }

    export function specimenToJson(value: Specimen): string {
        return JSON.stringify(uncast(value, r("Specimen")), null, 2);
    }
    ...
    const typeMap: any = {
        "Specimen": o([
            ...
            { json: "_receivedTime", js: "_receivedTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "accessionIdentifier", js: "accessionIdentifier", typ: u(undefined, r("Identifier")) },
            { json: "collection", js: "collection", typ: u(undefined, r("Collection")) },
            { json: "condition", js: "condition", typ: u(undefined, a(r("PurpleType"))) },
            { json: "container", js: "container", typ: u(undefined, a(r("Container"))) },
            ...
            { json: "parent", js: "parent", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "processing", js: "processing", typ: u(undefined, a(r("Processing"))) },
            { json: "receivedTime", js: "receivedTime", typ: u(undefined, "") },
            { json: "request", js: "request", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, r("SpecimenStatus")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
            { json: "use", js: "use", typ: u(undefined, r("AccessionIdentifierUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Collection": o([
            { json: "_collectedDateTime", js: "_collectedDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, r("PurpleType")) },
            { json: "collectedDateTime", js: "collectedDateTime", typ: u(undefined, "") },
            { json: "collectedPeriod", js: "collectedPeriod", typ: u(undefined, r("Period")) },
            { json: "collector", js: "collector", typ: u(undefined, r("AuthorReference")) },
            { json: "duration", js: "duration", typ: u(undefined, r("ValueDuration")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "fastingStatusCodeableConcept", js: "fastingStatusCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "fastingStatusDuration", js: "fastingStatusDuration", typ: u(undefined, r("ValueDuration")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "method", js: "method", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Container": o([
            ...
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "specimenQuantity", js: "specimenQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Meta": o([
        ...
        "Processing": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_timeDateTime", js: "_timeDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additive", js: "additive", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "procedure", js: "procedure", typ: u(undefined, r("PurpleType")) },
            { json: "timeDateTime", js: "timeDateTime", typ: u(undefined, "") },
            { json: "timePeriod", js: "timePeriod", typ: u(undefined, r("Period")) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
