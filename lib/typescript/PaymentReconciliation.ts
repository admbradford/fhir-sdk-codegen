// To parse this data:
//
//   import { Convert, PaymentReconciliation } from "./file";
//
//   const paymentReconciliation = Convert.toPaymentReconciliation(json);
//
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: FormCodeElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: FormCodeElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: FormCodeElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: FormCodeElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
 ...
 * A code for the form to be used for printing the content.
 */
export interface FormCodeElement {
    /**
     * Extensions for text
     */
    _text?: PuneHedgehog;
 ...
 * The purpose of this identifier.
 */
export enum PaymentIdentifierUse {
    Official = "official",
    Old = "old",
    Secondary = "secondary",
    Temp = "temp",
...
export interface Detail {
     ...
     * A resource, such as a ClaimResponse, which contains a commitment to payment.
     */
    response?: AuthorReference;
    /**
     * A reference to the individual who is responsible for inquiries regarding the response and
     * its payment.
     */
    responsible?: AuthorReference;
    /**
     * The party which submitted the claim or financial transaction.
     */
    submitter?: AuthorReference;
    /**
     * Code to indicate the nature of the payment.
     */
    type: FormCodeElement;
...
export namespace Convert {
    export function toPaymentReconciliation(json: string): PaymentReconciliation {
        return cast(JSON.parse(json), r("PaymentReconciliation"));
    }

    export function paymentReconciliationToJson(value: PaymentReconciliation): string {
        return JSON.stringify(uncast(value, r("PaymentReconciliation")), null, 2);
    }
    ...
    const typeMap: any = {
        "PaymentReconciliation": o([
            ...
            { json: "formCode", js: "formCode", typ: u(undefined, r("FormCodeElement")) },
            ...
            { json: "paymentAmount", js: "paymentAmount", typ: u(undefined, r("ValueMoney")) },
            { json: "paymentDate", js: "paymentDate", typ: u(undefined, "") },
            { json: "paymentIdentifier", js: "paymentIdentifier", typ: u(undefined, r("Identifier")) },
            { json: "paymentIssuer", js: "paymentIssuer", typ: u(undefined, r("AuthorReference")) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("FormCodeElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("FormCodeElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("FormCodeElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("FormCodeElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("FormCodeElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("FormCodeElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("FormCodeElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("FormCodeElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("FormCodeElement")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("FormCodeElement")) },
            { json: "use", js: "use", typ: u(undefined, r("PaymentIdentifierUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Detail": o([
            ...
            { json: "identifier", js: "identifier", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "payee", js: "payee", typ: u(undefined, r("AuthorReference")) },
            { json: "predecessor", js: "predecessor", typ: u(undefined, r("Identifier")) },
            { json: "request", js: "request", typ: u(undefined, r("AuthorReference")) },
            { json: "response", js: "response", typ: u(undefined, r("AuthorReference")) },
            { json: "responsible", js: "responsible", typ: u(undefined, r("AuthorReference")) },
            { json: "submitter", js: "submitter", typ: u(undefined, r("AuthorReference")) },
            { json: "type", js: "type", typ: r("FormCodeElement") },
        ], false),
        "Meta": o([
