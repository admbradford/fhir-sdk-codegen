// To parse this data:
//
//   import { Convert, DocumentReference } from "./file";
//
//   const documentReference = Convert.toDocumentReference(json);
//
 ...
 * The purpose of this identifier.
 */
export enum MasterIdentifierUse {
    Official = "official",
    Old = "old",
    Secondary = "secondary",
    Temp = "temp",
...
export interface Context {
     ...
     * created, often reflecting the clinical specialty.
     */
    practiceSetting?: PurpleType;
    /**
     * Related identifiers or resources associated with the DocumentReference.
     */
    related?: AuthorReference[];
    /**
     * The Patient Information as known when the document was published. May be a reference to a
     * version specific, or contained.
     */
    sourcePatientInfo?: AuthorReference;
}
...
export namespace Convert {
    export function toDocumentReference(json: string): DocumentReference {
        return cast(JSON.parse(json), r("DocumentReference"));
    }

    export function documentReferenceToJson(value: DocumentReference): string {
        return JSON.stringify(uncast(value, r("DocumentReference")), null, 2);
    }
    ...
    const typeMap: any = {
        "DocumentReference": o([
            ...
            { json: "_docStatus", js: "_docStatus", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "authenticator", js: "authenticator", typ: u(undefined, r("AuthorReference")) },
            { json: "author", js: "author", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "content", js: "content", typ: u(undefined, a(r("Content"))) },
            ...
            { json: "docStatus", js: "docStatus", typ: u(undefined, "") },
            ...
            { json: "masterIdentifier", js: "masterIdentifier", typ: u(undefined, r("Identifier")) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "relatesTo", js: "relatesTo", typ: u(undefined, a(r("RelatesTo"))) },
            { json: "securityLabel", js: "securityLabel", typ: u(undefined, a(r("PurpleType"))) },
            { json: "status", js: "status", typ: u(undefined, r("DocumentReferenceStatus")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
            { json: "use", js: "use", typ: u(undefined, r("MasterIdentifierUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Content": o([
            { json: "attachment", js: "attachment", typ: r("ValueAttachment") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "format", js: "format", typ: u(undefined, r("Coding")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Context": o([
            { json: "encounter", js: "encounter", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "event", js: "event", typ: u(undefined, a(r("PurpleType"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "facilityType", js: "facilityType", typ: u(undefined, r("PurpleType")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "practiceSetting", js: "practiceSetting", typ: u(undefined, r("PurpleType")) },
            { json: "related", js: "related", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "sourcePatientInfo", js: "sourcePatientInfo", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Meta": o([
