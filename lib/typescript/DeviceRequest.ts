// To parse this data:
//
//   import { Convert, DeviceRequest } from "./file";
//
//   const deviceRequest = Convert.toDeviceRequest(json);
//
...
export interface DeviceRequest {
     ...
     */
    codeCodeableConcept?: PurpleType;
    /**
     * The details of the device to be used.
     */
    codeReference?: AuthorReference;
    /**
...
export namespace Convert {
    export function toDeviceRequest(json: string): DeviceRequest {
        return cast(JSON.parse(json), r("DeviceRequest"));
    }

    export function deviceRequestToJson(value: DeviceRequest): string {
        return JSON.stringify(uncast(value, r("DeviceRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "DeviceRequest": o([
            ...
            { json: "codeCodeableConcept", js: "codeCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "codeReference", js: "codeReference", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "priorRequest", js: "priorRequest", typ: u(undefined, a(r("AuthorReference"))) },
