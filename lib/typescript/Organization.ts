// To parse this data:
//
//   import { Convert, Organization } from "./file";
//
...
export namespace Convert {
    export function toOrganization(json: string): Organization {
        return cast(JSON.parse(json), r("Organization"));
    }

    export function organizationToJson(value: Organization): string {
    ...
    const typeMap: any = {
        ...
        "Contact": o([
            ...
            { json: "purpose", js: "purpose", typ: u(undefined, r("TypeElement")) },
            { json: "telecom", js: "telecom", typ: u(undefined, a(r("ValueContactPoint"))) },
        ], false),
        "Meta": o([
