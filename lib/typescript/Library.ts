// To parse this data:
//
//   import { Convert, Library } from "./file";
//
//   const library = Convert.toLibrary(json);
//
...
export interface Library {
     ...
     */
    parameter?: ValueParameterDefinition[];
    /**
...
export namespace Convert {
    export function toLibrary(json: string): Library {
        return cast(JSON.parse(json), r("Library"));
    }

    export function libraryToJson(value: Library): string {
        return JSON.stringify(uncast(value, r("Library")), null, 2);
    }
    ...
    const typeMap: any = {
        "Library": o([
            ...
            { json: "content", js: "content", typ: u(undefined, a(r("ValueAttachment"))) },
            ...
            { json: "parameter", js: "parameter", typ: u(undefined, a(r("ValueParameterDefinition"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("LibraryStatus")) },
