// To parse this data:
//
//   import { Convert, Consent } from "./file";
//
//   const consent = Convert.toConsent(json);
//
...
export interface Consent {
     ...
     */
    sourceAttachment?: ValueAttachment;
    /**
     * The source on which this consent statement is based. The source might be a scanned
     * original paper form, or a reference to a consent that links back to such a source, a
     * reference to a document repository (e.g. XDS) that stores the original consent document.
     */
    sourceReference?: AuthorReference;
    /**
...
export interface Verification {
     ...
     * Extensions for verificationDate
     */
    _verificationDate?: PuneHedgehog;
    /**
     * Extensions for verified
     */
    _verified?: PuneHedgehog;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
     ...
     * Who verified the instruction (Patient, Relative or other Authorized Person).
     */
    verifiedWith?: AuthorReference;
}

// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export namespace Convert {
    export function toConsent(json: string): Consent {
        return cast(JSON.parse(json), r("Consent"));
    }

    export function consentToJson(value: Consent): string {
        return JSON.stringify(uncast(value, r("Consent")), null, 2);
    }
    ...
    const typeMap: any = {
        "Consent": o([
            ...
            { json: "organization", js: "organization", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "patient", js: "patient", typ: u(undefined, r("AuthorReference")) },
            { json: "performer", js: "performer", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "policy", js: "policy", typ: u(undefined, a(r("Policy"))) },
            { json: "policyRule", js: "policyRule", typ: u(undefined, r("PurpleType")) },
            { json: "provision", js: "provision", typ: u(undefined, r("Provision")) },
            { json: "scope", js: "scope", typ: u(undefined, r("PurpleType")) },
            { json: "sourceAttachment", js: "sourceAttachment", typ: u(undefined, r("ValueAttachment")) },
            { json: "sourceReference", js: "sourceReference", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("ConsentStatus")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "verification", js: "verification", typ: u(undefined, a(r("Verification"))) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Policy": o([
            { json: "_authority", js: "_authority", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Provision": o([
            { json: "_type", js: "_type", typ: u(undefined, r("PuneHedgehog")) },
            { json: "action", js: "action", typ: u(undefined, a(r("PurpleType"))) },
            { json: "actor", js: "actor", typ: u(undefined, a(r("Actor"))) },
            { json: "class", js: "class", typ: u(undefined, a(r("Coding"))) },
            { json: "code", js: "code", typ: u(undefined, a(r("PurpleType"))) },
            { json: "data", js: "data", typ: u(undefined, a(r("Data"))) },
            { json: "dataPeriod", js: "dataPeriod", typ: u(undefined, r("Period")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "provision", js: "provision", typ: u(undefined, a(r("Provision"))) },
            { json: "purpose", js: "purpose", typ: u(undefined, a(r("Coding"))) },
            { json: "securityLabel", js: "securityLabel", typ: u(undefined, a(r("Coding"))) },
            { json: "type", js: "type", typ: u(undefined, r("ProvisionType")) },
        ], false),
        "Actor": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            ...
            { json: "role", js: "role", typ: r("PurpleType") },
        ], false),
        "Data": o([
            { json: "_meaning", js: "_meaning", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "meaning", js: "meaning", typ: u(undefined, r("Meaning")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reference", js: "reference", typ: r("AuthorReference") },
        ], false),
        "Text": o([
        ...
        "Verification": o([
            { json: "_verificationDate", js: "_verificationDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_verified", js: "_verified", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "verificationDate", js: "verificationDate", typ: u(undefined, "") },
            { json: "verified", js: "verified", typ: u(undefined, true) },
            { json: "verifiedWith", js: "verifiedWith", typ: u(undefined, r("AuthorReference")) },
        ], false),
