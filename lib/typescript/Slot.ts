// To parse this data:
//
//   import { Convert, Slot } from "./file";
//
//   const slot = Convert.toSlot(json);
//
...
export namespace Convert {
    export function toSlot(json: string): Slot {
        return cast(JSON.parse(json), r("Slot"));
    }

    export function slotToJson(value: Slot): string {
        return JSON.stringify(uncast(value, r("Slot")), null, 2);
    }
    ...
    const typeMap: any = {
        "Slot": o([
            ...
            { json: "_overbooked", js: "_overbooked", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "overbooked", js: "overbooked", typ: u(undefined, true) },
            { json: "schedule", js: "schedule", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("SlotStatus")) },
