// To parse this data:
//
//   import { Convert, NutritionOrder } from "./file";
//
//   const nutritionOrder = Convert.toNutritionOrder(json);
//
...
export interface NutritionOrder {
     ...
     * nutrition order.
     */
    allergyIntolerance?: AuthorReference[];
    /**
     ...
     */
    excludeFoodModifier?: PurpleType[];
    /**
     ...
     */
    foodPreferenceModifier?: PurpleType[];
    /**
...
export interface EnteralFormula {
     ...
     * Extensions for additiveProductName
     */
    _additiveProductName?: PuneHedgehog;
    /**
     * Extensions for administrationInstruction
     */
    _administrationInstruction?: PuneHedgehog;
    /**
     * Extensions for baseFormulaProductName
     */
    _baseFormulaProductName?: PuneHedgehog;
    /**
     ...
     * period of time, e.g. 1440 mL over 24 hours.
     */
    maxVolumeToDeliver?: ValueQuantity;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
     ...
     * tract for purposes of providing the formula feeding, e.g. nasogastric tube.
     */
    routeofAdministration?: PurpleType;
}
 ...
 * patient/resident.
 */
export interface OralDiet {
    /**
     * Extensions for instruction
     */
    _instruction?: PuneHedgehog;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
     ...
     */
    fluidConsistencyType?: PurpleType[];
    /**
     * Unique id for the element within a resource (for internal references). This may be any
     * string value that does not contain spaces.
     */
...
export namespace Convert {
    export function toNutritionOrder(json: string): NutritionOrder {
        return cast(JSON.parse(json), r("NutritionOrder"));
    }

    export function nutritionOrderToJson(value: NutritionOrder): string {
        return JSON.stringify(uncast(value, r("NutritionOrder")), null, 2);
    }
    ...
    const typeMap: any = {
        "NutritionOrder": o([
            { json: "_dateTime", js: "_dateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_implicitRules", js: "_implicitRules", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_instantiates", js: "_instantiates", typ: u(undefined, a(r("PuneHedgehog"))) },
            ...
            { json: "allergyIntolerance", js: "allergyIntolerance", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "dateTime", js: "dateTime", typ: u(undefined, "") },
            { json: "encounter", js: "encounter", typ: u(undefined, r("AuthorReference")) },
            { json: "enteralFormula", js: "enteralFormula", typ: u(undefined, r("EnteralFormula")) },
            { json: "excludeFoodModifier", js: "excludeFoodModifier", typ: u(undefined, a(r("PurpleType"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "foodPreferenceModifier", js: "foodPreferenceModifier", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "oralDiet", js: "oralDiet", typ: u(undefined, r("OralDiet")) },
            { json: "orderer", js: "orderer", typ: u(undefined, r("AuthorReference")) },
            { json: "patient", js: "patient", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "supplement", js: "supplement", typ: u(undefined, a(r("Supplement"))) },
        ...
        "EnteralFormula": o([
            { json: "_additiveProductName", js: "_additiveProductName", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_administrationInstruction", js: "_administrationInstruction", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_baseFormulaProductName", js: "_baseFormulaProductName", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additiveProductName", js: "additiveProductName", typ: u(undefined, "") },
            { json: "additiveType", js: "additiveType", typ: u(undefined, r("PurpleType")) },
            { json: "administration", js: "administration", typ: u(undefined, a(r("Administration"))) },
            { json: "administrationInstruction", js: "administrationInstruction", typ: u(undefined, "") },
            { json: "baseFormulaProductName", js: "baseFormulaProductName", typ: u(undefined, "") },
            { json: "baseFormulaType", js: "baseFormulaType", typ: u(undefined, r("PurpleType")) },
            { json: "caloricDensity", js: "caloricDensity", typ: u(undefined, r("ValueQuantity")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "maxVolumeToDeliver", js: "maxVolumeToDeliver", typ: u(undefined, r("ValueQuantity")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "routeofAdministration", js: "routeofAdministration", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Administration": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            ...
            { json: "rateQuantity", js: "rateQuantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "rateRatio", js: "rateRatio", typ: u(undefined, r("ValueRatio")) },
            { json: "schedule", js: "schedule", typ: u(undefined, r("ValueTiming")) },
        ], false),
        "Meta": o([
        ...
        "OralDiet": o([
            { json: "_instruction", js: "_instruction", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "fluidConsistencyType", js: "fluidConsistencyType", typ: u(undefined, a(r("PurpleType"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "instruction", js: "instruction", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "nutrient", js: "nutrient", typ: u(undefined, a(r("Nutrient"))) },
            { json: "schedule", js: "schedule", typ: u(undefined, a(r("ValueTiming"))) },
            { json: "texture", js: "texture", typ: u(undefined, a(r("Texture"))) },
            { json: "type", js: "type", typ: u(undefined, a(r("PurpleType"))) },
        ], false),
        "Nutrient": o([
            { json: "amount", js: "amount", typ: u(undefined, r("ValueQuantity")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifier", js: "modifier", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Texture": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "foodType", js: "foodType", typ: u(undefined, r("PurpleType")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifier", js: "modifier", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
