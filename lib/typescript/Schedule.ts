// To parse this data:
//
//   import { Convert, Schedule } from "./file";
//
//   const schedule = Convert.toSchedule(json);
//
...
export namespace Convert {
    export function toSchedule(json: string): Schedule {
        return cast(JSON.parse(json), r("Schedule"));
    }

    export function scheduleToJson(value: Schedule): string {
        return JSON.stringify(uncast(value, r("Schedule")), null, 2);
    }
    ...
    const typeMap: any = {
        "Schedule": o([
            ...
            { json: "actor", js: "actor", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "planningHorizon", js: "planningHorizon", typ: u(undefined, r("Period")) },
