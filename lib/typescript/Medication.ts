// To parse this data:
//
//   import { Convert, Medication } from "./file";
//
//   const medication = Convert.toMedication(json);
//
...
export namespace Convert {
    export function toMedication(json: string): Medication {
        return cast(JSON.parse(json), r("Medication"));
    }

    export function medicationToJson(value: Medication): string {
        return JSON.stringify(uncast(value, r("Medication")), null, 2);
    }
    ...
    const typeMap: any = {
        "Medication": o([
            ...
            { json: "amount", js: "amount", typ: u(undefined, r("ValueRatio")) },
            { json: "batch", js: "batch", typ: u(undefined, r("Batch")) },
