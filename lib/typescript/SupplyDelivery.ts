// To parse this data:
//
//   import { Convert, SupplyDelivery } from "./file";
//
//   const supplyDelivery = Convert.toSupplyDelivery(json);
//
...
export interface SuppliedItem {
     ...
     * known list.
     */
    itemCodeableConcept?: TypeElement;
    /**
     * Identifies the medication, substance or device being dispensed. This is either a link to
     * a resource representing the details of the item or a code that identifies the item from a
     * known list.
...
export namespace Convert {
    export function toSupplyDelivery(json: string): SupplyDelivery {
        return cast(JSON.parse(json), r("SupplyDelivery"));
    }

    export function supplyDeliveryToJson(value: SupplyDelivery): string {
        return JSON.stringify(uncast(value, r("SupplyDelivery")), null, 2);
    }
    ...
    const typeMap: any = {
        "SupplyDelivery": o([
            ...
            { json: "destination", js: "destination", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "receiver", js: "receiver", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, r("SupplyDeliveryStatus")) },
            { json: "suppliedItem", js: "suppliedItem", typ: u(undefined, r("SuppliedItem")) },
            { json: "supplier", js: "supplier", typ: u(undefined, r("AuthorReference")) },
        ...
        "SuppliedItem": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "itemCodeableConcept", js: "itemCodeableConcept", typ: u(undefined, r("TypeElement")) },
