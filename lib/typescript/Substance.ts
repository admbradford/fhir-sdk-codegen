// To parse this data:
//
//   import { Convert, Substance } from "./file";
//
//   const substance = Convert.toSubstance(json);
//
...
export interface Ingredient {
     ...
     * Another substance that is a component of this substance.
     */
    substanceCodeableConcept?: PurpleType;
    /**
     * Another substance that is a component of this substance.
     */
...
export namespace Convert {
    export function toSubstance(json: string): Substance {
        return cast(JSON.parse(json), r("Substance"));
    }

    export function substanceToJson(value: Substance): string {
        return JSON.stringify(uncast(value, r("Substance")), null, 2);
    }
    ...
    const typeMap: any = {
        "Substance": o([
            ...
            { json: "status", js: "status", typ: u(undefined, r("SubstanceStatus")) },
        ...
        "Ingredient": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueRatio")) },
            { json: "substanceCodeableConcept", js: "substanceCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "substanceReference", js: "substanceReference", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Instance": o([
            { json: "_expiry", js: "_expiry", typ: u(undefined, r("PuneHedgehog")) },
