// To parse this data:
//
//   import { Convert, DeviceMetric } from "./file";
//
//   const deviceMetric = Convert.toDeviceMetric(json);
//
...
export interface DeviceMetric {
     ...
     */
    _operationalStatus?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toDeviceMetric(json: string): DeviceMetric {
        return cast(JSON.parse(json), r("DeviceMetric"));
    }

    export function deviceMetricToJson(value: DeviceMetric): string {
        return JSON.stringify(uncast(value, r("DeviceMetric")), null, 2);
    }
    ...
    const typeMap: any = {
        "DeviceMetric": o([
            ...
            { json: "_operationalStatus", js: "_operationalStatus", typ: u(undefined, r("PuneHedgehog")) },
            { json: "calibration", js: "calibration", typ: u(undefined, a(r("Calibration"))) },
            ...
            { json: "measurementPeriod", js: "measurementPeriod", typ: u(undefined, r("ValueTiming")) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "operationalStatus", js: "operationalStatus", typ: u(undefined, r("OperationalStatus")) },
            ...
            { json: "unit", js: "unit", typ: u(undefined, r("TypeElement")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Calibration": o([
            ...
            { json: "time", js: "time", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("CalibrationType")) },
        ], false),
        "Meta": o([
