// To parse this data:
//
//   import { Convert, ImmunizationRecommendation } from "./file";
//
//   const immunizationRecommendation = Convert.toImmunizationRecommendation(json);
//
...
export interface Recommendation {
     ...
     */
    contraindicatedVaccineCode?: PurpleType[];
    /**
     ...
     */
    forecastReason?: PurpleType[];
    /**
     * Indicates the patient status with respect to the path to immunity for the target disease.
     */
    forecastStatus: PurpleType;
    /**
     * Unique id for the element within a resource (for internal references). This may be any
     * string value that does not contain spaces.
     */
     ...
     */
    supportingImmunization?: AuthorReference[];
    /**
     ...
     */
    supportingPatientInformation?: AuthorReference[];
    /**
     * The targeted disease for the recommendation.
     */
...
export namespace Convert {
    export function toImmunizationRecommendation(json: string): ImmunizationRecommendation {
        return cast(JSON.parse(json), r("ImmunizationRecommendation"));
    }

    export function immunizationRecommendationToJson(value: ImmunizationRecommendation): string {
        return JSON.stringify(uncast(value, r("ImmunizationRecommendation")), null, 2);
    }
    ...
    const typeMap: any = {
        "ImmunizationRecommendation": o([
            ...
            { json: "recommendation", js: "recommendation", typ: u(undefined, a(r("Recommendation"))) },
        ...
        "Recommendation": o([
            ...
            { json: "contraindicatedVaccineCode", js: "contraindicatedVaccineCode", typ: u(undefined, a(r("PurpleType"))) },
            { json: "dateCriterion", js: "dateCriterion", typ: u(undefined, a(r("DateCriterion"))) },
            { json: "description", js: "description", typ: u(undefined, "") },
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "forecastReason", js: "forecastReason", typ: u(undefined, a(r("PurpleType"))) },
            { json: "forecastStatus", js: "forecastStatus", typ: r("PurpleType") },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            ...
            { json: "supportingImmunization", js: "supportingImmunization", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "supportingPatientInformation", js: "supportingPatientInformation", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "targetDisease", js: "targetDisease", typ: u(undefined, r("PurpleType")) },
            { json: "vaccineCode", js: "vaccineCode", typ: u(undefined, a(r("PurpleType"))) },
        ], false),
        "DateCriterion": o([
            { json: "_value", js: "_value", typ: u(undefined, r("PuneHedgehog")) },
