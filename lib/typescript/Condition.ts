// To parse this data:
//
//   import { Convert, Condition } from "./file";
//
//   const condition = Convert.toCondition(json);
//
...
export interface Condition {
     ...
     */
    _abatementDateTime?: PuneHedgehog;
    /**
     * Extensions for abatementString
     */
    _abatementString?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toCondition(json: string): Condition {
        return cast(JSON.parse(json), r("Condition"));
    }

    export function conditionToJson(value: Condition): string {
        return JSON.stringify(uncast(value, r("Condition")), null, 2);
    }
    ...
    const typeMap: any = {
        "Condition": o([
            { json: "_abatementDateTime", js: "_abatementDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_abatementString", js: "_abatementString", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_onsetDateTime", js: "_onsetDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_onsetString", js: "_onsetString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_recordedDate", js: "_recordedDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "abatementAge", js: "abatementAge", typ: u(undefined, r("ValueAge")) },
            { json: "abatementDateTime", js: "abatementDateTime", typ: u(undefined, "") },
            { json: "abatementPeriod", js: "abatementPeriod", typ: u(undefined, r("Period")) },
            { json: "abatementRange", js: "abatementRange", typ: u(undefined, r("ValueRange")) },
            { json: "abatementString", js: "abatementString", typ: u(undefined, "") },
            { json: "asserter", js: "asserter", typ: u(undefined, r("AuthorReference")) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, a(r("PurpleType"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "clinicalStatus", js: "clinicalStatus", typ: u(undefined, r("PurpleType")) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "encounter", js: "encounter", typ: u(undefined, r("AuthorReference")) },
            { json: "evidence", js: "evidence", typ: u(undefined, a(r("Evidence"))) },
            ...
            { json: "onsetDateTime", js: "onsetDateTime", typ: u(undefined, "") },
            ...
            { json: "recordedDate", js: "recordedDate", typ: u(undefined, "") },
            { json: "recorder", js: "recorder", typ: u(undefined, r("AuthorReference")) },
            { json: "severity", js: "severity", typ: u(undefined, r("PurpleType")) },
            { json: "stage", js: "stage", typ: u(undefined, a(r("Stage"))) },
            { json: "subject", js: "subject", typ: u(undefined, r("AuthorReference")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "verificationStatus", js: "verificationStatus", typ: u(undefined, r("PurpleType")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Evidence": o([
            { json: "code", js: "code", typ: u(undefined, a(r("PurpleType"))) },
        ...
        "Stage": o([
            { json: "assessment", js: "assessment", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "summary", js: "summary", typ: u(undefined, r("PurpleType")) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Text": o([
