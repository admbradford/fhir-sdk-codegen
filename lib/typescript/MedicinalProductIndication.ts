// To parse this data:
//
//   import { Convert, MedicinalProductIndication } from "./file";
//
//   const medicinalProductIndication = Convert.toMedicinalProductIndication(json);
//
...
export interface MedicinalProductIndication {
     ...
     */
    comorbidity?: PurpleType[];
    /**
     * The status of the disease or symptom for which the indication applies.
     */
    diseaseStatus?: PurpleType;
    /**
     * The disease, symptom or procedure that is the indication for treatment.
     */
    diseaseSymptomProcedure?: PurpleType;
    /**
     ...
     */
    undesirableEffect?: AuthorReference[];
}
...
export interface OtherTherapy {
     ...
     * another therapy.
     */
    therapyRelationshipType: PurpleType;
}
...
export interface Population {
     ...
     * The existing physiological conditions of the specific population to which this applies.
     */
    physiologicalCondition?: PurpleType;
    /**
     * Race of the specific population.
     */
    race?: PurpleType;
...
export namespace Convert {
    export function toMedicinalProductIndication(json: string): MedicinalProductIndication {
        return cast(JSON.parse(json), r("MedicinalProductIndication"));
    }

    export function medicinalProductIndicationToJson(value: MedicinalProductIndication): string {
        return JSON.stringify(uncast(value, r("MedicinalProductIndication")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductIndication": o([
            ...
            { json: "comorbidity", js: "comorbidity", typ: u(undefined, a(r("PurpleType"))) },
            { json: "diseaseStatus", js: "diseaseStatus", typ: u(undefined, r("PurpleType")) },
            { json: "diseaseSymptomProcedure", js: "diseaseSymptomProcedure", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "intendedEffect", js: "intendedEffect", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "otherTherapy", js: "otherTherapy", typ: u(undefined, a(r("OtherTherapy"))) },
            ...
            { json: "undesirableEffect", js: "undesirableEffect", typ: u(undefined, a(r("AuthorReference"))) },
        ], false),
        "ValueUsageContext": o([
        ...
        "OtherTherapy": o([
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "therapyRelationshipType", js: "therapyRelationshipType", typ: r("PurpleType") },
        ], false),
        "Population": o([
            { json: "ageCodeableConcept", js: "ageCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "ageRange", js: "ageRange", typ: u(undefined, r("ValueRange")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "gender", js: "gender", typ: u(undefined, r("PurpleType")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "physiologicalCondition", js: "physiologicalCondition", typ: u(undefined, r("PurpleType")) },
            { json: "race", js: "race", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Text": o([
