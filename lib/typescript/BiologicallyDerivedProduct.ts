// To parse this data:
//
//   import { Convert, BiologicallyDerivedProduct } from "./file";
//
//   const biologicallyDerivedProduct = Convert.toBiologicallyDerivedProduct(json);
//
...
export interface BiologicallyDerivedProduct {
     ...
     */
    _productCategory?: PuneHedgehog;
    /**
     * Extensions for quantity
     */
    _quantity?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toBiologicallyDerivedProduct(json: string): BiologicallyDerivedProduct {
        return cast(JSON.parse(json), r("BiologicallyDerivedProduct"));
    }

    export function biologicallyDerivedProductToJson(value: BiologicallyDerivedProduct): string {
        return JSON.stringify(uncast(value, r("BiologicallyDerivedProduct")), null, 2);
    }
    ...
    const typeMap: any = {
        "BiologicallyDerivedProduct": o([
            ...
            { json: "_productCategory", js: "_productCategory", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_quantity", js: "_quantity", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "manipulation", js: "manipulation", typ: u(undefined, r("Manipulation")) },
            ...
            { json: "productCode", js: "productCode", typ: u(undefined, r("PurpleType")) },
            { json: "quantity", js: "quantity", typ: u(undefined, 3.14) },
            { json: "request", js: "request", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, r("BiologicallyDerivedProductStatus")) },
            { json: "storage", js: "storage", typ: u(undefined, a(r("Storage"))) },
        ...
        "Processing": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_timeDateTime", js: "_timeDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additive", js: "additive", typ: u(undefined, r("AuthorReference")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Storage": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_scale", js: "_scale", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_temperature", js: "_temperature", typ: u(undefined, r("PuneHedgehog")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "duration", js: "duration", typ: u(undefined, r("Period")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
