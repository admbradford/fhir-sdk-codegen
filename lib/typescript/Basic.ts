// To parse this data:
//
//   import { Convert, Basic } from "./file";
//
//   const basic = Convert.toBasic(json);
//
...
export namespace Convert {
    export function toBasic(json: string): Basic {
        return cast(JSON.parse(json), r("Basic"));
    }

    export function basicToJson(value: Basic): string {
        return JSON.stringify(uncast(value, r("Basic")), null, 2);
    }
