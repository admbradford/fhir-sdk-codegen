// To parse this data:
//
//   import { Convert, DetectedIssue } from "./file";
//
//   const detectedIssue = Convert.toDetectedIssue(json);
//
...
export interface DetectedIssue {
     ...
     */
    _identifiedDateTime?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toDetectedIssue(json: string): DetectedIssue {
        return cast(JSON.parse(json), r("DetectedIssue"));
    }

    export function detectedIssueToJson(value: DetectedIssue): string {
        return JSON.stringify(uncast(value, r("DetectedIssue")), null, 2);
    }
    ...
    const typeMap: any = {
        "DetectedIssue": o([
            ...
            { json: "_identifiedDateTime", js: "_identifiedDateTime", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "identifiedDateTime", js: "identifiedDateTime", typ: u(undefined, "") },
            { json: "identifiedPeriod", js: "identifiedPeriod", typ: u(undefined, r("Period")) },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "implicated", js: "implicated", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "mitigation", js: "mitigation", typ: u(undefined, a(r("Mitigation"))) },
        ...
        "Mitigation": o([
            ...
            { json: "action", js: "action", typ: r("CodeElement") },
            { json: "author", js: "author", typ: u(undefined, r("AuthorReference")) },
