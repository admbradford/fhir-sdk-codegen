// To parse this data:
//
//   import { Convert, Coverage } from "./file";
//
//   const coverage = Convert.toCoverage(json);
//
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: RelationshipElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: RelationshipElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: RelationshipElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: RelationshipElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
...
export namespace Convert {
    export function toCoverage(json: string): Coverage {
        return cast(JSON.parse(json), r("Coverage"));
    }

    export function coverageToJson(value: Coverage): string {
        return JSON.stringify(uncast(value, r("Coverage")), null, 2);
    }
    ...
    const typeMap: any = {
        "Coverage": o([
            { json: "_dependent", js: "_dependent", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_network", js: "_network", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_order", js: "_order", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_subrogation", js: "_subrogation", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_subscriberId", js: "_subscriberId", typ: u(undefined, r("PuneHedgehog")) },
            { json: "beneficiary", js: "beneficiary", typ: u(undefined, r("AuthorReference")) },
            { json: "class", js: "class", typ: u(undefined, a(r("Class"))) },
            { json: "contract", js: "contract", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "costToBeneficiary", js: "costToBeneficiary", typ: u(undefined, a(r("CostToBeneficiary"))) },
            { json: "dependent", js: "dependent", typ: u(undefined, "") },
            ...
            { json: "payor", js: "payor", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "policyHolder", js: "policyHolder", typ: u(undefined, r("AuthorReference")) },
            { json: "relationship", js: "relationship", typ: u(undefined, r("RelationshipElement")) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "subrogation", js: "subrogation", typ: u(undefined, true) },
            { json: "subscriber", js: "subscriber", typ: u(undefined, r("AuthorReference")) },
            { json: "subscriberId", js: "subscriberId", typ: u(undefined, "") },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "type", js: "type", typ: u(undefined, r("RelationshipElement")) },
        ], false),
        "ValueUsageContext": o([
            { json: "code", js: "code", typ: r("Coding") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("RelationshipElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("RelationshipElement")) },
        ...
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("RelationshipElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("RelationshipElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("RelationshipElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("RelationshipElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("RelationshipElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("RelationshipElement")) },
        ...
        "Class": o([
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "type", js: "type", typ: r("RelationshipElement") },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "CostToBeneficiary": o([
            { json: "exception", js: "exception", typ: u(undefined, a(r("Exception"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: u(undefined, r("RelationshipElement")) },
