...
export interface Patient {
     ...
     */
    _deceasedDateTime?: PuneHedgehog;
    /**
     ...
     */
    _multipleBirthBoolean?: PuneHedgehog;
    /**
     * Extensions for multipleBirthInteger
     */
    _multipleBirthInteger?: PuneHedgehog;
    /**
     ...
     */
    generalPractitioner?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toPatient(json: string): Patient {
        return cast(JSON.parse(json), r("Patient"));
    }

    export function patientToJson(value: Patient): string {
    ...
    const typeMap: any = {
        "Patient": o([
            ...
            { json: "_deceasedDateTime", js: "_deceasedDateTime", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_multipleBirthBoolean", js: "_multipleBirthBoolean", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_multipleBirthInteger", js: "_multipleBirthInteger", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "maritalStatus", js: "maritalStatus", typ: u(undefined, r("PurpleType")) },
            { json: "meta", js: "meta", typ: u(undefined, r("Meta")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "multipleBirthBoolean", js: "multipleBirthBoolean", typ: u(undefined, true) },
            { json: "multipleBirthInteger", js: "multipleBirthInteger", typ: u(undefined, 3.14) },
            { json: "name", js: "name", typ: u(undefined, a(r("ValueHumanName"))) },
            { json: "photo", js: "photo", typ: u(undefined, a(r("ValueAttachment"))) },
        ...
        "Communication": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "language", js: "language", typ: r("PurpleType") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Contact": o([
            ...
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "relationship", js: "relationship", typ: u(undefined, a(r("PurpleType"))) },
            { json: "telecom", js: "telecom", typ: u(undefined, a(r("ValueContactPoint"))) },
        ], false),
        "Link": o([
            { json: "_type", js: "_type", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "other", js: "other", typ: r("AuthorReference") },
            { json: "type", js: "type", typ: u(undefined, r("LinkType")) },
        ], false),
        "Meta": o([
