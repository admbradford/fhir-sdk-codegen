// To parse this data:
//
//   import { Convert, Provenance } from "./file";
//
//   const provenance = Convert.toProvenance(json);
//
...
export interface Provenance {
     ...
     */
    _occurredDateTime?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toProvenance(json: string): Provenance {
        return cast(JSON.parse(json), r("Provenance"));
    }

    export function provenanceToJson(value: Provenance): string {
        return JSON.stringify(uncast(value, r("Provenance")), null, 2);
    }
    ...
    const typeMap: any = {
        "Provenance": o([
            ...
            { json: "_occurredDateTime", js: "_occurredDateTime", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_policy", js: "_policy", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_recorded", js: "_recorded", typ: u(undefined, r("PuneHedgehog")) },
            { json: "activity", js: "activity", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "occurredDateTime", js: "occurredDateTime", typ: u(undefined, "") },
            { json: "occurredPeriod", js: "occurredPeriod", typ: u(undefined, r("Period")) },
            ...
            { json: "signature", js: "signature", typ: u(undefined, a(r("ValueSignature"))) },
        ...
        "Entity": o([
            { json: "_role", js: "_role", typ: u(undefined, r("PuneHedgehog")) },
            { json: "agent", js: "agent", typ: u(undefined, a(r("Agent"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "role", js: "role", typ: u(undefined, r("Role")) },
            { json: "what", js: "what", typ: r("AuthorReference") },
        ], false),
        "Meta": o([
