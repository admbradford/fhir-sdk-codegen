// To parse this data:
//
//   import { Convert, Practitioner } from "./file";
//
//   const practitioner = Convert.toPractitioner(json);
//
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: CommunicationElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: CommunicationElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: CommunicationElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: CommunicationElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
...
export namespace Convert {
    export function toPractitioner(json: string): Practitioner {
        return cast(JSON.parse(json), r("Practitioner"));
    }

    export function practitionerToJson(value: Practitioner): string {
        return JSON.stringify(uncast(value, r("Practitioner")), null, 2);
    }
    ...
    const typeMap: any = {
        "Practitioner": o([
            ...
            { json: "communication", js: "communication", typ: u(undefined, a(r("CommunicationElement"))) },
            ...
            { json: "qualification", js: "qualification", typ: u(undefined, a(r("Qualification"))) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("CommunicationElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("CommunicationElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("CommunicationElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("CommunicationElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("CommunicationElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("CommunicationElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("CommunicationElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("CommunicationElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("CommunicationElement")) },
        ...
        "Qualification": o([
            { json: "code", js: "code", typ: r("CommunicationElement") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
