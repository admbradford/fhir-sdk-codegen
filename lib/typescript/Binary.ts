// To parse this data:
//
//   import { Convert, Binary } from "./file";
//
//   const binary = Convert.toBinary(json);
//
...
export interface Binary {
     ...
     * patient.
     */
    securityContext?: AuthorReference;
}
...
export namespace Convert {
    export function toBinary(json: string): Binary {
        return cast(JSON.parse(json), r("Binary"));
    }

    export function binaryToJson(value: Binary): string {
        return JSON.stringify(uncast(value, r("Binary")), null, 2);
    }
    ...
    const typeMap: any = {
        "Binary": o([
            ...
            { json: "securityContext", js: "securityContext", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "ValueUsageContext": o([
