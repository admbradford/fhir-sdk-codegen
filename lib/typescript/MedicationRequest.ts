// To parse this data:
//
//   import { Convert, MedicationRequest } from "./file";
//
//   const medicationRequest = Convert.toMedicationRequest(json);
//
...
export interface MedicationRequest {
     ...
     * patient.
     */
    courseOfTherapyType?: PurpleType;
    /**
     ...
     * dosage alert etc.
     */
    detectedIssue?: HammerfestPonies[];
    /**
     ...
     */
    medicationCodeableConcept?: PurpleType;
    /**
     * Identifies the medication being requested. This is a link to a resource that represents
     * the medication which may be the details of the medication or simply an attribute carrying
     * a code that identifies the medication from a known list of medications.
     */
    medicationReference?: HammerfestPonies;
    /**
     ...
     */
    priorPrescription?: HammerfestPonies;
    /**
     ...
     * original primary source-of-truth record.  It may also indicate the source of the report.
     */
    reportedReference?: HammerfestPonies;
    /**
     ...
     */
    supportingInformation?: HammerfestPonies[];
    /**
...
export interface DispenseRequest {
     ...
     * Extensions for numberOfRepeatsAllowed
     */
    _numberOfRepeatsAllowed?: PuneHedgehog;
    /**
     * The minimum period of time that must occur between dispenses of the medication.
     */
    dispenseInterval?: ValueDuration;
    /**
     * Identifies the period time over which the supplied product is expected to be used, or the
     * length of time the dispense is expected to last.
     */
    expectedSupplyDuration?: ValueDuration;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export interface Substitution {
     ...
     * True if the prescriber allows a different drug to be dispensed from what was prescribed.
     */
    allowedCodeableConcept?: PurpleType;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export namespace Convert {
    export function toMedicationRequest(json: string): MedicationRequest {
        return cast(JSON.parse(json), r("MedicationRequest"));
    }

    export function medicationRequestToJson(value: MedicationRequest): string {
        return JSON.stringify(uncast(value, r("MedicationRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicationRequest": o([
            ...
            { json: "_reportedBoolean", js: "_reportedBoolean", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "authoredOn", js: "authoredOn", typ: u(undefined, "") },
            { json: "basedOn", js: "basedOn", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "courseOfTherapyType", js: "courseOfTherapyType", typ: u(undefined, r("PurpleType")) },
            { json: "detectedIssue", js: "detectedIssue", typ: u(undefined, a(r("HammerfestPonies"))) },
            ...
            { json: "dosageInstruction", js: "dosageInstruction", typ: u(undefined, a(r("ValueDosage"))) },
            { json: "encounter", js: "encounter", typ: u(undefined, r("HammerfestPonies")) },
            { json: "eventHistory", js: "eventHistory", typ: u(undefined, a(r("HammerfestPonies"))) },
            ...
            { json: "insurance", js: "insurance", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "intent", js: "intent", typ: u(undefined, "") },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "medicationCodeableConcept", js: "medicationCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "medicationReference", js: "medicationReference", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "performerType", js: "performerType", typ: u(undefined, r("PurpleType")) },
            { json: "priority", js: "priority", typ: u(undefined, "") },
            { json: "priorPrescription", js: "priorPrescription", typ: u(undefined, r("HammerfestPonies")) },
            ...
            { json: "recorder", js: "recorder", typ: u(undefined, r("HammerfestPonies")) },
            { json: "reportedBoolean", js: "reportedBoolean", typ: u(undefined, true) },
            { json: "reportedReference", js: "reportedReference", typ: u(undefined, r("HammerfestPonies")) },
            { json: "requester", js: "requester", typ: u(undefined, r("HammerfestPonies")) },
            { json: "status", js: "status", typ: u(undefined, "") },
            { json: "statusReason", js: "statusReason", typ: u(undefined, r("PurpleType")) },
            { json: "subject", js: "subject", typ: u(undefined, r("HammerfestPonies")) },
            { json: "substitution", js: "substitution", typ: u(undefined, r("Substitution")) },
            { json: "supportingInformation", js: "supportingInformation", typ: u(undefined, a(r("HammerfestPonies"))) },
        ...
        "DispenseRequest": o([
            { json: "_numberOfRepeatsAllowed", js: "_numberOfRepeatsAllowed", typ: u(undefined, r("PuneHedgehog")) },
            { json: "dispenseInterval", js: "dispenseInterval", typ: u(undefined, r("ValueDuration")) },
            { json: "expectedSupplyDuration", js: "expectedSupplyDuration", typ: u(undefined, r("ValueDuration")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "initialFill", js: "initialFill", typ: u(undefined, r("InitialFill")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "numberOfRepeatsAllowed", js: "numberOfRepeatsAllowed", typ: u(undefined, 3.14) },
            { json: "performer", js: "performer", typ: u(undefined, r("HammerfestPonies")) },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueQuantity")) },
            { json: "validityPeriod", js: "validityPeriod", typ: u(undefined, r("Period")) },
        ], false),
        "InitialFill": o([
            { json: "duration", js: "duration", typ: u(undefined, r("ValueDuration")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "quantity", js: "quantity", typ: u(undefined, r("ValueQuantity")) },
        ...
        "Substitution": o([
            { json: "_allowedBoolean", js: "_allowedBoolean", typ: u(undefined, r("PuneHedgehog")) },
            { json: "allowedBoolean", js: "allowedBoolean", typ: u(undefined, true) },
            { json: "allowedCodeableConcept", js: "allowedCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "reason", js: "reason", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
