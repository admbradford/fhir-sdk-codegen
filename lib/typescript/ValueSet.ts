// To parse this data:
//
//   import { Convert, ValueSet } from "./file";
//
//   const valueSet = Convert.toValueSet(json);
//
...
export namespace Convert {
    export function toValueSet(json: string): ValueSet {
        return cast(JSON.parse(json), r("ValueSet"));
    }

    export function valueSetToJson(value: ValueSet): string {
        return JSON.stringify(uncast(value, r("ValueSet")), null, 2);
    }
    ...
    const typeMap: any = {
        "ValueSet": o([
            ...
            { json: "_immutable", js: "_immutable", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "compose", js: "compose", typ: u(undefined, r("Compose")) },
            ...
            { json: "immutable", js: "immutable", typ: u(undefined, true) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("ValueSetStatus")) },
        ...
        "Compose": o([
            { json: "_inactive", js: "_inactive", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_lockedDate", js: "_lockedDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "exclude", js: "exclude", typ: u(undefined, a(r("Include"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "inactive", js: "inactive", typ: u(undefined, true) },
            { json: "include", js: "include", typ: a(r("Include")) },
            { json: "lockedDate", js: "lockedDate", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Include": o([
            { json: "_system", js: "_system", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "valueSet", js: "valueSet", typ: u(undefined, a("")) },
            { json: "version", js: "version", typ: u(undefined, "") },
        ], false),
        "Concept": o([
            { json: "_code", js: "_code", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Filter": o([
            { json: "_op", js: "_op", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_property", js: "_property", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_value", js: "_value", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "op", js: "op", typ: u(undefined, r("Op")) },
            { json: "property", js: "property", typ: u(undefined, "") },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "Expansion": o([
            { json: "_identifier", js: "_identifier", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_offset", js: "_offset", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_timestamp", js: "_timestamp", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_total", js: "_total", typ: u(undefined, r("PuneHedgehog")) },
            { json: "contains", js: "contains", typ: u(undefined, a(r("Contains"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
