// To parse this data:
//
//   import { Convert, MessageHeader } from "./file";
//
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: ReasonElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: ReasonElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: ReasonElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: ReasonElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
 ...
 * the event that is a focus of this message.
 */
export interface ReasonElement {
    /**
     * Extensions for text
     */
    _text?: PuneHedgehog;
...
export namespace Convert {
    export function toMessageHeader(json: string): MessageHeader {
        return cast(JSON.parse(json), r("MessageHeader"));
    }

    export function messageHeaderToJson(value: MessageHeader): string {
    ...
    const typeMap: any = {
        "MessageHeader": o([
            ...
            { json: "focus", js: "focus", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("ReasonElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("ReasonElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("ReasonElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("ReasonElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("ReasonElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("ReasonElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("ReasonElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("ReasonElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("ReasonElement")) },
        ...
        "Destination": o([
            { json: "_endpoint", js: "_endpoint", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "receiver", js: "receiver", typ: u(undefined, r("AuthorReference")) },
            { json: "target", js: "target", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Meta": o([
        ...
        "Response": o([
            ...
            { json: "details", js: "details", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
        ...
        "Source": o([
            { json: "_endpoint", js: "_endpoint", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_software", js: "_software", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_version", js: "_version", typ: u(undefined, r("PuneHedgehog")) },
            { json: "contact", js: "contact", typ: u(undefined, r("ValueContactPoint")) },
            { json: "endpoint", js: "endpoint", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
