// To parse this data:
//
//   import { Convert, SupplyRequest } from "./file";
//
//   const supplyRequest = Convert.toSupplyRequest(json);
//
...
export interface SupplyRequest {
     ...
     */
    deliverFrom?: AuthorReference;
    /**
     * Where the supply is destined to go.
     */
    deliverTo?: AuthorReference;
    /**
...
export namespace Convert {
    export function toSupplyRequest(json: string): SupplyRequest {
        return cast(JSON.parse(json), r("SupplyRequest"));
    }

    export function supplyRequestToJson(value: SupplyRequest): string {
        return JSON.stringify(uncast(value, r("SupplyRequest")), null, 2);
    }
    ...
    const typeMap: any = {
        "SupplyRequest": o([
            ...
            { json: "deliverFrom", js: "deliverFrom", typ: u(undefined, r("AuthorReference")) },
            { json: "deliverTo", js: "deliverTo", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("SupplyRequestStatus")) },
            { json: "supplier", js: "supplier", typ: u(undefined, a(r("AuthorReference"))) },
