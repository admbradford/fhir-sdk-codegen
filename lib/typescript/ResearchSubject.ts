// To parse this data:
//
//   import { Convert, ResearchSubject } from "./file";
//
//   const researchSubject = Convert.toResearchSubject(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * A physical entity which is the primary unit of operational and/or administrative interest
 * in a study.
 */
export interface ResearchSubject {
     ...
     */
    _actualArm?: PuneHedgehog;
    /**
     * Extensions for assignedArm
     */
    _assignedArm?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toResearchSubject(json: string): ResearchSubject {
        return cast(JSON.parse(json), r("ResearchSubject"));
    }

    export function researchSubjectToJson(value: ResearchSubject): string {
        return JSON.stringify(uncast(value, r("ResearchSubject")), null, 2);
    }
    ...
    const typeMap: any = {
        "ResearchSubject": o([
            { json: "_actualArm", js: "_actualArm", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_assignedArm", js: "_assignedArm", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "actualArm", js: "actualArm", typ: u(undefined, "") },
            { json: "assignedArm", js: "assignedArm", typ: u(undefined, "") },
            { json: "consent", js: "consent", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "individual", js: "individual", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("ResearchSubjectStatus")) },
            { json: "study", js: "study", typ: u(undefined, r("AuthorReference")) },
