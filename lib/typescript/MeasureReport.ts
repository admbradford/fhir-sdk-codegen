// To parse this data:
//
//   import { Convert, MeasureReport } from "./file";
//
//   const measureReport = Convert.toMeasureReport(json);
//
...
export interface MeasureReport {
     ...
     * this measure.
     */
    evaluatedResource?: AuthorReference[];
    /**
...
export interface GroupPopulation {
     ...
     * subject in this population.
     */
    subjectResults?: AuthorReference;
}
...
export namespace Convert {
    export function toMeasureReport(json: string): MeasureReport {
        return cast(JSON.parse(json), r("MeasureReport"));
    }

    export function measureReportToJson(value: MeasureReport): string {
        return JSON.stringify(uncast(value, r("MeasureReport")), null, 2);
    }
    ...
    const typeMap: any = {
        "MeasureReport": o([
            ...
            { json: "evaluatedResource", js: "evaluatedResource", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "reporter", js: "reporter", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("MeasureReportStatus")) },
            { json: "subject", js: "subject", typ: u(undefined, r("AuthorReference")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "type", js: "type", typ: u(undefined, r("MeasureReportType")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Group": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "measureScore", js: "measureScore", typ: u(undefined, r("ValueQuantity")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "population", js: "population", typ: u(undefined, a(r("GroupPopulation"))) },
        ...
        "GroupPopulation": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "subjectResults", js: "subjectResults", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Stratifier": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "stratum", js: "stratum", typ: u(undefined, a(r("Stratum"))) },
        ], false),
        "Stratum": o([
            ...
            { json: "measureScore", js: "measureScore", typ: u(undefined, r("ValueQuantity")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "population", js: "population", typ: u(undefined, a(r("StratumPopulation"))) },
            { json: "value", js: "value", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Component": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "value", js: "value", typ: r("PurpleType") },
        ], false),
        "StratumPopulation": o([
            { json: "_count", js: "_count", typ: u(undefined, r("PuneHedgehog")) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
