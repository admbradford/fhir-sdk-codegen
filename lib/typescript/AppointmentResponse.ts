// To parse this data:
//
//   import { Convert, AppointmentResponse } from "./file";
//
//   const appointmentResponse = Convert.toAppointmentResponse(json);
//
...
export interface AppointmentResponse {
     ...
     */
    _participantStatus?: PuneHedgehog;
    /**
     ...
     */
    participantType?: ParticipantTypeElement[];
    /**
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: ParticipantTypeElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: ParticipantTypeElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: ParticipantTypeElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: ParticipantTypeElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
 ...
 * the value is defined by the code.
 */
export interface ParticipantTypeElement {
    /**
     * Extensions for text
     */
    _text?: PuneHedgehog;
...
export namespace Convert {
    export function toAppointmentResponse(json: string): AppointmentResponse {
        return cast(JSON.parse(json), r("AppointmentResponse"));
    }

    export function appointmentResponseToJson(value: AppointmentResponse): string {
        return JSON.stringify(uncast(value, r("AppointmentResponse")), null, 2);
    }
    ...
    const typeMap: any = {
        "AppointmentResponse": o([
            ...
            { json: "_participantStatus", js: "_participantStatus", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_start", js: "_start", typ: u(undefined, r("PuneHedgehog")) },
            { json: "actor", js: "actor", typ: u(undefined, r("AuthorReference")) },
            { json: "appointment", js: "appointment", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "participantStatus", js: "participantStatus", typ: u(undefined, "") },
            { json: "participantType", js: "participantType", typ: u(undefined, a(r("ParticipantTypeElement"))) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("ParticipantTypeElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("ParticipantTypeElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("ParticipantTypeElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("ParticipantTypeElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("ParticipantTypeElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("ParticipantTypeElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("ParticipantTypeElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("ParticipantTypeElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("ParticipantTypeElement")) },
