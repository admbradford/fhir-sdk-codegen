// To parse this data:
//
//   import { Convert, MedicinalProduct } from "./file";
//
//   const medicinalProduct = Convert.toMedicinalProduct(json);
//
...
export interface MedicinalProduct {
     ...
     */
    _specialMeasures?: PuneHedgehog[];
    /**
     * Whether the Medicinal Product is subject to additional monitoring for regulatory reasons.
     */
    additionalMonitoringIndicator?: HammerfestPonies;
    /**
     * Supporting documentation, typically for regulatory submission.
     */
    attachedDocument?: AuthorReference[];
    /**
     * Clinical trials or studies that this product is involved in.
     */
    clinicalTrial?: AuthorReference[];
    /**
     * The dose form for a single part product, or combined form of a multiple part product.
     */
    combinedPharmaceuticalDoseForm?: HammerfestPonies;
    /**
     * A product specific contact, person (in a role), or an organization.
     */
    contact?: AuthorReference[];
    /**
     ...
     */
    legalStatusOfSupply?: HammerfestPonies;
    /**
     ...
     */
    packagedMedicinalProduct?: AuthorReference[];
    /**
     * If authorised for use in children.
     */
    paediatricUseIndicator?: HammerfestPonies;
    /**
     * Pharmaceutical aspects of product.
     */
    pharmaceuticalProduct?: AuthorReference[];
    /**
     * Allows the product to be classified by various systems.
     */
    productClassification?: HammerfestPonies[];
    /**
 ...
 * care (e.g. regulatory use).
 */
export interface ManufacturingBusinessOperation {
    /**
     * Extensions for effectiveDate
     */
    _effectiveDate?: PuneHedgehog;
    /**
     * Regulatory authorization reference number.
     */
     ...
     * To indicate if this proces is commercially confidential.
     */
    confidentialityIndicator?: HammerfestPonies;
    /**
     ...
     * The type of manufacturing operation.
     */
    operationType?: HammerfestPonies;
    /**
     * A regulator which oversees the operation.
     */
    regulator?: AuthorReference;
}
...
export interface SpecialDesignation {
     ...
     * Condition for which the medicinal use applies.
     */
    indicationCodeableConcept?: HammerfestPonies;
    /**
     * Condition for which the medicinal use applies.
     */
    indicationReference?: AuthorReference;
    /**
     * The intended use of the product, e.g. prevention, treatment.
     */
    intendedUse?: HammerfestPonies;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element and that modifies the understanding of the element in which it is
     * contained and/or the understanding of the containing element's descendants. Usually
...
export namespace Convert {
    export function toMedicinalProduct(json: string): MedicinalProduct {
        return cast(JSON.parse(json), r("MedicinalProduct"));
    }

    export function medicinalProductToJson(value: MedicinalProduct): string {
        return JSON.stringify(uncast(value, r("MedicinalProduct")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProduct": o([
            ...
            { json: "_specialMeasures", js: "_specialMeasures", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "additionalMonitoringIndicator", js: "additionalMonitoringIndicator", typ: u(undefined, r("HammerfestPonies")) },
            { json: "attachedDocument", js: "attachedDocument", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "clinicalTrial", js: "clinicalTrial", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "combinedPharmaceuticalDoseForm", js: "combinedPharmaceuticalDoseForm", typ: u(undefined, r("HammerfestPonies")) },
            { json: "contact", js: "contact", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "crossReference", js: "crossReference", typ: u(undefined, a(r("Identifier"))) },
            { json: "domain", js: "domain", typ: u(undefined, r("Coding")) },
            ...
            { json: "legalStatusOfSupply", js: "legalStatusOfSupply", typ: u(undefined, r("HammerfestPonies")) },
            { json: "manufacturingBusinessOperation", js: "manufacturingBusinessOperation", typ: u(undefined, a(r("ManufacturingBusinessOperation"))) },
            { json: "marketingStatus", js: "marketingStatus", typ: u(undefined, a(r("MarketingStatus"))) },
            { json: "masterFile", js: "masterFile", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "packagedMedicinalProduct", js: "packagedMedicinalProduct", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "paediatricUseIndicator", js: "paediatricUseIndicator", typ: u(undefined, r("HammerfestPonies")) },
            { json: "pharmaceuticalProduct", js: "pharmaceuticalProduct", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "productClassification", js: "productClassification", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "specialDesignation", js: "specialDesignation", typ: u(undefined, a(r("SpecialDesignation"))) },
            { json: "specialMeasures", js: "specialMeasures", typ: u(undefined, a("")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("HammerfestPonies")) },
            { json: "use", js: "use", typ: u(undefined, r("CrossReferenceUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "ManufacturingBusinessOperation": o([
            { json: "_effectiveDate", js: "_effectiveDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "authorisationReferenceNumber", js: "authorisationReferenceNumber", typ: u(undefined, r("Identifier")) },
            { json: "confidentialityIndicator", js: "confidentialityIndicator", typ: u(undefined, r("HammerfestPonies")) },
            { json: "effectiveDate", js: "effectiveDate", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "manufacturer", js: "manufacturer", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "operationType", js: "operationType", typ: u(undefined, r("HammerfestPonies")) },
            { json: "regulator", js: "regulator", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "MarketingStatus": o([
            { json: "_restoreDate", js: "_restoreDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "country", js: "country", typ: r("HammerfestPonies") },
            { json: "dateRange", js: "dateRange", typ: r("Period") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "jurisdiction", js: "jurisdiction", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "restoreDate", js: "restoreDate", typ: u(undefined, "") },
            { json: "status", js: "status", typ: r("HammerfestPonies") },
        ], false),
        "Meta": o([
        ...
        "Name": o([
            { json: "_productName", js: "_productName", typ: u(undefined, r("PuneHedgehog")) },
            { json: "countryLanguage", js: "countryLanguage", typ: u(undefined, a(r("CountryLanguage"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "namePart", js: "namePart", typ: u(undefined, a(r("NamePart"))) },
        ...
        "CountryLanguage": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "jurisdiction", js: "jurisdiction", typ: u(undefined, r("HammerfestPonies")) },
            { json: "language", js: "language", typ: r("HammerfestPonies") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "NamePart": o([
            { json: "_part", js: "_part", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "part", js: "part", typ: u(undefined, "") },
            { json: "type", js: "type", typ: r("Coding") },
        ], false),
        "SpecialDesignation": o([
            { json: "_date", js: "_date", typ: u(undefined, r("PuneHedgehog")) },
            { json: "date", js: "date", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "indicationCodeableConcept", js: "indicationCodeableConcept", typ: u(undefined, r("HammerfestPonies")) },
            { json: "indicationReference", js: "indicationReference", typ: u(undefined, r("AuthorReference")) },
            { json: "intendedUse", js: "intendedUse", typ: u(undefined, r("HammerfestPonies")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
