// To parse this data:
//
//   import { Convert, DeviceUseStatement } from "./file";
//
//   const deviceUseStatement = Convert.toDeviceUseStatement(json);
//
...
export namespace Convert {
    export function toDeviceUseStatement(json: string): DeviceUseStatement {
        return cast(JSON.parse(json), r("DeviceUseStatement"));
    }

    export function deviceUseStatementToJson(value: DeviceUseStatement): string {
        return JSON.stringify(uncast(value, r("DeviceUseStatement")), null, 2);
    }
    ...
    const typeMap: any = {
        "DeviceUseStatement": o([
            ...
            { json: "_recordedOn", js: "_recordedOn", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "recordedOn", js: "recordedOn", typ: u(undefined, "") },
            { json: "source", js: "source", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("DeviceUseStatementStatus")) },
