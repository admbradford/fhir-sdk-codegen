// To parse this data:
//
//   import { Convert, ImmunizationEvaluation } from "./file";
//
//   const immunizationEvaluation = Convert.toImmunizationEvaluation(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * Describes a comparison of an immunization event against published recommendations to
...
export interface ImmunizationEvaluation {
     ...
     */
    immunizationEvent?: AuthorReference;
    /**
...
export namespace Convert {
    export function toImmunizationEvaluation(json: string): ImmunizationEvaluation {
        return cast(JSON.parse(json), r("ImmunizationEvaluation"));
    }

    export function immunizationEvaluationToJson(value: ImmunizationEvaluation): string {
        return JSON.stringify(uncast(value, r("ImmunizationEvaluation")), null, 2);
    }
    ...
    const typeMap: any = {
        "ImmunizationEvaluation": o([
            ...
            { json: "doseStatus", js: "doseStatus", typ: u(undefined, r("PurpleType")) },
            { json: "doseStatusReason", js: "doseStatusReason", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "immunizationEvent", js: "immunizationEvent", typ: u(undefined, r("AuthorReference")) },
