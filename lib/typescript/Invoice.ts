...
export interface Invoice {
     ...
     * calculated.
     */
    totalPriceComponent?: PriceComponent[];
    /**
...
export interface LineItem {
     ...
     * the CodeableConcept data type instead of the Reference.
     */
    chargeItemCodeableConcept?: PurpleType;
    /**
     * The ChargeItem contains information such as the billing code, date, amount etc. If no
     * further details are required for the lineItem, inline billing codes can be added using
     * the CodeableConcept data type instead of the Reference.
     */
    chargeItemReference?: AuthorReference;
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export interface PriceComponent {
     ...
     */
    type?: TotalPriceComponentType;
}

/**
 * This code identifies the type of the component.
 */
export enum TotalPriceComponentType {
    Base = "base",
    Deduction = "deduction",
    Discount = "discount",
...
export namespace Convert {
    export function toInvoice(json: string): Invoice {
        return cast(JSON.parse(json), r("Invoice"));
    }

    export function invoiceToJson(value: Invoice): string {
    ...
    const typeMap: any = {
        "Invoice": o([
            { json: "_cancelledReason", js: "_cancelledReason", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_paymentTerms", js: "_paymentTerms", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "account", js: "account", typ: u(undefined, r("AuthorReference")) },
            { json: "cancelledReason", js: "cancelledReason", typ: u(undefined, "") },
            ...
            { json: "issuer", js: "issuer", typ: u(undefined, r("AuthorReference")) },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "lineItem", js: "lineItem", typ: u(undefined, a(r("LineItem"))) },
            ...
            { json: "paymentTerms", js: "paymentTerms", typ: u(undefined, "") },
            { json: "recipient", js: "recipient", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("InvoiceStatus")) },
            { json: "subject", js: "subject", typ: u(undefined, r("AuthorReference")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "totalGross", js: "totalGross", typ: u(undefined, r("ValueMoney")) },
            { json: "totalNet", js: "totalNet", typ: u(undefined, r("ValueMoney")) },
            { json: "totalPriceComponent", js: "totalPriceComponent", typ: u(undefined, a(r("PriceComponent"))) },
        ...
        "LineItem": o([
            { json: "_sequence", js: "_sequence", typ: u(undefined, r("PuneHedgehog")) },
            { json: "chargeItemCodeableConcept", js: "chargeItemCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "chargeItemReference", js: "chargeItemReference", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "PriceComponent": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: u(undefined, r("TotalPriceComponentType")) },
        ], false),
        "Meta": o([
