// To parse this data:
//
//   import { Convert, Goal } from "./file";
//
//   const goal = Convert.toGoal(json);
//
...
export interface Goal {
     ...
     */
    _lifecycleStatus?: PuneHedgehog;
    /**
     * Extensions for startDate
     */
    _startDate?: PuneHedgehog;
    /**
     ...
     * assessed.
     */
    outcomeCode?: PurpleType[];
    /**
     * Details of what's changed (or not changed).
     */
    outcomeReference?: AuthorReference[];
    /**
     ...
     */
    startCodeableConcept?: PurpleType;
    /**
     * The date or event after which the goal should begin being pursued.
     */
    startDate?: string;
...
export interface Target {
     ...
     * Extensions for detailBoolean
     */
    _detailBoolean?: PuneHedgehog;
    /**
     * Extensions for detailInteger
     */
    _detailInteger?: PuneHedgehog;
    /**
     * Extensions for detailString
     */
    _detailString?: PuneHedgehog;
    /**
     * Extensions for dueDate
     */
    _dueDate?: PuneHedgehog;
    /**
     * The target value of the focus to be achieved to signify the fulfillment of the goal, e.g.
     * 150 pounds, 7.0%. Either the high or low or both values of the range can be specified.
     * When a low value is missing, it indicates that the goal is achieved at any focus value at
     ...
     * goal is achieved at any focus value at or above the low value.
     */
    detailCodeableConcept?: PurpleType;
    /**
     * The target value of the focus to be achieved to signify the fulfillment of the goal, e.g.
     * 150 pounds, 7.0%. Either the high or low or both values of the range can be specified.
     * When a low value is missing, it indicates that the goal is achieved at any focus value at
...
export namespace Convert {
    export function toGoal(json: string): Goal {
        return cast(JSON.parse(json), r("Goal"));
    }

    export function goalToJson(value: Goal): string {
    ...
    const typeMap: any = {
        "Goal": o([
            ...
            { json: "_lifecycleStatus", js: "_lifecycleStatus", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_startDate", js: "_startDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_statusDate", js: "_statusDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_statusReason", js: "_statusReason", typ: u(undefined, r("PuneHedgehog")) },
            { json: "achievementStatus", js: "achievementStatus", typ: u(undefined, r("PurpleType")) },
            { json: "addresses", js: "addresses", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "description", js: "description", typ: u(undefined, r("PurpleType")) },
            { json: "expressedBy", js: "expressedBy", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "lifecycleStatus", js: "lifecycleStatus", typ: u(undefined, r("LifecycleStatus")) },
            ...
            { json: "outcomeCode", js: "outcomeCode", typ: u(undefined, a(r("PurpleType"))) },
            { json: "outcomeReference", js: "outcomeReference", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "priority", js: "priority", typ: u(undefined, r("PurpleType")) },
            { json: "startCodeableConcept", js: "startCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "startDate", js: "startDate", typ: u(undefined, "") },
            { json: "statusDate", js: "statusDate", typ: u(undefined, "") },
            { json: "statusReason", js: "statusReason", typ: u(undefined, "") },
        ...
        "Target": o([
            { json: "_detailBoolean", js: "_detailBoolean", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_detailInteger", js: "_detailInteger", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_detailString", js: "_detailString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_dueDate", js: "_dueDate", typ: u(undefined, r("PuneHedgehog")) },
            { json: "detailBoolean", js: "detailBoolean", typ: u(undefined, true) },
            { json: "detailCodeableConcept", js: "detailCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "detailInteger", js: "detailInteger", typ: u(undefined, 3.14) },
            ...
            { json: "detailRatio", js: "detailRatio", typ: u(undefined, r("ValueRatio")) },
            { json: "detailString", js: "detailString", typ: u(undefined, "") },
            { json: "dueDate", js: "dueDate", typ: u(undefined, "") },
            { json: "dueDuration", js: "dueDuration", typ: u(undefined, r("ValueDuration")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "measure", js: "measure", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Text": o([
