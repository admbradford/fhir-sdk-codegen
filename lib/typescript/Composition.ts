// To parse this data:
//
//   import { Convert, Composition } from "./file";
//
//   const composition = Convert.toComposition(json);
//
...
export interface RelatesTo {
     ...
     * The target composition/document of this relationship.
     */
    targetReference?: AuthorReference;
}
...
export interface Section {
     ...
     * explaining the empty reason.
     */
    emptyReason?: PurpleType;
    /**
     * A reference to the actual resource from which the narrative in the section is derived.
     */
    entry?: AuthorReference[];
    /**
     * May be used to represent additional information that is not part of the basic definition
     * of the element. To make the use of extensions safe and manageable, there is a strict set
     * of governance  applied to the definition and use of extensions. Though any implementer
...
export namespace Convert {
    export function toComposition(json: string): Composition {
        return cast(JSON.parse(json), r("Composition"));
    }

    export function compositionToJson(value: Composition): string {
        return JSON.stringify(uncast(value, r("Composition")), null, 2);
    }
    ...
    const typeMap: any = {
        "Composition": o([
            { json: "_confidentiality", js: "_confidentiality", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "event", js: "event", typ: u(undefined, a(r("Event"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("CompositionStatus")) },
        ...
        "Attester": o([
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "party", js: "party", typ: u(undefined, r("AuthorReference")) },
            { json: "time", js: "time", typ: u(undefined, "") },
        ], false),
        "Event": o([
        ...
        "RelatesTo": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "targetIdentifier", js: "targetIdentifier", typ: u(undefined, r("Identifier")) },
            { json: "targetReference", js: "targetReference", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Section": o([
            { json: "_mode", js: "_mode", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_title", js: "_title", typ: u(undefined, r("PuneHedgehog")) },
            { json: "author", js: "author", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "emptyReason", js: "emptyReason", typ: u(undefined, r("PurpleType")) },
            { json: "entry", js: "entry", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "focus", js: "focus", typ: u(undefined, r("AuthorReference")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "mode", js: "mode", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "orderedBy", js: "orderedBy", typ: u(undefined, r("PurpleType")) },
            { json: "section", js: "section", typ: u(undefined, a(r("Section"))) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "title", js: "title", typ: u(undefined, "") },
        ], false),
