// To parse this data:
//
//   import { Convert, MedicinalProductManufactured } from "./file";
//
//   const medicinalProductManufactured = Convert.toMedicinalProductManufactured(json);
//
...
export interface MedicinalProductManufactured {
     ...
     */
    manufacturedDoseForm?: PurpleType;
    /**
...
export namespace Convert {
    export function toMedicinalProductManufactured(json: string): MedicinalProductManufactured {
        return cast(JSON.parse(json), r("MedicinalProductManufactured"));
    }

    export function medicinalProductManufacturedToJson(value: MedicinalProductManufactured): string {
        return JSON.stringify(uncast(value, r("MedicinalProductManufactured")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicinalProductManufactured": o([
            ...
            { json: "manufacturedDoseForm", js: "manufacturedDoseForm", typ: u(undefined, r("PurpleType")) },
