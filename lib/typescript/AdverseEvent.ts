// To parse this data:
//
//   import { Convert, AdverseEvent } from "./file";
//
//   const adverseEvent = Convert.toAdverseEvent(json);
//
...
export interface AdverseEvent {
     ...
     */
    referenceDocument?: AuthorReference[];
    /**
     ...
     */
    resultingCondition?: AuthorReference[];
    /**
     * Assessment whether this event was of real importance.
     */
    seriousness?: PurpleType;
    /**
     ...
     */
    subjectMedicalHistory?: AuthorReference[];
    /**
...
export interface Causality {
     ...
     * Extensions for productRelatedness
     */
    _productRelatedness?: PuneHedgehog;
    /**
     * Assessment of if the entity caused the event.
     */
    assessment?: PurpleType;
    /**
     * AdverseEvent.suspectEntity.causalityAuthor.
     */
...
export namespace Convert {
    export function toAdverseEvent(json: string): AdverseEvent {
        return cast(JSON.parse(json), r("AdverseEvent"));
    }

    export function adverseEventToJson(value: AdverseEvent): string {
        return JSON.stringify(uncast(value, r("AdverseEvent")), null, 2);
    }
    ...
    const typeMap: any = {
        "AdverseEvent": o([
            { json: "_actuality", js: "_actuality", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_date", js: "_date", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_detected", js: "_detected", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "actuality", js: "actuality", typ: u(undefined, r("Actuality")) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "contributor", js: "contributor", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "date", js: "date", typ: u(undefined, "") },
            { json: "detected", js: "detected", typ: u(undefined, "") },
            { json: "encounter", js: "encounter", typ: u(undefined, r("AuthorReference")) },
            { json: "event", js: "event", typ: u(undefined, r("PurpleType")) },
            ...
            { json: "referenceDocument", js: "referenceDocument", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "resultingCondition", js: "resultingCondition", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "seriousness", js: "seriousness", typ: u(undefined, r("PurpleType")) },
            { json: "severity", js: "severity", typ: u(undefined, r("PurpleType")) },
            { json: "study", js: "study", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "subject", js: "subject", typ: u(undefined, r("AuthorReference")) },
            { json: "subjectMedicalHistory", js: "subjectMedicalHistory", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "suspectEntity", js: "suspectEntity", typ: u(undefined, a(r("SuspectEntity"))) },
        ...
        "SuspectEntity": o([
            { json: "causality", js: "causality", typ: u(undefined, a(r("Causality"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "instance", js: "instance", typ: r("AuthorReference") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "Causality": o([
            { json: "_productRelatedness", js: "_productRelatedness", typ: u(undefined, r("PuneHedgehog")) },
            { json: "assessment", js: "assessment", typ: u(undefined, r("PurpleType")) },
            { json: "author", js: "author", typ: u(undefined, r("AuthorReference")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "method", js: "method", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "productRelatedness", js: "productRelatedness", typ: u(undefined, "") },
        ], false),
        "Text": o([
