// To parse this data:
//
//   import { Convert, ObservationDefinition } from "./file";
//
//   const observationDefinition = Convert.toObservationDefinition(json);
//
...
export interface ObservationDefinition {
     ...
     * ObservationDefinition.
     */
    criticalCodedValueSet?: AuthorReference;
    /**
     ...
     * ObservationDefinition.
     */
    normalCodedValueSet?: AuthorReference;
    /**
     ...
     * ObservationDefinition.
     */
    validCodedValueSet?: AuthorReference;
}
 ...
 * consumed by an orderable health care service.
 */
export interface QualifiedInterval {
    /**
     * Extensions for category
     */
    _category?: PuneHedgehog;
    /**
     * Extensions for condition
     */
...
export interface QuantitativeDetails {
     ...
     * Extensions for conversionFactor
     */
    _conversionFactor?: PuneHedgehog;
    /**
     * Extensions for decimalPrecision
     */
    _decimalPrecision?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toObservationDefinition(json: string): ObservationDefinition {
        return cast(JSON.parse(json), r("ObservationDefinition"));
    }

    export function observationDefinitionToJson(value: ObservationDefinition): string {
        return JSON.stringify(uncast(value, r("ObservationDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "ObservationDefinition": o([
            ...
            { json: "_multipleResultsAllowed", js: "_multipleResultsAllowed", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_permittedDataType", js: "_permittedDataType", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_preferredReportName", js: "_preferredReportName", typ: u(undefined, r("PuneHedgehog")) },
            { json: "abnormalCodedValueSet", js: "abnormalCodedValueSet", typ: u(undefined, r("AuthorReference")) },
            { json: "category", js: "category", typ: u(undefined, a(r("PurpleType"))) },
            { json: "code", js: "code", typ: u(undefined, r("PurpleType")) },
            { json: "criticalCodedValueSet", js: "criticalCodedValueSet", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "multipleResultsAllowed", js: "multipleResultsAllowed", typ: u(undefined, true) },
            { json: "normalCodedValueSet", js: "normalCodedValueSet", typ: u(undefined, r("AuthorReference")) },
            { json: "permittedDataType", js: "permittedDataType", typ: u(undefined, a(r("PermittedDataType"))) },
            { json: "preferredReportName", js: "preferredReportName", typ: u(undefined, "") },
            { json: "qualifiedInterval", js: "qualifiedInterval", typ: u(undefined, a(r("QualifiedInterval"))) },
            { json: "quantitativeDetails", js: "quantitativeDetails", typ: u(undefined, r("QuantitativeDetails")) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "validCodedValueSet", js: "validCodedValueSet", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "QualifiedInterval": o([
            { json: "_category", js: "_category", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_condition", js: "_condition", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_gender", js: "_gender", typ: u(undefined, r("PuneHedgehog")) },
            { json: "age", js: "age", typ: u(undefined, r("ValueRange")) },
            { json: "appliesTo", js: "appliesTo", typ: u(undefined, a(r("PurpleType"))) },
            { json: "category", js: "category", typ: u(undefined, r("Category")) },
            { json: "condition", js: "condition", typ: u(undefined, "") },
            { json: "context", js: "context", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "gender", js: "gender", typ: u(undefined, r("Gender")) },
            { json: "gestationalAge", js: "gestationalAge", typ: u(undefined, r("ValueRange")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "range", js: "range", typ: u(undefined, r("ValueRange")) },
        ], false),
        "QuantitativeDetails": o([
            { json: "_conversionFactor", js: "_conversionFactor", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_decimalPrecision", js: "_decimalPrecision", typ: u(undefined, r("PuneHedgehog")) },
            { json: "conversionFactor", js: "conversionFactor", typ: u(undefined, 3.14) },
            { json: "customaryUnit", js: "customaryUnit", typ: u(undefined, r("PurpleType")) },
            { json: "decimalPrecision", js: "decimalPrecision", typ: u(undefined, 3.14) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
