// To parse this data:
//
//   import { Convert, ResearchDefinition } from "./file";
//
//   const researchDefinition = Convert.toResearchDefinition(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * The ResearchDefinition resource describes the conditional state (population and any
...
export namespace Convert {
    export function toResearchDefinition(json: string): ResearchDefinition {
        return cast(JSON.parse(json), r("ResearchDefinition"));
    }

    export function researchDefinitionToJson(value: ResearchDefinition): string {
        return JSON.stringify(uncast(value, r("ResearchDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "ResearchDefinition": o([
            ...
            { json: "status", js: "status", typ: u(undefined, r("ResearchDefinitionStatus")) },
