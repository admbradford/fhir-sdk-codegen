// To parse this data:
//
//   import { Convert, Communication } from "./file";
//
//   const communication = Convert.toCommunication(json);
//
...
export interface Payload {
     ...
     * communication).
     */
    contentReference?: AuthorReference;
    /**
     * A communicated content (or for multi-part communications, one portion of the
     * communication).
     */
...
export namespace Convert {
    export function toCommunication(json: string): Communication {
        return cast(JSON.parse(json), r("Communication"));
    }

    export function communicationToJson(value: Communication): string {
        return JSON.stringify(uncast(value, r("Communication")), null, 2);
    }
    ...
    const typeMap: any = {
        "Communication": o([
            ...
            { json: "_received", js: "_received", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_sent", js: "_sent", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "about", js: "about", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "inResponseTo", js: "inResponseTo", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "medium", js: "medium", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "payload", js: "payload", typ: u(undefined, a(r("Payload"))) },
            ...
            { json: "topic", js: "topic", typ: u(undefined, r("PurpleType")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Payload": o([
            { json: "_contentString", js: "_contentString", typ: u(undefined, r("PuneHedgehog")) },
            { json: "contentAttachment", js: "contentAttachment", typ: u(undefined, r("ValueAttachment")) },
            { json: "contentReference", js: "contentReference", typ: u(undefined, r("AuthorReference")) },
            { json: "contentString", js: "contentString", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
