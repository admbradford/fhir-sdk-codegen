// To parse this data:
//
//   import { Convert, Endpoint } from "./file";
//
//   const endpoint = Convert.toEndpoint(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * The technical details of an endpoint that can be used for electronic services, such as
...
export interface Endpoint {
     ...
     * endpoint.
     */
    payloadType?: PayloadTypeElement[];
    /**
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: PayloadTypeElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: PayloadTypeElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: PayloadTypeElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: PayloadTypeElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
 ...
 * the value is defined by the code.
 */
export interface PayloadTypeElement {
    /**
     * Extensions for text
     */
    _text?: PuneHedgehog;
...
export namespace Convert {
    export function toEndpoint(json: string): Endpoint {
        return cast(JSON.parse(json), r("Endpoint"));
    }

    export function endpointToJson(value: Endpoint): string {
        return JSON.stringify(uncast(value, r("Endpoint")), null, 2);
    }
    ...
    const typeMap: any = {
        "Endpoint": o([
            ...
            { json: "_header", js: "_header", typ: u(undefined, a(r("PuneHedgehog"))) },
            ...
            { json: "_payloadMimeType", js: "_payloadMimeType", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "address", js: "address", typ: u(undefined, "") },
            { json: "connectionType", js: "connectionType", typ: u(undefined, r("Coding")) },
            ...
            { json: "payloadMimeType", js: "payloadMimeType", typ: u(undefined, a("")) },
            { json: "payloadType", js: "payloadType", typ: u(undefined, a(r("PayloadTypeElement"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "status", js: "status", typ: u(undefined, r("EndpointStatus")) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("PayloadTypeElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("PayloadTypeElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("PayloadTypeElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("PayloadTypeElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("PayloadTypeElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("PayloadTypeElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("PayloadTypeElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("PayloadTypeElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("PayloadTypeElement")) },
