// To parse this data:
//
//   import { Convert, OrganizationAffiliation } from "./file";
//
//   const organizationAffiliation = Convert.toOrganizationAffiliation(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

/**
 * Defines an affiliation/assotiation/relationship between 2 distinct oganizations, that is
 * not a part-of relationship/sub-division relationship.
 */
export interface OrganizationAffiliation {
     ...
     */
    participatingOrganization?: AuthorReference;
    /**
...
export namespace Convert {
    export function toOrganizationAffiliation(json: string): OrganizationAffiliation {
        return cast(JSON.parse(json), r("OrganizationAffiliation"));
    }

    export function organizationAffiliationToJson(value: OrganizationAffiliation): string {
        return JSON.stringify(uncast(value, r("OrganizationAffiliation")), null, 2);
    }
    ...
    const typeMap: any = {
        "OrganizationAffiliation": o([
            ...
            { json: "participatingOrganization", js: "participatingOrganization", typ: u(undefined, r("AuthorReference")) },
