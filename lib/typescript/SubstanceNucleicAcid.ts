// To parse this data:
//
//   import { Convert, SubstanceNucleicAcid } from "./file";
//
//   const substanceNucleicAcid = Convert.toSubstanceNucleicAcid(json);
//
...
export interface SubstanceNucleicAcid {
     ...
     */
    _areaOfHybridisation?: PuneHedgehog;
    /**
     ...
     * (TBC).
     */
    oligoNucleotideType?: PurpleType;
    /**
     * The type of the sequence shall be specified based on a controlled vocabulary.
     */
    sequenceType?: PurpleType;
    /**
...
export namespace Convert {
    export function toSubstanceNucleicAcid(json: string): SubstanceNucleicAcid {
        return cast(JSON.parse(json), r("SubstanceNucleicAcid"));
    }

    export function substanceNucleicAcidToJson(value: SubstanceNucleicAcid): string {
        return JSON.stringify(uncast(value, r("SubstanceNucleicAcid")), null, 2);
    }
    ...
    const typeMap: any = {
        "SubstanceNucleicAcid": o([
            { json: "_areaOfHybridisation", js: "_areaOfHybridisation", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "areaOfHybridisation", js: "areaOfHybridisation", typ: u(undefined, "") },
            ...
            { json: "oligoNucleotideType", js: "oligoNucleotideType", typ: u(undefined, r("PurpleType")) },
            { json: "sequenceType", js: "sequenceType", typ: u(undefined, r("PurpleType")) },
        ...
        "Subunit": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "fivePrime", js: "fivePrime", typ: u(undefined, r("PurpleType")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "length", js: "length", typ: u(undefined, 3.14) },
            { json: "linkage", js: "linkage", typ: u(undefined, a(r("Linkage"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            ...
            { json: "sugar", js: "sugar", typ: u(undefined, a(r("Sugar"))) },
            { json: "threePrime", js: "threePrime", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Linkage": o([
            { json: "_connectivity", js: "_connectivity", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_residueSite", js: "_residueSite", typ: u(undefined, r("PuneHedgehog")) },
            { json: "connectivity", js: "connectivity", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, r("Identifier")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "residueSite", js: "residueSite", typ: u(undefined, "") },
        ], false),
        "Sugar": o([
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_residueSite", js: "_residueSite", typ: u(undefined, r("PuneHedgehog")) },
