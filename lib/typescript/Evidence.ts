// To parse this data:
//
//   import { Convert, Evidence } from "./file";
//
...
export interface Evidence {
     ...
     */
    exposureBackground?: AuthorReference;
    /**
     * A reference to a EvidenceVariable resource that defines the exposure for the research.
     */
    exposureVariant?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toEvidence(json: string): Evidence {
        return cast(JSON.parse(json), r("Evidence"));
    }

    export function evidenceToJson(value: Evidence): string {
    ...
    const typeMap: any = {
        "Evidence": o([
            ...
            { json: "exposureBackground", js: "exposureBackground", typ: u(undefined, r("AuthorReference")) },
            { json: "exposureVariant", js: "exposureVariant", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "outcome", js: "outcome", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "status", js: "status", typ: u(undefined, r("EvidenceStatus")) },
