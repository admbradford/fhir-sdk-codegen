// To parse this data:
//
//   import { Convert, MedicationStatement } from "./file";
//
//   const medicationStatement = Convert.toMedicationStatement(json);
//
 ...
 * taking process during a patient visit or stay.   The medication information may come from
 * sources such as the patient's memory, from a prescription bottle,  or from a list of
 ...
 * that the medication administration has complete administration information and is based
 * on actual administration information from the person who administered the medication.  A
 * medication statement is often, if not always, less specific.  There is no required
 * date/time when the medication was administered, in fact we only know that a source has
 * reported the patient is taking this medication, where details such as time, quantity, or
 * rate or even medication product may be incomplete or missing or less precise.  As stated
...
export interface MedicationStatement {
     ...
     */
    _dateAsserted?: PuneHedgehog;
    /**
     * Extensions for effectiveDateTime
     */
    _effectiveDateTime?: PuneHedgehog;
    /**
     ...
     */
    informationSource?: AuthorReference;
    /**
     ...
     * identifies the medication from a known list of medications.
     */
    medicationReference?: AuthorReference;
    /**
...
export namespace Convert {
    export function toMedicationStatement(json: string): MedicationStatement {
        return cast(JSON.parse(json), r("MedicationStatement"));
    }

    export function medicationStatementToJson(value: MedicationStatement): string {
        return JSON.stringify(uncast(value, r("MedicationStatement")), null, 2);
    }
    ...
    const typeMap: any = {
        "MedicationStatement": o([
            { json: "_dateAsserted", js: "_dateAsserted", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_effectiveDateTime", js: "_effectiveDateTime", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "dateAsserted", js: "dateAsserted", typ: u(undefined, "") },
            { json: "derivedFrom", js: "derivedFrom", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "dosage", js: "dosage", typ: u(undefined, a(r("ValueDosage"))) },
            { json: "effectiveDateTime", js: "effectiveDateTime", typ: u(undefined, "") },
            ...
            { json: "informationSource", js: "informationSource", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "medicationReference", js: "medicationReference", typ: u(undefined, r("AuthorReference")) },
