// To parse this data:
//
//   import { Convert, Claim } from "./file";
//
//   const claim = Convert.toClaim(json);
//
...
export namespace Convert {
    export function toClaim(json: string): Claim {
        return cast(JSON.parse(json), r("Claim"));
    }

    export function claimToJson(value: Claim): string {
        return JSON.stringify(uncast(value, r("Claim")), null, 2);
    }
    ...
    const typeMap: any = {
        "Claim": o([
            ...
            { json: "total", js: "total", typ: u(undefined, r("ValueMoney")) },
            { json: "type", js: "type", typ: u(undefined, r("ArakGroundhog")) },
            { json: "use", js: "use", typ: u(undefined, r("ClaimUse")) },
        ], false),
        "ValueUsageContext": o([
        ...
        "Item": o([
            ...
            { json: "detail", js: "detail", typ: u(undefined, a(r("Detail"))) },
        ...
        "Detail": o([
            ...
            { json: "revenue", js: "revenue", typ: u(undefined, r("ArakGroundhog")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "subDetail", js: "subDetail", typ: u(undefined, a(r("SubDetail"))) },
            { json: "udi", js: "udi", typ: u(undefined, a(r("HammerfestPonies"))) },
            { json: "unitPrice", js: "unitPrice", typ: u(undefined, r("ValueMoney")) },
        ], false),
        "SubDetail": o([
