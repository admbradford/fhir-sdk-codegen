// To parse this data:
//
//   import { Convert, SubstanceReferenceInformation } from "./file";
//
//   const substanceReferenceInformation = Convert.toSubstanceReferenceInformation(json);
//
...
export namespace Convert {
    export function toSubstanceReferenceInformation(json: string): SubstanceReferenceInformation {
        return cast(JSON.parse(json), r("SubstanceReferenceInformation"));
    }

    export function substanceReferenceInformationToJson(value: SubstanceReferenceInformation): string {
        return JSON.stringify(uncast(value, r("SubstanceReferenceInformation")), null, 2);
    }
    ...
    const typeMap: any = {
        "SubstanceReferenceInformation": o([
            ...
            { json: "classification", js: "classification", typ: u(undefined, a(r("Classification"))) },
            { json: "comment", js: "comment", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "gene", js: "gene", typ: u(undefined, a(r("Gene"))) },
            { json: "geneElement", js: "geneElement", typ: u(undefined, a(r("GeneElement"))) },
        ...
        "Classification": o([
            { json: "classification", js: "classification", typ: u(undefined, r("PurpleType")) },
            { json: "domain", js: "domain", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "source", js: "source", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "subtype", js: "subtype", typ: u(undefined, a(r("PurpleType"))) },
        ], false),
        "Gene": o([
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "gene", js: "gene", typ: u(undefined, r("PurpleType")) },
            { json: "geneSequenceOrigin", js: "geneSequenceOrigin", typ: u(undefined, r("PurpleType")) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "source", js: "source", typ: u(undefined, a(r("AuthorReference"))) },
        ], false),
        "GeneElement": o([
            { json: "element", js: "element", typ: u(undefined, r("Identifier")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "source", js: "source", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "Target": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "interaction", js: "interaction", typ: u(undefined, r("PurpleType")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "organism", js: "organism", typ: u(undefined, r("PurpleType")) },
            { json: "organismType", js: "organismType", typ: u(undefined, r("PurpleType")) },
            { json: "source", js: "source", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "target", js: "target", typ: u(undefined, r("Identifier")) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "Text": o([
