// To parse this data:
//
//   import { Convert, CatalogEntry } from "./file";
//
//   const catalogEntry = Convert.toCatalogEntry(json);
//
...
export interface CatalogEntry {
     ...
     */
    _validTo?: PuneHedgehog;
    /**
     * Used for examplefor Out of Formulary, or any specifics.
     */
    additionalCharacteristic?: PurpleType[];
    /**
     * User for example for ATC classification, or.
     */
    additionalClassification?: PurpleType[];
    /**
     ...
     */
    referencedItem?: AuthorReference;
    /**
 ...
 * The purpose of this identifier.
 */
export enum AdditionalIdentifierUse {
    Official = "official",
    Old = "old",
    Secondary = "secondary",
    Temp = "temp",
...
export namespace Convert {
    export function toCatalogEntry(json: string): CatalogEntry {
        return cast(JSON.parse(json), r("CatalogEntry"));
    }

    export function catalogEntryToJson(value: CatalogEntry): string {
        return JSON.stringify(uncast(value, r("CatalogEntry")), null, 2);
    }
    ...
    const typeMap: any = {
        "CatalogEntry": o([
            ...
            { json: "_orderable", js: "_orderable", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_validTo", js: "_validTo", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalCharacteristic", js: "additionalCharacteristic", typ: u(undefined, a(r("PurpleType"))) },
            { json: "additionalClassification", js: "additionalClassification", typ: u(undefined, a(r("PurpleType"))) },
            { json: "additionalIdentifier", js: "additionalIdentifier", typ: u(undefined, a(r("Identifier"))) },
            ...
            { json: "orderable", js: "orderable", typ: u(undefined, true) },
            { json: "referencedItem", js: "referencedItem", typ: u(undefined, r("AuthorReference")) },
            { json: "relatedEntry", js: "relatedEntry", typ: u(undefined, a(r("RelatedEntry"))) },
            { json: "status", js: "status", typ: u(undefined, r("CatalogEntryStatus")) },
        ...
        "Identifier": o([
            ...
            { json: "system", js: "system", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
            { json: "use", js: "use", typ: u(undefined, r("AdditionalIdentifierUse")) },
            { json: "value", js: "value", typ: u(undefined, "") },
        ], false),
        "AuthorReference": o([
            { json: "_display", js: "_display", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "RelatedEntry": o([
            { json: "_relationtype", js: "_relationtype", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "item", js: "item", typ: r("AuthorReference") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "relationtype", js: "relationtype", typ: u(undefined, r("Relationtype")) },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
