// To parse this data:
//
//   import { Convert, PractitionerRole } from "./file";
//
//   const practitionerRole = Convert.toPractitionerRole(json);
//
...
export interface PractitionerRole {
     ...
     */
    healthcareService?: AuthorReference[];
    /**
     ...
     */
    practitioner?: AuthorReference;
    /**
     * Specific specialty of the practitioner.
     */
    specialty?: CodeElement[];
    /**
...
export namespace Convert {
    export function toPractitionerRole(json: string): PractitionerRole {
        return cast(JSON.parse(json), r("PractitionerRole"));
    }

    export function practitionerRoleToJson(value: PractitionerRole): string {
        return JSON.stringify(uncast(value, r("PractitionerRole")), null, 2);
    }
    ...
    const typeMap: any = {
        "PractitionerRole": o([
            ...
            { json: "healthcareService", js: "healthcareService", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "organization", js: "organization", typ: u(undefined, r("AuthorReference")) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "practitioner", js: "practitioner", typ: u(undefined, r("AuthorReference")) },
            { json: "specialty", js: "specialty", typ: u(undefined, a(r("CodeElement"))) },
