// To parse this data:
//
//   import { Convert, ImagingStudy } from "./file";
//
//   const imagingStudy = Convert.toImagingStudy(json);
//
...
export interface ImagingStudy {
     ...
     */
    _numberOfInstances?: PuneHedgehog;
    /**
     * Extensions for numberOfSeries
     */
    _numberOfSeries?: PuneHedgehog;
    /**
     * Extensions for started
     */
    _started?: PuneHedgehog;
    /**
     ...
     */
    procedureCode?: PurpleType[];
    /**
     * The procedure which this ImagingStudy was part of.
     */
    procedureReference?: AuthorReference;
    /**
...
export namespace Convert {
    export function toImagingStudy(json: string): ImagingStudy {
        return cast(JSON.parse(json), r("ImagingStudy"));
    }

    export function imagingStudyToJson(value: ImagingStudy): string {
        return JSON.stringify(uncast(value, r("ImagingStudy")), null, 2);
    }
    ...
    const typeMap: any = {
        "ImagingStudy": o([
            ...
            { json: "_numberOfInstances", js: "_numberOfInstances", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_numberOfSeries", js: "_numberOfSeries", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_started", js: "_started", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "interpreter", js: "interpreter", typ: u(undefined, a(r("AuthorReference"))) },
            ...
            { json: "modality", js: "modality", typ: u(undefined, a(r("Coding"))) },
            ...
            { json: "numberOfInstances", js: "numberOfInstances", typ: u(undefined, 3.14) },
            { json: "numberOfSeries", js: "numberOfSeries", typ: u(undefined, 3.14) },
            { json: "procedureCode", js: "procedureCode", typ: u(undefined, a(r("PurpleType"))) },
            { json: "procedureReference", js: "procedureReference", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "referrer", js: "referrer", typ: u(undefined, r("AuthorReference")) },
            { json: "series", js: "series", typ: u(undefined, a(r("Series"))) },
            { json: "started", js: "started", typ: u(undefined, "") },
            { json: "status", js: "status", typ: u(undefined, r("ImagingStudyStatus")) },
        ...
        "Series": o([
            ...
            { json: "_numberOfInstances", js: "_numberOfInstances", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_started", js: "_started", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_uid", js: "_uid", typ: u(undefined, r("PuneHedgehog")) },
            { json: "bodySite", js: "bodySite", typ: u(undefined, r("Coding")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "endpoint", js: "endpoint", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "instance", js: "instance", typ: u(undefined, a(r("Instance"))) },
            { json: "laterality", js: "laterality", typ: u(undefined, r("Coding")) },
            { json: "modality", js: "modality", typ: r("Coding") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Instance": o([
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "number", js: "number", typ: u(undefined, 3.14) },
            { json: "sopClass", js: "sopClass", typ: r("Coding") },
            { json: "title", js: "title", typ: u(undefined, "") },
            { json: "uid", js: "uid", typ: u(undefined, "") },
        ], false),
        "Performer": o([
