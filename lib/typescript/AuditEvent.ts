// To parse this data:
//
//   import { Convert, AuditEvent } from "./file";
//
//   const auditEvent = Convert.toAuditEvent(json);
//
...
export interface Agent {
     ...
     */
    _policy?: PuneHedgehog[];
    /**
     * Extensions for requestor
     */
    _requestor?: PuneHedgehog;
    /**
...
export namespace Convert {
    export function toAuditEvent(json: string): AuditEvent {
        return cast(JSON.parse(json), r("AuditEvent"));
    }

    export function auditEventToJson(value: AuditEvent): string {
        return JSON.stringify(uncast(value, r("AuditEvent")), null, 2);
    }
    ...
    const typeMap: any = {
        "AuditEvent": o([
            { json: "_action", js: "_action", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_outcomeDesc", js: "_outcomeDesc", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_recorded", js: "_recorded", typ: u(undefined, r("PuneHedgehog")) },
            { json: "action", js: "action", typ: u(undefined, r("Action")) },
            { json: "agent", js: "agent", typ: u(undefined, a(r("Agent"))) },
            { json: "entity", js: "entity", typ: u(undefined, a(r("Entity"))) },
            ...
            { json: "outcomeDesc", js: "outcomeDesc", typ: u(undefined, "") },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "purposeOfEvent", js: "purposeOfEvent", typ: u(undefined, a(r("PurpleType"))) },
            { json: "recorded", js: "recorded", typ: u(undefined, "") },
            { json: "source", js: "source", typ: u(undefined, r("Source")) },
            { json: "subtype", js: "subtype", typ: u(undefined, a(r("Coding"))) },
        ...
        "Agent": o([
            { json: "_altId", js: "_altId", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_policy", js: "_policy", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "_requestor", js: "_requestor", typ: u(undefined, r("PuneHedgehog")) },
            { json: "altId", js: "altId", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "location", js: "location", typ: u(undefined, r("AuthorReference")) },
            { json: "media", js: "media", typ: u(undefined, r("Coding")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "network", js: "network", typ: u(undefined, r("Network")) },
            { json: "policy", js: "policy", typ: u(undefined, a("")) },
            { json: "purposeOfUse", js: "purposeOfUse", typ: u(undefined, a(r("PurpleType"))) },
            { json: "requestor", js: "requestor", typ: u(undefined, true) },
            { json: "role", js: "role", typ: u(undefined, a(r("PurpleType"))) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ...
        "Network": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: u(undefined, r("NetworkType")) },
        ], false),
        "Entity": o([
            { json: "_description", js: "_description", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_query", js: "_query", typ: u(undefined, r("PuneHedgehog")) },
            { json: "description", js: "description", typ: u(undefined, "") },
            { json: "detail", js: "detail", typ: u(undefined, a(r("Detail"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "lifecycle", js: "lifecycle", typ: u(undefined, r("Coding")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "query", js: "query", typ: u(undefined, "") },
            { json: "role", js: "role", typ: u(undefined, r("Coding")) },
            { json: "securityLabel", js: "securityLabel", typ: u(undefined, a(r("Coding"))) },
            { json: "type", js: "type", typ: u(undefined, r("Coding")) },
            { json: "what", js: "what", typ: u(undefined, r("AuthorReference")) },
        ], false),
        "Detail": o([
            { json: "_type", js: "_type", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_valueBase64Binary", js: "_valueBase64Binary", typ: u(undefined, r("PuneHedgehog")) },
        ...
        "Source": o([
            { json: "_site", js: "_site", typ: u(undefined, r("PuneHedgehog")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "observer", js: "observer", typ: r("AuthorReference") },
            { json: "site", js: "site", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, a(r("Coding"))) },
        ], false),
        "Text": o([
