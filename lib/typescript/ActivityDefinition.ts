// To parse this data:
//
//   import { Convert, ActivityDefinition } from "./file";
//
//   const activityDefinition = Convert.toActivityDefinition(json);
//
...
export interface ActivityDefinition {
     ...
     * surface area.
     */
    observationRequirement?: AuthorReference[];
    /**
     * Defines the observations that are expected to be produced by the action.
     */
    observationResultRequirement?: AuthorReference[];
    /**
     ...
     */
    productCodeableConcept?: PurpleType;
    /**
     * Identifies the food, drug or other product being consumed or supplied in the activity.
     */
    productReference?: AuthorReference;
    /**
     ...
     * for a lab test.
     */
    specimenRequirement?: AuthorReference[];
    /**
...
export namespace Convert {
    export function toActivityDefinition(json: string): ActivityDefinition {
        return cast(JSON.parse(json), r("ActivityDefinition"));
    }

    export function activityDefinitionToJson(value: ActivityDefinition): string {
        return JSON.stringify(uncast(value, r("ActivityDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "ActivityDefinition": o([
            ...
            { json: "bodySite", js: "bodySite", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "dosage", js: "dosage", typ: u(undefined, a(r("ValueDosage"))) },
            ...
            { json: "observationRequirement", js: "observationRequirement", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "observationResultRequirement", js: "observationResultRequirement", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "participant", js: "participant", typ: u(undefined, a(r("Participant"))) },
            { json: "priority", js: "priority", typ: u(undefined, "") },
            { json: "productCodeableConcept", js: "productCodeableConcept", typ: u(undefined, r("PurpleType")) },
            { json: "productReference", js: "productReference", typ: u(undefined, r("AuthorReference")) },
            ...
            { json: "specimenRequirement", js: "specimenRequirement", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "status", js: "status", typ: u(undefined, r("ActivityDefinitionStatus")) },
        ...
        "DynamicValue": o([
            { json: "_path", js: "_path", typ: u(undefined, r("PuneHedgehog")) },
            { json: "expression", js: "expression", typ: r("ValueExpression") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "path", js: "path", typ: u(undefined, "") },
        ...
        "Participant": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "role", js: "role", typ: u(undefined, r("PurpleType")) },
            { json: "type", js: "type", typ: u(undefined, "") },
        ], false),
        "Text": o([
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
