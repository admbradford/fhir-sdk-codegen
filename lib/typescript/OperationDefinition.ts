// To parse this data:
//
//   import { Convert, OperationDefinition } from "./file";
//
//   const operationDefinition = Convert.toOperationDefinition(json);
//
 ...
 * query (using the search interaction).
 */
export interface ReferencedFrom {
    /**
     * Extensions for source
     */
    _source?: PuneHedgehog;
...
export namespace Convert {
    export function toOperationDefinition(json: string): OperationDefinition {
        return cast(JSON.parse(json), r("OperationDefinition"));
    }

    export function operationDefinitionToJson(value: OperationDefinition): string {
        return JSON.stringify(uncast(value, r("OperationDefinition")), null, 2);
    }
    ...
    const typeMap: any = {
        "OperationDefinition": o([
            { json: "_affectsState", js: "_affectsState", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_instance", js: "_instance", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "_resource", js: "_resource", typ: u(undefined, a(r("PuneHedgehog"))) },
            ...
            { json: "affectsState", js: "affectsState", typ: u(undefined, true) },
            ...
            { json: "inputProfile", js: "inputProfile", typ: u(undefined, "") },
            { json: "instance", js: "instance", typ: u(undefined, true) },
            ...
            { json: "outputProfile", js: "outputProfile", typ: u(undefined, "") },
            { json: "overload", js: "overload", typ: u(undefined, a(r("Overload"))) },
            ...
            { json: "resource", js: "resource", typ: u(undefined, a("")) },
            { json: "status", js: "status", typ: u(undefined, r("OperationDefinitionStatus")) },
            { json: "system", js: "system", typ: u(undefined, true) },
            { json: "text", js: "text", typ: u(undefined, r("Text")) },
            { json: "title", js: "title", typ: u(undefined, "") },
            { json: "type", js: "type", typ: u(undefined, true) },
        ...
        "Overload": o([
            { json: "_comment", js: "_comment", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_parameterName", js: "_parameterName", typ: u(undefined, a(r("PuneHedgehog"))) },
            { json: "comment", js: "comment", typ: u(undefined, "") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "parameterName", js: "parameterName", typ: u(undefined, a("")) },
        ], false),
        "Parameter": o([
            { json: "_documentation", js: "_documentation", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_max", js: "_max", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_min", js: "_min", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_name", js: "_name", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_searchType", js: "_searchType", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_type", js: "_type", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_use", js: "_use", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, "") },
            { json: "part", js: "part", typ: u(undefined, a(r("Parameter"))) },
            { json: "referencedFrom", js: "referencedFrom", typ: u(undefined, a(r("ReferencedFrom"))) },
            { json: "searchType", js: "searchType", typ: u(undefined, r("SearchType")) },
            { json: "targetProfile", js: "targetProfile", typ: u(undefined, a("")) },
            { json: "type", js: "type", typ: u(undefined, "") },
            { json: "use", js: "use", typ: u(undefined, r("ParameterUse")) },
        ], false),
        "Binding": o([
