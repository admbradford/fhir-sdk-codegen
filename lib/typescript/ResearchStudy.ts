// To parse this data:
//
//   import { Convert, ResearchStudy } from "./file";
//
//   const researchStudy = Convert.toResearchStudy(json);
//
...
export interface ResearchStudy {
     ...
     */
    principalInvestigator?: AuthorReference;
    /**
     * The set of steps expected to be performed as part of the execution of the study.
     */
    protocol?: AuthorReference[];
    /**
     * A description and/or code explaining the premature termination of the study.
     */
    reasonStopped?: PurpleType;
    /**
     ...
     */
    site?: AuthorReference[];
    /**
     * An organization that initiates the investigation and is legally responsible for the study.
     */
    sponsor?: AuthorReference;
    /**
...
export namespace Convert {
    export function toResearchStudy(json: string): ResearchStudy {
        return cast(JSON.parse(json), r("ResearchStudy"));
    }

    export function researchStudyToJson(value: ResearchStudy): string {
        return JSON.stringify(uncast(value, r("ResearchStudy")), null, 2);
    }
    ...
    const typeMap: any = {
        "ResearchStudy": o([
            ...
            { json: "arm", js: "arm", typ: u(undefined, a(r("Arm"))) },
            ...
            { json: "enrollment", js: "enrollment", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "focus", js: "focus", typ: u(undefined, a(r("PurpleType"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "implicitRules", js: "implicitRules", typ: u(undefined, "") },
            { json: "keyword", js: "keyword", typ: u(undefined, a(r("PurpleType"))) },
            { json: "language", js: "language", typ: u(undefined, "") },
            { json: "location", js: "location", typ: u(undefined, a(r("PurpleType"))) },
            ...
            { json: "objective", js: "objective", typ: u(undefined, a(r("Objective"))) },
            { json: "partOf", js: "partOf", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "phase", js: "phase", typ: u(undefined, r("PurpleType")) },
            { json: "primaryPurposeType", js: "primaryPurposeType", typ: u(undefined, r("PurpleType")) },
            { json: "principalInvestigator", js: "principalInvestigator", typ: u(undefined, r("AuthorReference")) },
            { json: "protocol", js: "protocol", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "reasonStopped", js: "reasonStopped", typ: u(undefined, r("PurpleType")) },
            { json: "relatedArtifact", js: "relatedArtifact", typ: u(undefined, a(r("ValueRelatedArtifact"))) },
            { json: "site", js: "site", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "sponsor", js: "sponsor", typ: u(undefined, r("AuthorReference")) },
            { json: "status", js: "status", typ: u(undefined, r("ResearchStudyStatus")) },
