// To parse this data:
//
//   import { Convert, InsurancePlan } from "./file";
//
//   const insurancePlan = Convert.toInsurancePlan(json);
//
...
export interface InsurancePlan {
     ...
     */
    administeredBy?: AuthorReference;
    /**
 ...
 * Details of a Health Insurance product/plan provided by an organization.
 */
export interface SpecificCostBenefit {
    /**
...
export namespace Convert {
    export function toInsurancePlan(json: string): InsurancePlan {
        return cast(JSON.parse(json), r("InsurancePlan"));
    }

    export function insurancePlanToJson(value: InsurancePlan): string {
        return JSON.stringify(uncast(value, r("InsurancePlan")), null, 2);
    }
    ...
    const typeMap: any = {
        "InsurancePlan": o([
            ...
            { json: "administeredBy", js: "administeredBy", typ: u(undefined, r("AuthorReference")) },
            { json: "alias", js: "alias", typ: u(undefined, a("")) },
            { json: "contact", js: "contact", typ: u(undefined, a(r("Contact"))) },
            { json: "coverage", js: "coverage", typ: u(undefined, a(r("Coverage"))) },
            ...
            { json: "network", js: "network", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "ownedBy", js: "ownedBy", typ: u(undefined, r("AuthorReference")) },
            { json: "period", js: "period", typ: u(undefined, r("Period")) },
            { json: "plan", js: "plan", typ: u(undefined, a(r("Plan"))) },
            { json: "status", js: "status", typ: u(undefined, r("InsurancePlanStatus")) },
        ...
        "Contact": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "name", js: "name", typ: u(undefined, r("ValueHumanName")) },
            { json: "purpose", js: "purpose", typ: u(undefined, r("PurpleType")) },
            { json: "telecom", js: "telecom", typ: u(undefined, a(r("ValueContactPoint"))) },
        ], false),
        "Coverage": o([
            { json: "benefit", js: "benefit", typ: a(r("CoverageBenefit")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "network", js: "network", typ: u(undefined, a(r("AuthorReference"))) },
        ...
        "CoverageBenefit": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "limit", js: "limit", typ: u(undefined, a(r("Limit"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ...
        "Limit": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "value", js: "value", typ: u(undefined, r("ValueQuantity")) },
        ], false),
        "Meta": o([
        ...
        "Plan": o([
            { json: "coverageArea", js: "coverageArea", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "generalCost", js: "generalCost", typ: u(undefined, a(r("GeneralCost"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "identifier", js: "identifier", typ: u(undefined, a(r("Identifier"))) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "network", js: "network", typ: u(undefined, a(r("AuthorReference"))) },
            { json: "specificCost", js: "specificCost", typ: u(undefined, a(r("SpecificCost"))) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "GeneralCost": o([
            { json: "_comment", js: "_comment", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_groupSize", js: "_groupSize", typ: u(undefined, r("PuneHedgehog")) },
            { json: "comment", js: "comment", typ: u(undefined, "") },
            { json: "cost", js: "cost", typ: u(undefined, r("ValueMoney")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "groupSize", js: "groupSize", typ: u(undefined, 3.14) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "type", js: "type", typ: u(undefined, r("PurpleType")) },
        ], false),
        "SpecificCost": o([
            { json: "benefit", js: "benefit", typ: u(undefined, a(r("SpecificCostBenefit"))) },
            { json: "category", js: "category", typ: r("PurpleType") },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
        ], false),
        "SpecificCostBenefit": o([
        ...
        "Cost": o([
            { json: "applicability", js: "applicability", typ: u(undefined, r("PurpleType")) },
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "qualifiers", js: "qualifiers", typ: u(undefined, a(r("PurpleType"))) },
            { json: "type", js: "type", typ: r("PurpleType") },
            { json: "value", js: "value", typ: u(undefined, r("ValueQuantity")) },
        ], false),
        "Text": o([
