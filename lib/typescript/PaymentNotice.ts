// To parse this data:
//
//   import { Convert, PaymentNotice } from "./file";
//
//   const paymentNotice = Convert.toPaymentNotice(json);
//
...
export interface ValueUsageContext {
     ...
     */
    valueCodeableConcept?: PaymentStatusElement;
    /**
     * A value that defines the context specified in this context of use. The interpretation of
     * the value is defined by the code.
     */
...
export interface ValueDosage {
     ...
     * sunlamps").
     */
    additionalInstruction?: PaymentStatusElement[];
    /**
     ...
     * (CodeableConcept).
     */
    asNeededCodeableConcept?: PaymentStatusElement;
    /**
...
export interface ValueDataRequirement {
     ...
     * subject is assumed.
     */
    subjectCodeableConcept?: PaymentStatusElement;
    /**
     * The intended subjects of the data requirement. If this element is not provided, a Patient
     * subject is assumed.
     */
 ...
 * A code indicating whether payment has been sent or cleared.
 */
export interface PaymentStatusElement {
    /**
     * Extensions for text
     */
    _text?: PuneHedgehog;
...
export namespace Convert {
    export function toPaymentNotice(json: string): PaymentNotice {
        return cast(JSON.parse(json), r("PaymentNotice"));
    }

    export function paymentNoticeToJson(value: PaymentNotice): string {
        return JSON.stringify(uncast(value, r("PaymentNotice")), null, 2);
    }
    ...
    const typeMap: any = {
        "PaymentNotice": o([
            ...
            { json: "payment", js: "payment", typ: u(undefined, r("AuthorReference")) },
            { json: "paymentDate", js: "paymentDate", typ: u(undefined, "") },
            { json: "paymentStatus", js: "paymentStatus", typ: u(undefined, r("PaymentStatusElement")) },
            { json: "provider", js: "provider", typ: u(undefined, r("AuthorReference")) },
            { json: "recipient", js: "recipient", typ: u(undefined, r("AuthorReference")) },
        ...
        "ValueUsageContext": o([
            ...
            { json: "extension", js: "extension", typ: u(undefined, a(r("Extension"))) },
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "valueCodeableConcept", js: "valueCodeableConcept", typ: u(undefined, r("PaymentStatusElement")) },
        ...
        "ValueTiming": o([
            ...
            { json: "code", js: "code", typ: u(undefined, r("PaymentStatusElement")) },
        ...
        "DoseAndRate": o([
            ...
            { json: "type", js: "type", typ: u(undefined, r("PaymentStatusElement")) },
        ], false),
        "ValueDosage": o([
            ...
            { json: "_text", js: "_text", typ: u(undefined, r("PuneHedgehog")) },
            { json: "additionalInstruction", js: "additionalInstruction", typ: u(undefined, a(r("PaymentStatusElement"))) },
            { json: "asNeededBoolean", js: "asNeededBoolean", typ: u(undefined, true) },
            { json: "asNeededCodeableConcept", js: "asNeededCodeableConcept", typ: u(undefined, r("PaymentStatusElement")) },
            ...
            { json: "method", js: "method", typ: u(undefined, r("PaymentStatusElement")) },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "patientInstruction", js: "patientInstruction", typ: u(undefined, "") },
            { json: "route", js: "route", typ: u(undefined, r("PaymentStatusElement")) },
            { json: "sequence", js: "sequence", typ: u(undefined, 3.14) },
            { json: "site", js: "site", typ: u(undefined, r("PaymentStatusElement")) },
            { json: "text", js: "text", typ: u(undefined, "") },
        ...
        "ValueDataRequirement": o([
            ...
            { json: "subjectCodeableConcept", js: "subjectCodeableConcept", typ: u(undefined, r("PaymentStatusElement")) },
