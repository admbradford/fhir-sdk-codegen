// To parse this data:
//
//   import { Convert, Linkage } from "./file";
//
//   const linkage = Convert.toLinkage(json);
//
...
export namespace Convert {
    export function toLinkage(json: string): Linkage {
        return cast(JSON.parse(json), r("Linkage"));
    }

    export function linkageToJson(value: Linkage): string {
        return JSON.stringify(uncast(value, r("Linkage")), null, 2);
    }
    ...
    const typeMap: any = {
        ...
        "Item": o([
            ...
            { json: "id", js: "id", typ: u(undefined, "") },
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "resource", js: "resource", typ: r("AuthorReference") },
