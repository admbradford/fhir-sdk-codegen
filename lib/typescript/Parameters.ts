// To parse this data:
//
//   import { Convert, Parameters } from "./file";
//
//   const parameters = Convert.toParameters(json);
//
...
export namespace Convert {
    export function toParameters(json: string): Parameters {
        return cast(JSON.parse(json), r("Parameters"));
    }

    export function parametersToJson(value: Parameters): string {
