// To parse this data:
//
//   import { Convert, TestReport } from "./file";
//
//   const testReport = Convert.toTestReport(json);
//
...
export interface Assert {
     ...
     * Extensions for detail
     */
    _detail?: PuneHedgehog;
    /**
     * Extensions for message
     */
    _message?: PuneHedgehog;
    /**
     * Extensions for result
     */
    _result?: PuneHedgehog;
...
export namespace Convert {
    export function toTestReport(json: string): TestReport {
        return cast(JSON.parse(json), r("TestReport"));
    }

    export function testReportToJson(value: TestReport): string {
        return JSON.stringify(uncast(value, r("TestReport")), null, 2);
    }
    ...
    const typeMap: any = {
        "TestReport": o([
            ...
            { json: "_result", js: "_result", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_score", js: "_score", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_status", js: "_status", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_tester", js: "_tester", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "result", js: "result", typ: u(undefined, r("TestReportResult")) },
            { json: "score", js: "score", typ: u(undefined, 3.14) },
            { json: "setup", js: "setup", typ: u(undefined, r("Setup")) },
            { json: "status", js: "status", typ: u(undefined, r("TestReportStatus")) },
            { json: "teardown", js: "teardown", typ: u(undefined, r("Teardown")) },
            { json: "test", js: "test", typ: u(undefined, a(r("Test"))) },
            { json: "tester", js: "tester", typ: u(undefined, "") },
            { json: "testScript", js: "testScript", typ: u(undefined, r("AuthorReference")) },
        ...
        "Assert": o([
            { json: "_detail", js: "_detail", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_message", js: "_message", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_result", js: "_result", typ: u(undefined, r("PuneHedgehog")) },
            ...
            { json: "modifierExtension", js: "modifierExtension", typ: u(undefined, a(r("Extension"))) },
            { json: "result", js: "result", typ: u(undefined, r("AssertResult")) },
        ], false),
        "Operation": o([
            { json: "_detail", js: "_detail", typ: u(undefined, r("PuneHedgehog")) },
            { json: "_message", js: "_message", typ: u(undefined, r("PuneHedgehog")) },
